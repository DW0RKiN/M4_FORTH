...
dnl
define({__T_IS_PTR_REVERSE_1},{__HAS_PTR(__T_REVERSE_1($1))}){}dnl
define({__T_IS_PTR_REVERSE_2},{__HAS_PTR(__T_REVERSE_2($1))}){}dnl
define({__T_IS_PTR_REVERSE_3},{__HAS_PTR(__T_REVERSE_3($1))}){}dnl
define({__T_IS_PTR_REVERSE_4},{__HAS_PTR(__T_REVERSE_4($1))}){}dnl
define({__T_IS_PTR_REVERSE_5},{__HAS_PTR(__T_REVERSE_5($1))}){}dnl
define({__T_IS_PTR_REVERSE_6},{__HAS_PTR(__T_REVERSE_6($1))}){}dnl
define({__T_IS_PTR_REVERSE_2_1},    {eval(                                                                __HAS_PTR(__T_REVERSE_2($1))|__HAS_PTR(__T_REVERSE_1($1)))}){}dnl
define({__T_IS_PTR_REVERSE_3_1},    {eval(                                __HAS_PTR(__T_REVERSE_3($1))|                                __HAS_PTR(__T_REVERSE_1($1)))}){}dnl
define({__T_IS_PTR_REVERSE_4_1},    {eval(__HAS_PTR(__T_REVERSE_4($1))|                                                                __HAS_PTR(__T_REVERSE_1($1)))}){}dnl
define({__T_IS_PTR_REVERSE_3_2},    {eval(                                __HAS_PTR(__T_REVERSE_3($1))|__HAS_PTR(__T_REVERSE_2($1))                                )}){}dnl
define({__T_IS_PTR_REVERSE_4_2},    {eval(__HAS_PTR(__T_REVERSE_4($1))|                                __HAS_PTR(__T_REVERSE_2($1))                                )}){}dnl
define({__T_IS_PTR_REVERSE_4_3},    {eval(__HAS_PTR(__T_REVERSE_4($1))|__HAS_PTR(__T_REVERSE_3($1))                                                                )}){}dnl
define({__T_IS_PTR_REVERSE_3_2_1},  {eval(                                __HAS_PTR(__T_REVERSE_3($1))|__HAS_PTR(__T_REVERSE_2($1))|__HAS_PTR(__T_REVERSE_1($1)))}){}dnl
define({__T_IS_PTR_REVERSE_4_3_2_1},{eval(__HAS_PTR(__T_REVERSE_4($1))|__HAS_PTR(__T_REVERSE_3($1))|__HAS_PTR(__T_REVERSE_2($1))|__HAS_PTR(__T_REVERSE_1($1)))}){}dnl
dnl # __IS_NUM() --> 0
...
dnl # __HAS_PTR() --> 0
define({__T_IS_PTR_1},{__HAS_PTR(__T_ARRAY_1($1))}){}dnl
define({__T_IS_PTR_2},{__HAS_PTR(__T_ARRAY_2($1))}){}dnl
define({__T_IS_PTR_3},{__HAS_PTR(__T_ARRAY_3($1))}){}dnl
define({__T_IS_PTR_4},{__HAS_PTR(__T_ARRAY_4($1))}){}dnl
define({__T_IS_PTR_5},{__HAS_PTR(__T_ARRAY_5($1))}){}dnl
define({__T_IS_PTR_6},{__HAS_PTR(__T_ARRAY_6($1))}){}dnl
define({__T_IS_PTR_1_2},    {eval(__HAS_PTR(__T_ARRAY_1($1))|__HAS_PTR(__T_ARRAY_2($1))                                                            )}){}dnl
define({__T_IS_PTR_1_3},    {eval(__HAS_PTR(__T_ARRAY_1($1))|                              __HAS_PTR(__T_ARRAY_3($1))                              )}){}dnl
define({__T_IS_PTR_1_4},    {eval(__HAS_PTR(__T_ARRAY_1($1))|                                                            __HAS_PTR(__T_ARRAY_4($1)))}){}dnl
define({__T_IS_PTR_2_3},    {eval(                              __HAS_PTR(__T_ARRAY_2($1))|__HAS_PTR(__T_ARRAY_3($1))                              )}){}dnl
define({__T_IS_PTR_2_4},    {eval(                              __HAS_PTR(__T_ARRAY_2($1))|                              __HAS_PTR(__T_ARRAY_4($1)))}){}dnl
define({__T_IS_PTR_3_4},    {eval(                                                            __HAS_PTR(__T_ARRAY_3($1))|__HAS_PTR(__T_ARRAY_4($1)))}){}dnl
define({__T_IS_PTR_1_2_3},  {eval(__HAS_PTR(__T_ARRAY_1($1))|__HAS_PTR(__T_ARRAY_2($1))|__HAS_PTR(__T_ARRAY_3($1))                              )}){}dnl
define({__T_IS_PTR_1_2_3_4},{eval(__HAS_PTR(__T_ARRAY_1($1))|__HAS_PTR(__T_ARRAY_2($1))|__HAS_PTR(__T_ARRAY_3($1))|__HAS_PTR(__T_ARRAY_4($1)))}){}dnl
dnl
...
dnl
dnl
define({__DELETE_LAST_TOKENS},{dnl
__{}ifelse(eval($1>0),1,{__DELETE_LAST_TOKEN{}$0(decr($1))})}){}dnl
dnl
dnl
dnl
...
_2,,,
            ...
            __T_NAME(0):$1, __TOKEN_2DUP:__TOKEN_2DROP,                 {__DELETE_LAST_TOKEN},
...
# x y (at-xy only because no change TOS & NOS) 2dup (2drop) -->
# (x_y_at-xy) 2dup (2drop)
...,,,
            __T_NAME(0):__T_ITEMS(0):$1,        __TOKEN_PUSHS:2:__TOKEN_2DUP_AT_XY,     {__SET_TOKEN({__TOKEN_PUSH2_AT_XY},__CONCATENATE_WITH({ },__T_INFO(0),$2),__T_ARRAY(0)){}__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_2DUP},{__dtto})},
            __T_NAME(0):eval(__T_ITEMS(0)>2):$1,__TOKEN_PUSHS:1:__TOKEN_2DUP_AT_XY,     {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH2_AT_XY},__CONCATENATE_WITH({ },__T_REVERSE_2(1),__T_REVERSE_1(1),$2),__LAST_2_PAR(__T_ARRAY(1))){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_PUSHS},__CONCATENATE_WITH({ },__T_INFO(1),{2drop}),__DROP_2_PAR(__T_ARRAY(1))){}__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_2DUP},{__dtto})},
...
o...,,,
            ...
            __T_NAME(2):__T_NAME(1):__T_NAME(0):$1,
               __TOKEN_OVER:__TOKEN_CFETCH:__TOKEN_OVER:__TOKEN_CFETCH,
                  {__SET_TOKEN_X(eval(__COUNT_TOKEN-2),{__TOKEN_OVER_CFETCH_OVER_CFETCH},__CONCATENATE_WITH({ },__T_INFO(2),__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKENS(2)},
            ...
            __T_NAME(2):__T_NAME(1):__T_NAME(0):$1,  __TOKEN_OVER:__TOKEN_CFETCH:__TOKEN_0EQ:__TOKEN_UNTIL,   {__SET_TOKEN_X(eval(__COUNT_TOKEN-2),{__TOKEN_OVER_CFETCH_0EQ_UNTIL},__CONCATENATE_WITH({ },__T_INFO(2),__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKENS(2)},
            __T_NAME(2):__T_NAME(1):__T_NAME(0):$1,  __TOKEN_OVER:__TOKEN_CFETCH:__TOKEN_0EQ:__TOKEN_WHILE,   {__SET_TOKEN_X(eval(__COUNT_TOKEN-2),{__TOKEN_OVER_CFETCH_0EQ_WHILE},__CONCATENATE_WITH({ },__T_INFO(2),__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKENS(2)},
...
p,,,
            ...
            __T_NAME(0):$1,                      __TOKEN_FILE:__TOKEN_PLAY,                                   {__SET_TOKEN({__TOKEN_FILE_PLAY},   __CONCATENATE_WITH({ },__T_INFO(0),$2),__ESCAPING(__ESCAPING(__T_ARRAY_1(0))),__ESCAPING(__ESCAPING(__T_ARRAY_2(0))),__ESCAPING(__ESCAPING(__T_ARRAY_3(0))))},
            __T_NAME(0):$1,                      __TOKEN_BINFILE:__TOKEN_PLAY,                                {__SET_TOKEN({__TOKEN_BINFILE_PLAY},__CONCATENATE_WITH({ },__T_INFO(0),$2),__ESCAPING(__ESCAPING(__T_ARRAY_1(0))),__ESCAPING(__ESCAPING(__T_ARRAY_2(0))),__ESCAPING(__ESCAPING(__T_ARRAY_3(0))))},
...
pushdot,,,
            ...
            __T_NAME(0):$1:__HAS_PTR($3),             __TOKEN_PUSHS:__TOKEN_PUSHDOT:1,                      {__SET_TOKEN({__TOKEN_PUSHS},__T_INFO(0){ }$2,__T_ARRAY(0),($3+2),$3)},
            $1:__IS_NUM($3),                             __TOKEN_PUSHDOT:1,                                    {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSHS},$2,__HEX_DE($3),__HEX_HL($3))},
            $1:__HAS_PTR($3),                         __TOKEN_PUSHDOT:1,                                    {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSHS},$2,($3+2),$3)},
...
-2,(sp+2)->tos,,
            ...
            __T_NAME(0):__T_ITEMS(0):__T_IS_NUM_1(0):$1,      __TOKEN_PUSHS:1:1:__TOKEN_LSHIFT,     {__SET_TOKEN({__TOKEN_PUSH_LSHIFT},__CONCATENATE_WITH({ },__T_INFO(0),$2),__T_ARRAY(0))},
            __T_NAME(0):__T_ITEMS(0):__T_IS_NUM_1(0):$1,      __TOKEN_PUSHS:1:1:__TOKEN_RSHIFT,     {__SET_TOKEN({__TOKEN_PUSH_RSHIFT},__CONCATENATE_WITH({ },__T_INFO(0),$2),__T_ARRAY(0))},

            __T_NAME(0):__T_ITEMS(0):__T_IS_NUM_1_2(0):$1,    __TOKEN_PUSHS:2:1:__TOKEN_LSHIFT,     {__SET_TOKEN({__TOKEN_PUSHS},__CONCATENATE_WITH({ },__T_INFO(0),$2),__HEX_HL(__T_ARRAY_1(0)<<__T_ARRAY_2(0)))},
            __T_NAME(0):__T_ITEMS(0):__T_IS_NUM_1_2(0):$1,    __TOKEN_PUSHS:2:1:__TOKEN_RSHIFT,     {__SET_TOKEN({__TOKEN_PUSHS},__CONCATENATE_WITH({ },__T_INFO(0),$2),__HEX_HL(__T_ARRAY_1(0)>>__T_ARRAY_2(0)))},

            __T_NAME(0):eval(__T_ITEMS(0)>2):__T_IS_NUM_REVERSE_2_1(0):$1, __TOKEN_PUSHS:1:1:__TOKEN_LSHIFT,       {__SET_TOKEN({__TOKEN_PUSHS},__CONCATENATE_WITH({ },__T_INFO(0),$2),__DROP_2_PAR(__T_ARRAY(0)),__HEX_HL(__T_REVERSE_2(0)<<__T_REVERSE_1(0)))},
            __T_NAME(0):eval(__T_ITEMS(0)>2):__T_IS_NUM_REVERSE_2_1(0):$1, __TOKEN_PUSHS:1:1:__TOKEN_RSHIFT,       {__SET_TOKEN({__TOKEN_PUSHS},__CONCATENATE_WITH({ },__T_INFO(0),$2),__DROP_2_PAR(__T_ARRAY(0)),__HEX_HL(__T_REVERSE_2(0)>>__T_REVERSE_1(0)))},
...
"dup num !",,,
            __T_NAME(2):__T_NAME(1):__T_ITEMS(1):__T_NAME(0):$1,__TOKEN_DUP:__TOKEN_PUSHS:1:__TOKEN_2DUP_STORE_1ADD:__TOKEN_2DROP, {__SET_TOKEN_X(eval(__COUNT_TOKEN-2),{__TOKEN_DUP_PUSH_STORE}, __CONCATENATE_WITH({ },__T_INFO(2),__T_INFO(1),__T_INFO(0),$2),__T_ARRAY(1)){}__DELETE_LAST_TOKENS(2)},
            __T_NAME(2):__T_NAME(1):__T_ITEMS(1):__T_NAME(0):$1,__TOKEN_DUP:__TOKEN_PUSHS:1:__TOKEN_2DUP_CSTORE:__TOKEN_2DROP,     {__SET_TOKEN_X(eval(__COUNT_TOKEN-2),{__TOKEN_DUP_PUSH_CSTORE},__CONCATENATE_WITH({ },__T_INFO(2),__T_INFO(1),__T_INFO(0),$2),__T_ARRAY(1)){}__DELETE_LAST_TOKENS(2)},
            __T_NAME(2):__T_NAME(1):__T_ITEMS(1):__T_NAME(0):$1,__TOKEN_DUP:__TOKEN_PUSHS:1:__TOKEN_2DUP_HSTORE:__TOKEN_2DROP,     {__SET_TOKEN_X(eval(__COUNT_TOKEN-2),{__TOKEN_DUP_PUSH_HSTORE},__CONCATENATE_WITH({ },__T_INFO(2),__T_INFO(1),__T_INFO(0),$2),__T_ARRAY(1)){}__DELETE_LAST_TOKENS(2)},
...
"num num !",,,
            ...
            __T_NAME(2):__T_NAME(1):__T_ITEMS(1):__T_NAME(0):$1, __TOKEN_DUP:__TOKEN_PUSHS:1:__TOKEN_2DUP_STORE_1ADD:__TOKEN_2DROP, {__SET_TOKEN_X(eval(__COUNT_TOKEN-2),{__TOKEN_DUP_PUSH_STORE}, __CONCATENATE_WITH({ },__T_INFO(1),__T_INFO(0),$2),__T_ARRAY(1)){}__DELETE_LAST_TOKENS(2)},
            __T_NAME(2):__T_NAME(1):__T_ITEMS(1):__T_NAME(0):$1, __TOKEN_DUP:__TOKEN_PUSHS:1:__TOKEN_2DUP_CSTORE:__TOKEN_2DROP,     {__SET_TOKEN_X(eval(__COUNT_TOKEN-2),{__TOKEN_DUP_PUSH_CSTORE},__CONCATENATE_WITH({ },__T_INFO(1),__T_INFO(0),$2),__T_ARRAY(1)){}__DELETE_LAST_TOKENS(2)},
            __T_NAME(2):__T_NAME(1):__T_ITEMS(1):__T_NAME(0):$1, __TOKEN_DUP:__TOKEN_PUSHS:1:__TOKEN_2DUP_HSTORE:__TOKEN_2DROP,     {__SET_TOKEN_X(eval(__COUNT_TOKEN-2),{__TOKEN_DUP_PUSH_HSTORE},__CONCATENATE_WITH({ },__T_INFO(1),__T_INFO(0),$2),__T_ARRAY(1)){}__DELETE_LAST_TOKENS(2)},
            __T_NAME(1):__T_NAME(0):__T_ITEMS(0):$1,             __TOKEN_DUP:__TOKEN_PUSHS:1:__TOKEN_STORE,                         {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_DUP_PUSH_STORE}, __CONCATENATE_WITH({ },__T_INFO(1),__T_INFO(0),$2),__T_ARRAY(0)){}__DELETE_LAST_TOKEN},
            __T_NAME(1):__T_NAME(0):__T_ITEMS(0):$1,             __TOKEN_DUP:__TOKEN_PUSHS:1:__TOKEN_CSTORE,                        {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_DUP_PUSH_CSTORE},__CONCATENATE_WITH({ },__T_INFO(1),__T_INFO(0),$2),__T_ARRAY(0)){}__DELETE_LAST_TOKEN},
            __T_NAME(1):__T_NAME(0):__T_ITEMS(0):$1,             __TOKEN_DUP:__TOKEN_PUSHS:1:__TOKEN_HSTORE,                        {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_DUP_PUSH_HSTORE},__CONCATENATE_WITH({ },__T_INFO(1),__T_INFO(0),$2),__T_ARRAY(0)){}__DELETE_LAST_TOKEN},
            ...
            __T_NAME(3):__T_NAME(2)=__T_LAST_1_PAR(2):__T_NAME(1):__T_NAME(0):$1,
               __TOKEN_OVER:__TOKEN_PUSH_RSHIFT=8:__TOKEN_OVER:__TOKEN_2DUP_CSTORE:__TOKEN_2DROP,
                  {__SET_TOKEN_X(eval(__COUNT_TOKEN-3),{__TOKEN_2DUP_HSTORE},__CONCATENATE_WITH({ },__T_INFO(3),__T_INFO(2),__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKENS(3)},
            ...
            __T_NAME(2):__T_NAME(1)=__T_LAST_1_PAR(1):__T_NAME(0):$1,
               __TOKEN_OVER:__TOKEN_PUSH_RSHIFT=8:__TOKEN_OVER:__TOKEN_CSTORE,
                  {__SET_TOKEN_X(eval(__COUNT_TOKEN-2),{__TOKEN_2DUP_HSTORE},__CONCATENATE_WITH({ },__T_INFO(2),__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKENS(2)},
...
num 3pick !,,,
            __T_NAME(2):__T_NAME(1):__T_NAME(0):$1, __TOKEN_2_PICK:__TOKEN_PUSH_SWAP:__TOKEN_2DUP_STORE_1ADD:__TOKEN_2DROP, {__SET_TOKEN_X(eval(__COUNT_TOKEN-2),{__TOKEN_PUSH_3_PICK_STORE},__CONCATENATE_WITH({ },__T_INFO(2),__T_INFO(1),__T_INFO(0),$2),__T_ARRAY(1)){}__DELETE_LAST_TOKENS(2)},

num 3pick c!,,,
            __T_NAME(2):__T_NAME(1):__T_NAME(0):$1, __TOKEN_2_PICK:__TOKEN_PUSH_SWAP:__TOKEN_2DUP_CSTORE:__TOKEN_2DROP,     {__SET_TOKEN_X(eval(__COUNT_TOKEN-2),{__TOKEN_PUSH_3_PICK_CSTORE},__CONCATENATE_WITH({ },__T_INFO(2),__T_INFO(1),__T_INFO(0),$2),__T_ARRAY(1)){}__DELETE_LAST_TOKENS(2)},

num 4pick !,,,
            __T_NAME(2):__T_NAME(1):__T_NAME(0):$1, __TOKEN_3_PICK:__TOKEN_PUSH_SWAP:__TOKEN_2DUP_STORE_1ADD:__TOKEN_2DROP, {__SET_TOKEN_X(eval(__COUNT_TOKEN-2),{__TOKEN_PUSH_4_PICK_STORE},__CONCATENATE_WITH({ },__T_INFO(2),__T_INFO(1),__T_INFO(0),$2),__T_ARRAY(1)){}__DELETE_LAST_TOKENS(2)},

num 4pick c!,,,
            __T_NAME(2):__T_NAME(1):__T_NAME(0):$1, __TOKEN_3_PICK:__TOKEN_PUSH_SWAP:__TOKEN_2DUP_CSTORE:__TOKEN_2DROP,     {__SET_TOKEN_X(eval(__COUNT_TOKEN-2),{__TOKEN_PUSH_4_PICK_CSTORE},__CONCATENATE_WITH({ },__T_INFO(2),__T_INFO(1),__T_INFO(0),$2),__T_ARRAY(1)){}__DELETE_LAST_TOKENS(2)},
...
s...,,,
            ...
            __T_NAME(1):__T_NAME(0):$1,             __TOKEN_ZNE:__TOKEN_S_TO_Z:__TOKEN_ZNEGATE,                           {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_ZNE_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKEN},
            __T_NAME(1):__T_NAME(0):$1,             __TOKEN_ZGT:__TOKEN_S_TO_Z:__TOKEN_ZNEGATE,                           {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_ZGT_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKEN},
            __T_NAME(1):__T_NAME(0):$1,             __TOKEN_ZLT:__TOKEN_S_TO_Z:__TOKEN_ZNEGATE,                           {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_ZLT_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKEN},
            __T_NAME(1):__T_NAME(0):$1,             __TOKEN_ZEQ:__TOKEN_S_TO_Z:__TOKEN_ZNEGATE,                           {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_ZEQ_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKEN},

            __T_NAME(1):__T_NAME(0):$1,             __TOKEN_ZLE:__TOKEN_NEGATE:__TOKEN_S_TO_Z,                            {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_ZLE_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKEN},
            __T_NAME(1):__T_NAME(0):$1,             __TOKEN_ZGE:__TOKEN_NEGATE:__TOKEN_S_TO_Z,                            {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_ZGE_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKEN},
            __T_NAME(1):__T_NAME(0):$1,             __TOKEN_ZNE:__TOKEN_NEGATE:__TOKEN_S_TO_Z,                            {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_ZNE_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKEN},
            __T_NAME(1):__T_NAME(0):$1,             __TOKEN_ZGT:__TOKEN_NEGATE:__TOKEN_S_TO_Z,                            {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_ZGT_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKEN},
            __T_NAME(1):__T_NAME(0):$1,             __TOKEN_ZLT:__TOKEN_NEGATE:__TOKEN_S_TO_Z,                            {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_ZLT_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKEN},
            __T_NAME(1):__T_NAME(0):$1,             __TOKEN_ZEQ:__TOKEN_NEGATE:__TOKEN_S_TO_Z,                            {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_ZEQ_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKEN},

z<=         if          2dup        zpush       1            1e             2drop       else        2dup        zpush       1            0e             2drop       then,,,
__T_NAME(8):__T_NAME(7):__T_NAME(6):__T_NAME(5):__T_ITEMS(5):__T_ARRAY_1(5):__T_NAME(4):__T_NAME(3):__T_NAME(2):__T_NAME(1):__T_ITEMS(1):__T_ARRAY_1(1):__T_NAME(0):$1, __TOKEN_ZLE:__TOKEN_IF:__TOKEN_2DUP:__TOKEN_ZPUSH:1:1e:__TOKEN_2DROP:__TOKEN_ELSE:__TOKEN_2DUP:__TOKEN_ZPUSH:1:0e:__TOKEN_2DROP:__TOKEN_THEN,         {__SET_TOKEN_X(eval(__COUNT_TOKEN-8),{__TOKEN_ZLE_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(8),__T_INFO(7),__T_INFO(6),__T_INFO(5),__T_INFO(4),__T_INFO(3),__T_INFO(2),__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKENS(8)},
__T_NAME(8):__T_NAME(7):__T_NAME(6):__T_NAME(5):__T_ITEMS(5):__T_ARRAY_1(5):__T_NAME(4):__T_NAME(3):__T_NAME(2):__T_NAME(1):__T_ITEMS(1):__T_ARRAY_1(1):__T_NAME(0):$1, __TOKEN_ZGE:__TOKEN_IF:__TOKEN_2DUP:__TOKEN_ZPUSH:1:1e:__TOKEN_2DROP:__TOKEN_ELSE:__TOKEN_2DUP:__TOKEN_ZPUSH:1:0e:__TOKEN_2DROP:__TOKEN_THEN,         {__SET_TOKEN_X(eval(__COUNT_TOKEN-8),{__TOKEN_ZGE_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(8),__T_INFO(7),__T_INFO(6),__T_INFO(5),__T_INFO(4),__T_INFO(3),__T_INFO(2),__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKENS(8)},
__T_NAME(8):__T_NAME(7):__T_NAME(6):__T_NAME(5):__T_ITEMS(5):__T_ARRAY_1(5):__T_NAME(4):__T_NAME(3):__T_NAME(2):__T_NAME(1):__T_ITEMS(1):__T_ARRAY_1(1):__T_NAME(0):$1, __TOKEN_ZNE:__TOKEN_IF:__TOKEN_2DUP:__TOKEN_ZPUSH:1:1e:__TOKEN_2DROP:__TOKEN_ELSE:__TOKEN_2DUP:__TOKEN_ZPUSH:1:0e:__TOKEN_2DROP:__TOKEN_THEN,         {__SET_TOKEN_X(eval(__COUNT_TOKEN-8),{__TOKEN_ZNE_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(8),__T_INFO(7),__T_INFO(6),__T_INFO(5),__T_INFO(4),__T_INFO(3),__T_INFO(2),__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKENS(8)},
__T_NAME(8):__T_NAME(7):__T_NAME(6):__T_NAME(5):__T_ITEMS(5):__T_ARRAY_1(5):__T_NAME(4):__T_NAME(3):__T_NAME(2):__T_NAME(1):__T_ITEMS(1):__T_ARRAY_1(1):__T_NAME(0):$1, __TOKEN_ZGT:__TOKEN_IF:__TOKEN_2DUP:__TOKEN_ZPUSH:1:1e:__TOKEN_2DROP:__TOKEN_ELSE:__TOKEN_2DUP:__TOKEN_ZPUSH:1:0e:__TOKEN_2DROP:__TOKEN_THEN,         {__SET_TOKEN_X(eval(__COUNT_TOKEN-8),{__TOKEN_ZGT_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(8),__T_INFO(7),__T_INFO(6),__T_INFO(5),__T_INFO(4),__T_INFO(3),__T_INFO(2),__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKENS(8)},
__T_NAME(8):__T_NAME(7):__T_NAME(6):__T_NAME(5):__T_ITEMS(5):__T_ARRAY_1(5):__T_NAME(4):__T_NAME(3):__T_NAME(2):__T_NAME(1):__T_ITEMS(1):__T_ARRAY_1(1):__T_NAME(0):$1, __TOKEN_ZLT:__TOKEN_IF:__TOKEN_2DUP:__TOKEN_ZPUSH:1:1e:__TOKEN_2DROP:__TOKEN_ELSE:__TOKEN_2DUP:__TOKEN_ZPUSH:1:0e:__TOKEN_2DROP:__TOKEN_THEN,         {__SET_TOKEN_X(eval(__COUNT_TOKEN-8),{__TOKEN_ZLT_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(8),__T_INFO(7),__T_INFO(6),__T_INFO(5),__T_INFO(4),__T_INFO(3),__T_INFO(2),__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKENS(8)},
__T_NAME(8):__T_NAME(7):__T_NAME(6):__T_NAME(5):__T_ITEMS(5):__T_ARRAY_1(5):__T_NAME(4):__T_NAME(3):__T_NAME(2):__T_NAME(1):__T_ITEMS(1):__T_ARRAY_1(1):__T_NAME(0):$1, __TOKEN_ZEQ:__TOKEN_IF:__TOKEN_2DUP:__TOKEN_ZPUSH:1:1e:__TOKEN_2DROP:__TOKEN_ELSE:__TOKEN_2DUP:__TOKEN_ZPUSH:1:0e:__TOKEN_2DROP:__TOKEN_THEN,         {__SET_TOKEN_X(eval(__COUNT_TOKEN-8),{__TOKEN_ZEQ_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(8),__T_INFO(7),__T_INFO(6),__T_INFO(5),__T_INFO(4),__T_INFO(3),__T_INFO(2),__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKENS(8)},

z<=         if          2dup        zpush       1            0x0001       2drop       else        2dup        zpush       1            0x0000       2drop       then,,,
__T_NAME(8):__T_NAME(7):__T_NAME(6):__T_NAME(5):__T_ITEMS(5):__T_HEX_1(5):__T_NAME(4):__T_NAME(3):__T_NAME(2):__T_NAME(1):__T_ITEMS(1):__T_HEX_1(1):__T_NAME(0):$1,     __TOKEN_ZLE:__TOKEN_IF:__TOKEN_2DUP:__TOKEN_ZPUSH:1:0x0001:__TOKEN_2DROP:__TOKEN_ELSE:__TOKEN_2DUP:__TOKEN_ZPUSH:1:0x0000:__TOKEN_2DROP:__TOKEN_THEN, {__SET_TOKEN_X(eval(__COUNT_TOKEN-8),{__TOKEN_ZLE_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(8),__T_INFO(7),__T_INFO(6),__T_INFO(5),__T_INFO(4),__T_INFO(3),__T_INFO(2),__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKENS(8)},
__T_NAME(8):__T_NAME(7):__T_NAME(6):__T_NAME(5):__T_ITEMS(5):__T_HEX_1(5):__T_NAME(4):__T_NAME(3):__T_NAME(2):__T_NAME(1):__T_ITEMS(1):__T_HEX_1(1):__T_NAME(0):$1,     __TOKEN_ZGE:__TOKEN_IF:__TOKEN_2DUP:__TOKEN_ZPUSH:1:0x0001:__TOKEN_2DROP:__TOKEN_ELSE:__TOKEN_2DUP:__TOKEN_ZPUSH:1:0x0000:__TOKEN_2DROP:__TOKEN_THEN, {__SET_TOKEN_X(eval(__COUNT_TOKEN-8),{__TOKEN_ZGE_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(8),__T_INFO(7),__T_INFO(6),__T_INFO(5),__T_INFO(4),__T_INFO(3),__T_INFO(2),__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKENS(8)},
__T_NAME(8):__T_NAME(7):__T_NAME(6):__T_NAME(5):__T_ITEMS(5):__T_HEX_1(5):__T_NAME(4):__T_NAME(3):__T_NAME(2):__T_NAME(1):__T_ITEMS(1):__T_HEX_1(1):__T_NAME(0):$1,     __TOKEN_ZNE:__TOKEN_IF:__TOKEN_2DUP:__TOKEN_ZPUSH:1:0x0001:__TOKEN_2DROP:__TOKEN_ELSE:__TOKEN_2DUP:__TOKEN_ZPUSH:1:0x0000:__TOKEN_2DROP:__TOKEN_THEN, {__SET_TOKEN_X(eval(__COUNT_TOKEN-8),{__TOKEN_ZNE_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(8),__T_INFO(7),__T_INFO(6),__T_INFO(5),__T_INFO(4),__T_INFO(3),__T_INFO(2),__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKENS(8)},
__T_NAME(8):__T_NAME(7):__T_NAME(6):__T_NAME(5):__T_ITEMS(5):__T_HEX_1(5):__T_NAME(4):__T_NAME(3):__T_NAME(2):__T_NAME(1):__T_ITEMS(1):__T_HEX_1(1):__T_NAME(0):$1,     __TOKEN_ZGT:__TOKEN_IF:__TOKEN_2DUP:__TOKEN_ZPUSH:1:0x0001:__TOKEN_2DROP:__TOKEN_ELSE:__TOKEN_2DUP:__TOKEN_ZPUSH:1:0x0000:__TOKEN_2DROP:__TOKEN_THEN, {__SET_TOKEN_X(eval(__COUNT_TOKEN-8),{__TOKEN_ZGT_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(8),__T_INFO(7),__T_INFO(6),__T_INFO(5),__T_INFO(4),__T_INFO(3),__T_INFO(2),__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKENS(8)},
__T_NAME(8):__T_NAME(7):__T_NAME(6):__T_NAME(5):__T_ITEMS(5):__T_HEX_1(5):__T_NAME(4):__T_NAME(3):__T_NAME(2):__T_NAME(1):__T_ITEMS(1):__T_HEX_1(1):__T_NAME(0):$1,     __TOKEN_ZLT:__TOKEN_IF:__TOKEN_2DUP:__TOKEN_ZPUSH:1:0x0001:__TOKEN_2DROP:__TOKEN_ELSE:__TOKEN_2DUP:__TOKEN_ZPUSH:1:0x0000:__TOKEN_2DROP:__TOKEN_THEN, {__SET_TOKEN_X(eval(__COUNT_TOKEN-8),{__TOKEN_ZLT_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(8),__T_INFO(7),__T_INFO(6),__T_INFO(5),__T_INFO(4),__T_INFO(3),__T_INFO(2),__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKENS(8)},
__T_NAME(8):__T_NAME(7):__T_NAME(6):__T_NAME(5):__T_ITEMS(5):__T_HEX_1(5):__T_NAME(4):__T_NAME(3):__T_NAME(2):__T_NAME(1):__T_ITEMS(1):__T_HEX_1(1):__T_NAME(0):$1,     __TOKEN_ZEQ:__TOKEN_IF:__TOKEN_2DUP:__TOKEN_ZPUSH:1:0x0001:__TOKEN_2DROP:__TOKEN_ELSE:__TOKEN_2DUP:__TOKEN_ZPUSH:1:0x0000:__TOKEN_2DROP:__TOKEN_THEN, {__SET_TOKEN_X(eval(__COUNT_TOKEN-8),{__TOKEN_ZEQ_NEGATE_S_TO_Z},__CONCATENATE_WITH({ },__T_INFO(8),__T_INFO(7),__T_INFO(6),__T_INFO(5),__T_INFO(4),__T_INFO(3),__T_INFO(2),__T_INFO(1),__T_INFO(0),$2)){}__DELETE_LAST_TOKENS(8)},
...
z,,,
            ...
            __T_NAME(0):$1,              __TOKEN_ZDROP:__TOKEN_ZDROP,               {__SET_TOKEN({__TOKEN_ZDROPS},__CONCATENATE_WITH({ },__T_INFO(0),$2),2)},
            __T_NAME(0):$1,              __TOKEN_ZDROPS:__TOKEN_ZDROP,              {__SET_TOKEN({__TOKEN_ZDROPS},{zdrops(}eval(__T_ARRAY_1(0)+1){)},eval(__T_ARRAY_1(0)+1))},
...
__{}__{}ifelse(dnl
__{}__{}__{}$1:__HAS_PTR($3),__TOKEN_PUSHDOT:1,    {__SET_TOKEN({__TOKEN_PUSHS},$2,($3+2),$3)},
...
__{}ifelse(dnl
__T_NAME(1):__T_NAME(0),   __TOKEN_DROPS:__TOKEN_DROP,       {__SET_TOKEN({__TOKEN_DROPS},{drops(}eval(__T_ARRAY_1(1)+1){)},eval(__T_ARRAY_1(1)+1)){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
__T_NAME(1):__T_NAME(0),   __TOKEN_DROPS:__TOKEN_2DROP,      {__SET_TOKEN({__TOKEN_DROPS},{drops(}eval(__T_ARRAY_1(1)+2){)},eval(__T_ARRAY_1(1)+2)){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
__T_NAME(1):__T_NAME(0),   __TOKEN_DROPS:__TOKEN_3DROP,      {__SET_TOKEN({__TOKEN_DROPS},{drops(}eval(__T_ARRAY_1(1)+3){)},eval(__T_ARRAY_1(1)+3)){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},

__T_NAME(1):__T_NAME(0),   __TOKEN_3DROP:__TOKEN_DROP,       {__SET_TOKEN({__TOKEN_DROPS},__CONCATENATE_WITH({ },__T_INFO(1),__T_INFO(0)),4){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
__T_NAME(1):__T_NAME(0),   __TOKEN_3DROP:__TOKEN_2DROP,      {__SET_TOKEN({__TOKEN_DROPS},__CONCATENATE_WITH({ },__T_INFO(1),__T_INFO(0)),5){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
...
__T_NAME(4):__T_NAME(3):__T_ITEMS(3):__T_NAME(2):__T_NAME(1):__T_ITEMS(1):__T_NAME(0),   __TOKEN_IF:__TOKEN_PUSHS:1:__TOKEN_ELSE:__TOKEN_PUSHS:1:__TOKEN_THEN,
{__SET_TOKEN({__TOKEN_IF_PUSH_ELSE_PUSH_THEN},__CONCATENATE_WITH({ },__T_INFO(4),__T_INFO(3),__T_INFO(2),__T_INFO(1),__T_INFO(0)),__T_ARRAY(3),__T_ARRAY(1)){}dnl
__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE}){}dnl
...
__{}__{}ifelse(__HEX_L(__T_HEX_REVERSE_2(0)0>0x8000),0x01,{__def({USE_Fill_Over})}){}dnl
__{}__{}ifelse(__HAS_PTR(__T_REVERSE_3(0)),1,{__def({USE_Fill_Unknown_Addr})}){}dnl
__{}}){}dnl
...
__{}__{}ifelse(__SEPARATE_TOKEN,1,__CR{;-----(}__COUNT_TOKEN{) }__T_NAME(0)(__T_ARRAY(0))){}dnl
