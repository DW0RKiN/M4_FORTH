...
__{}ifelse(_TYP_DOUBLE,{small},{eval((_TMP_BEST_B>____DEQ_BYTES) || ((_TMP_BEST_B==____DEQ_BYTES) && (_TMP_BEST_P>____DEQ_PRICE)))},{eval(_TMP_BEST_P>____DEQ_PRICE)})}){}dnl
dnl
dnl
dnl
