...
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_EVAL_REVERSE_1,      __TOKEN_PUSHS:1:__TOKEN_DIV:0xFFFF,    {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_1_PAR(__LAST_TOKEN_ARRAY)){}__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_NEGATE},__T_INFO(1))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_EVAL_REVERSE_1,      __TOKEN_PUSHS:1:__TOKEN_DIV:0x0002,     {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_1_PAR(__LAST_TOKEN_ARRAY)){}__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_2DIV},__T_INFO(1))},
