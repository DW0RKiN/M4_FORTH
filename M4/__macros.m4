...
dnl
dnl
dnl # join(sep, args) - join each non-empty ARG into a single
dnl # string, with each element separated by SEP
define({join},
    {{$# $0 $1 $2
    }ifelse({$#}, {2}, {{$2}},
        {ifelse({$2}, {}, {}, {{$2}_})$0({$1}, shift(shift($@)))})}){}dnl
dnl
define({_join},
    {ifelse({$#$2}, {2}, {},
        {ifelse({$2}, {}, {}, {{$1$2}})$0({$1}, shift(shift($@)))})}){}dnl
dnl
dnl # joinall(sep, args) - join each ARG, including empty ones,
dnl # into a single string, with each element separated by SEP
define({joinall}, {{$2}_$0({$1}, shift($@))}){}dnl
dnl
define({_joinall},
    {ifelse({$#}, {2}, {}, {{$1$3}$0({$1}, shift(shift($@)))})}){}dnl
dnl
dnl
dnl
dnl
...
__{}array1: regexp(defn({__TOKEN[$1].PARAM}),{^(\([^,]*\)[,)]},{\1})
__{}array2: regexp(defn({__TOKEN[$1].PARAM}),{^([^,]*,\([^,]*\)[,)]},{\1})
__{}array3: regexp(defn({__TOKEN[$1].PARAM}),{^([^,]*,[^,]*,\([^,]*\)[,)]},{\1})
...
define({__UNPACK_ALL},{$@}){}dnl
define({__UNPACK_1},{$1}){}dnl
define({__UNPACK_2},{$2}){}dnl
define({__UNPACK_3},{$3}){}dnl
define({__UNPACK_PARAM},{__UNPACK_ALL$1}){}dnl
define({__GET_TOKEN_ARRAY},{__UNPACK_PARAM(defn({__TOKEN[$1].PARAM}))}){}dnl # 1,2
...
define({__LAST_TOKEN_ARRAY},{__UNPACK_PARAM(defn({__TOKEN[}__TOKEN_COUNT{].PARAM}))}){}dnl
define({__LAST_TOKEN_ARRAY_1},{regexp(defn({__TOKEN[}__TOKEN_COUNT{].PARAM}),{^(\([^,]*\)[,)]},{\1})}){}dnl
define({__LAST_TOKEN_ARRAY_2},{regexp(defn({__TOKEN[}__TOKEN_COUNT{].PARAM}),{^([^,]*,\([^,]*\)[,)]},{\1})}){}dnl
define({__LAST_TOKEN_ARRAY_3},{regexp(defn({__TOKEN[}__TOKEN_COUNT{].PARAM}),{^([^,]*,[^,]*,\([^,]*\)[,)]},{\1})}){}dnl
dnl
...
define({__ADD_TOKEN},
    {ifdef({__TOKEN_COUNT},
        {ifelse(
dnl # _2...
__{}__{}__{}__{}__LAST_TOKEN_NAME-$1,{__TOKEN_2DUP-__TOKEN_DADD},{__SET_TOKEN({__TOKEN_2DUP_DADD},__LAST_TOKEN_INFO{ }$2)},
...
dnl # _3..
__{}__{}__{}__{}__LAST_TOKEN_NAME-$1,{__TOKEN_3_PICK-__TOKEN_3_PICK},{__SET_TOKEN({__TOKEN_2OVER},__LAST_TOKEN_INFO{ }$2)},

dnl # _4..
__{}__{}__{}__{}__LAST_TOKEN_NAME-$1,{__TOKEN_4DUP-__TOKEN_DEQ},{__SET_TOKEN({__TOKEN_4DUP_DEQ},__LAST_TOKEN_INFO{ }$2)},
...
dnl # DUP
__{}__{}__{}__{}__LAST_TOKEN_NAME-$1,{__TOKEN_DUP-__TOKEN_IF},{__SET_TOKEN({__TOKEN_DUP_IF},__LAST_TOKEN_INFO{ }$2)},
...
dnl # D...
__{}__{}__{}__{}__LAST_TOKEN_NAME-$1,{__TOKEN_DROP-__TOKEN_DROP},{__SET_TOKEN({__TOKEN_2DROP},__LAST_TOKEN_INFO{ }$2)},
...
dnl # M...
dnl # N...
__{}__{}__{}__{}__LAST_TOKEN_NAME-$1,{__TOKEN_NROT-__TOKEN_SWAP},{__SET_TOKEN({__TOKEN_NROT_SWAP},__LAST_TOKEN_INFO{ }$2)},
...
dnl # O...
__{}__{}__{}__{}__LAST_TOKEN_NAME-$1,{__TOKEN_OVER-__TOKEN_OVER},{__SET_TOKEN({__TOKEN_2DUP},__LAST_TOKEN_INFO{ }$2)},
...
dnl # PUSH
__{}__{}__{}__{}__LAST_TOKEN_NAME=__SAVE_EVAL(__LAST_TOKEN_ARRAY)-$1,__TOKEN_PUSH=0-__TOKEN_CMOVE,{__SET_TOKEN({__TOKEN_2DROP},__LAST_TOKEN_INFO{ }$2)},
...
dnl # PUSH2
__{}__{}__{}__{}__LAST_TOKEN_NAME-$1-__IS_NUM(__LAST_TOKEN_ARRAY_1)-__IS_NUM(__LAST_TOKEN_ARRAY_2),{__TOKEN_PUSH2-__TOKEN_ADD-1-1},   {__SET_TOKEN({__TOKEN_PUSH},__LAST_TOKEN_INFO{ }$2,__EVAL_S16(+,__LAST_TOKEN_ARRAY))},
...
dnl # PUSH3
__{}__{}__{}__{}__LAST_TOKEN_NAME-$1,{__TOKEN_PUSH3-__TOKEN_FILL},{__SET_TOKEN({__TOKEN_PUSH3_FILL},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},

dnl # PUSHDOT
__{}__{}__{}__{}__LAST_TOKEN_NAME-__SAVE_EVAL(__LAST_TOKEN_ARRAY)-$1,{__TOKEN_PUSHDOT-0-__TOKEN_DEQ},{__SET_TOKEN({__TOKEN_D0EQ},__LAST_TOKEN_INFO{ }$2)},
...
dnl # Q...
dnl # R...
__{}__{}__{}__{}__LAST_TOKEN_NAME-$1,{__TOKEN_ROT-__TOKEN_DROP},{__SET_TOKEN({__TOKEN_ROT_DROP},__LAST_TOKEN_INFO{ }$2)},
...
dnl # S...
__{}__{}__{}__{}__LAST_TOKEN_NAME-$1,{__TOKEN_SWAP-__TOKEN_IF},{__SET_TOKEN({__TOKEN_SWAP_IF},__LAST_TOKEN_INFO{ }$2)},
...
dnl # T...
__{}__{}__{}__{}__LAST_TOKEN_NAME-$1,{__TOKEN_TUCK-__TOKEN_STORE},{__SET_TOKEN({__TOKEN_TUCK_STORE},__LAST_TOKEN_INFO{ }$2)},
...
dnl # Z...
                                         ...
                                         {define({__TOKEN_COUNT},eval(__TOKEN_COUNT+1)){}__SET_TOKEN($@)})},
...
__{}__A({__ASM}substr(__GET_TOKEN_NAME(__TOKEN_I),1){}__GET_TOKEN_PARAM(__TOKEN_I)){}dnl
__{}$0{}dnl
})}){}dnl
dnl
dnl
