...
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_OVER_PUSH_SWAP:__TOKEN_CSTORE,  {__SET_TOKEN(__TOKEN_OVER_PUSH_SWAP_CSTORE,__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__BEFORELAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
