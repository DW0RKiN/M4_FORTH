...
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1, __TOKEN_PUSHS:1:__TOKEN_FILL,    {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH3_FILL},__BEFORELAST_TOKEN_REVERSE_3{ }__BEFORELAST_TOKEN_REVERSE_2{ }__BEFORELAST_TOKEN_REVERSE_1,__BEFORELAST_TOKEN_LAST_3_PAR){}__SET_TOKEN_X(eval(__TOKEN_COUNT-1),__TOKEN_PUSHS, __BEFORELAST_TOKEN_INFO{ 3drop},__DROP_3_PAR(__BEFORELAST_TOKEN_ARRAY))},
