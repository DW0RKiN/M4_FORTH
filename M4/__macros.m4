...
__LAST_TOKEN_NAME:eval(2*__LAST_TOKEN_ITEMS):$1, __TOKEN_PUSHS:__PSIZE_$4:__TOKEN_PVALUE,   {define(_{_TEMP},0x{}__ARRAY2HEXSTRING(__LAST_TOKEN_ARRAY)){}__DELETE_LAST_TOKEN{}PPUSH_VALUE($3,__TEMP,$4)},
