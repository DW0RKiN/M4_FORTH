...
dnl
define({__BEFORE_X_TOKEN_NAME},   {ifelse(__SAVE_EVAL(}__COUNT_TOKEN{>$1),1,{defn({__TOKEN[}eval(__COUNT_TOKEN-$1){].NAME})})}){}dnl
define({__BEFORE_X_TOKEN_INFO},   {ifelse(__SAVE_EVAL(}__COUNT_TOKEN{>$1),1,{defn({__TOKEN[}eval(__COUNT_TOKEN-$1){].INFO})})}){}dnl
define({__BEFORE_X_TOKEN_ITEMS},  {ifelse(__SAVE_EVAL(}__COUNT_TOKEN{>$1),1,{__DIM(__SPOJ({__ALL},defn(__TOKEN[}eval(__COUNT_TOKEN-$1){].PARAM)))})}){}dnl
define({__BEFORE_X_TOKEN_PARAM},  {ifelse(__SAVE_EVAL(}__COUNT_TOKEN{>$1),1,{defn({__TOKEN[}eval(__COUNT_TOKEN-$1){].PARAM})})}){}dnl
define({__BEFORE_X_TOKEN_ARRAY},  {ifelse(__SAVE_EVAL(}__COUNT_TOKEN{>$1),1,{__GET_TOKEN_ARRAY(eval(__COUNT_TOKEN-$1))})}){}dnl
define({__BEFORE_X_TOKEN_ARRAY_1},{ifelse(__SAVE_EVAL(}__COUNT_TOKEN{>$1),1,{__GET_TOKEN_ARRAY_1(eval(__COUNT_TOKEN-$1))})}){}dnl
define({__BEFORE_X_TOKEN_ARRAY_2},{ifelse(__SAVE_EVAL(}__COUNT_TOKEN{>$1),1,{__GET_TOKEN_ARRAY_2(eval(__COUNT_TOKEN-$1))})}){}dnl
define({__BEFORE_X_TOKEN_ARRAY_3},{ifelse(__SAVE_EVAL(}__COUNT_TOKEN{>$1),1,{__GET_TOKEN_ARRAY_3(eval(__COUNT_TOKEN-$1))})}){}dnl
define({__BEFORE_X_TOKEN_ARRAY_4},{ifelse(__SAVE_EVAL(}__COUNT_TOKEN{>$1),1,{__GET_TOKEN_ARRAY_4(eval(__COUNT_TOKEN-$1))})}){}dnl
...
define({__BEFORELAST_TOKEN_PARAM},  {ifelse(__SAVE_EVAL(}__COUNT_TOKEN{>1),1,{defn({__TOKEN[}eval(__COUNT_TOKEN-1){].PARAM})})}){}dnl
define({__BEFORELAST_TOKEN_ARRAY},  {ifelse(__SAVE_EVAL(}__COUNT_TOKEN{>1),1,{__GET_TOKEN_ARRAY(eval(__COUNT_TOKEN-1))})}){}dnl
define({__BEFORELAST_TOKEN_ARRAY_1},{ifelse(__SAVE_EVAL(}__COUNT_TOKEN{>1),1,{__GET_TOKEN_ARRAY_1(eval(__COUNT_TOKEN-1))})}){}dnl
define({__BEFORELAST_TOKEN_ARRAY_2},{ifelse(__SAVE_EVAL(}__COUNT_TOKEN{>1),1,{__GET_TOKEN_ARRAY_2(eval(__COUNT_TOKEN-1))})}){}dnl
define({__BEFORELAST_TOKEN_ARRAY_3},{ifelse(__SAVE_EVAL(}__COUNT_TOKEN{>1),1,{__GET_TOKEN_ARRAY_3(eval(__COUNT_TOKEN-1))})}){}dnl
define({__BEFORELAST_TOKEN_ARRAY_4},{ifelse(__SAVE_EVAL(}__COUNT_TOKEN{>1),1,{__GET_TOKEN_ARRAY_4(eval(__COUNT_TOKEN-1))})}){}dnl
define({__BEFORELAST_TOKEN_ARRAY_5},{ifelse(__SAVE_EVAL(}__COUNT_TOKEN{>1),1,{__GET_TOKEN_ARRAY_5(eval(__COUNT_TOKEN-1))})}){}dnl
define({__BEFORELAST_TOKEN_ARRAY_6},{ifelse(__SAVE_EVAL(}__COUNT_TOKEN{>1),1,{__GET_TOKEN_ARRAY_6(eval(__COUNT_TOKEN-1))})}){}dnl
dnl
define({__BEFORELAST_TOKEN_REVERSE_1},{__REVERSE_1_PAR(__GET_TOKEN_ARRAY(eval(__COUNT_TOKEN-1)))}){}dnl
define({__BEFORELAST_TOKEN_REVERSE_2},{__REVERSE_2_PAR(__GET_TOKEN_ARRAY(eval(__COUNT_TOKEN-1)))}){}dnl
define({__BEFORELAST_TOKEN_REVERSE_3},{__REVERSE_3_PAR(__GET_TOKEN_ARRAY(eval(__COUNT_TOKEN-1)))}){}dnl
define({__BEFORELAST_TOKEN_REVERSE_4},{__REVERSE_4_PAR(__GET_TOKEN_ARRAY(eval(__COUNT_TOKEN-1)))}){}dnl
dnl
define({__BEFORELAST_TOKEN_LAST_1_PAR},{__LAST_1_PAR(__GET_TOKEN_ARRAY(eval(__COUNT_TOKEN-1)))}){}dnl
define({__BEFORELAST_TOKEN_LAST_2_PAR},{__LAST_2_PAR(__GET_TOKEN_ARRAY(eval(__COUNT_TOKEN-1)))}){}dnl
define({__BEFORELAST_TOKEN_LAST_3_PAR},{__LAST_3_PAR(__GET_TOKEN_ARRAY(eval(__COUNT_TOKEN-1)))}){}dnl
define({__BEFORELAST_TOKEN_LAST_4_PAR},{__LAST_4_PAR(__GET_TOKEN_ARRAY(eval(__COUNT_TOKEN-1)))}){}dnl
dnl
define({__BEFORELAST_TOKEN_IS_PTR_REVERSE_1},{__IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_1)}){}dnl
define({__BEFORELAST_TOKEN_IS_PTR_REVERSE_2},{__IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_2)}){}dnl
define({__BEFORELAST_TOKEN_IS_PTR_REVERSE_3},{__IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_3)}){}dnl
define({__BEFORELAST_TOKEN_IS_PTR_REVERSE_4},{__IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_4)}){}dnl
define({__BEFORELAST_TOKEN_IS_PTR_REVERSE_2_1},    {eval(                                                                                      __IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_2)|__IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_1))}){}dnl
define({__BEFORELAST_TOKEN_IS_PTR_REVERSE_3_1},    {eval(                                           __IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_3)|                                           __IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_1))}){}dnl
define({__BEFORELAST_TOKEN_IS_PTR_REVERSE_4_1},    {eval(__IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_4)|                                                                                      __IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_1))}){}dnl
define({__BEFORELAST_TOKEN_IS_PTR_REVERSE_3_2},    {eval(                                           __IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_3)|__IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_2)                                           )}){}dnl
define({__BEFORELAST_TOKEN_IS_PTR_REVERSE_4_2},    {eval(__IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_4)|                                           __IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_2)                                           )}){}dnl
define({__BEFORELAST_TOKEN_IS_PTR_REVERSE_4_3},    {eval(__IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_4)|__IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_3)                                                                                      )}){}dnl
define({__BEFORELAST_TOKEN_IS_PTR_REVERSE_3_2_1},  {eval(                                           __IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_3)|__IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_2)|__IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_1))}){}dnl
define({__BEFORELAST_TOKEN_IS_PTR_REVERSE_4_3_2_1},{eval(__IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_4)|__IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_3)|__IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_2)|__IS_MEM_REF(__BEFORELAST_TOKEN_REVERSE_1))}){}dnl
dnl
define({__BEFORELAST_TOKEN_IS_NUM_REVERSE_1},{__IS_NUM(__BEFORELAST_TOKEN_REVERSE_1)}){}dnl
define({__BEFORELAST_TOKEN_IS_NUM_REVERSE_2},{__IS_NUM(__BEFORELAST_TOKEN_REVERSE_2)}){}dnl
define({__BEFORELAST_TOKEN_IS_NUM_REVERSE_3},{__IS_NUM(__BEFORELAST_TOKEN_REVERSE_3)}){}dnl
define({__BEFORELAST_TOKEN_IS_NUM_REVERSE_4},{__IS_NUM(__BEFORELAST_TOKEN_REVERSE_4)}){}dnl
define({__BEFORELAST_TOKEN_IS_NUM_REVERSE_2_1},    {eval(                                                                              __IS_NUM(__BEFORELAST_TOKEN_REVERSE_2)&__IS_NUM(__BEFORELAST_TOKEN_REVERSE_1))}){}dnl
define({__BEFORELAST_TOKEN_IS_NUM_REVERSE_4_3},    {eval(__IS_NUM(__BEFORELAST_TOKEN_REVERSE_4)&__IS_NUM(__BEFORELAST_TOKEN_REVERSE_3)                                                                              )}){}dnl
define({__BEFORELAST_TOKEN_IS_NUM_REVERSE_3_2_1},  {eval(                                       __IS_NUM(__BEFORELAST_TOKEN_REVERSE_3)&__IS_NUM(__BEFORELAST_TOKEN_REVERSE_2)&__IS_NUM(__BEFORELAST_TOKEN_REVERSE_1))}){}dnl
define({__BEFORELAST_TOKEN_IS_NUM_REVERSE_4_3_2_1},{eval(__IS_NUM(__BEFORELAST_TOKEN_REVERSE_4)&__IS_NUM(__BEFORELAST_TOKEN_REVERSE_3)&__IS_NUM(__BEFORELAST_TOKEN_REVERSE_2)&__IS_NUM(__BEFORELAST_TOKEN_REVERSE_1))}){}dnl
dnl
define({__LAST_TOKEN_NAME},   {defn({__TOKEN[}__COUNT_TOKEN{].NAME})}){}dnl
define({__LAST_TOKEN_INFO},   {defn({__TOKEN[}__COUNT_TOKEN{].INFO})}){}dnl
define({__LAST_TOKEN_ITEMS},  {__DIM(__SPOJ({__ALL},defn(__TOKEN[}__COUNT_TOKEN{].PARAM)))}){}dnl
define({__LAST_TOKEN_PARAM},  {defn({__TOKEN[}__COUNT_TOKEN{].PARAM})}){}dnl
define({__LAST_TOKEN_ARRAY},  {__GET_TOKEN_ARRAY(__COUNT_TOKEN)}){}dnl
define({__LAST_TOKEN_ARRAY_1},{__GET_TOKEN_ARRAY_1(__COUNT_TOKEN)}){}dnl
define({__LAST_TOKEN_ARRAY_2},{__GET_TOKEN_ARRAY_2(__COUNT_TOKEN)}){}dnl
define({__LAST_TOKEN_ARRAY_3},{__GET_TOKEN_ARRAY_3(__COUNT_TOKEN)}){}dnl
define({__LAST_TOKEN_ARRAY_4},{__GET_TOKEN_ARRAY_4(__COUNT_TOKEN)}){}dnl
define({__LAST_TOKEN_ARRAY_5},{__GET_TOKEN_ARRAY_5(__COUNT_TOKEN)}){}dnl
define({__LAST_TOKEN_ARRAY_6},{__GET_TOKEN_ARRAY_6(__COUNT_TOKEN)}){}dnl
dnl
define({__LAST_TOKEN_REVERSE_1},{__REVERSE_1_PAR(__GET_TOKEN_ARRAY(__COUNT_TOKEN))}){}dnl
define({__LAST_TOKEN_REVERSE_2},{__REVERSE_2_PAR(__GET_TOKEN_ARRAY(__COUNT_TOKEN))}){}dnl
define({__LAST_TOKEN_REVERSE_3},{__REVERSE_3_PAR(__GET_TOKEN_ARRAY(__COUNT_TOKEN))}){}dnl
define({__LAST_TOKEN_REVERSE_4},{__REVERSE_4_PAR(__GET_TOKEN_ARRAY(__COUNT_TOKEN))}){}dnl
dnl
...
define({__LAST_TOKEN_EVAL_REVERSE_4},{ifelse(__IS_NUM(__LAST_TOKEN_REVERSE_4),1,{eval(__LAST_TOKEN_REVERSE_4)})}){}dnl
dnl
define({__LAST_TOKEN_HEX_REVERSE_1},{ifelse(__IS_NUM(__LAST_TOKEN_REVERSE_1),1,{__HEX_HL(__LAST_TOKEN_REVERSE_1)})}){}dnl
define({__LAST_TOKEN_HEX_REVERSE_2},{ifelse(__IS_NUM(__LAST_TOKEN_REVERSE_2),1,{__HEX_HL(__LAST_TOKEN_REVERSE_2)})}){}dnl
define({__LAST_TOKEN_HEX_REVERSE_3},{ifelse(__IS_NUM(__LAST_TOKEN_REVERSE_3),1,{__HEX_HL(__LAST_TOKEN_REVERSE_3)})}){}dnl
define({__LAST_TOKEN_HEX_REVERSE_4},{ifelse(__IS_NUM(__LAST_TOKEN_REVERSE_4),1,{__HEX_HL(__LAST_TOKEN_REVERSE_4)})}){}dnl
dnl
...
define({__LAST_TOKEN_IS_PTR_REVERSE_3_1},    {eval(                                     __IS_MEM_REF(__LAST_TOKEN_REVERSE_3)|                                     __IS_MEM_REF(__LAST_TOKEN_REVERSE_1))}){}dnl
define({__LAST_TOKEN_IS_PTR_REVERSE_4_1},    {eval(__IS_MEM_REF(__LAST_TOKEN_REVERSE_4)|                                                                          __IS_MEM_REF(__LAST_TOKEN_REVERSE_1))}){}dnl
define({__LAST_TOKEN_IS_PTR_REVERSE_3_2},    {eval(                                     __IS_MEM_REF(__LAST_TOKEN_REVERSE_3)|__IS_MEM_REF(__LAST_TOKEN_REVERSE_2)                                     )}){}dnl
define({__LAST_TOKEN_IS_PTR_REVERSE_4_2},    {eval(__IS_MEM_REF(__LAST_TOKEN_REVERSE_4)|                                     __IS_MEM_REF(__LAST_TOKEN_REVERSE_2)                                     )}){}dnl
...
define({__LAST_TOKEN_IS_PTR_REVERSE_4_3_2_1},{eval(__IS_MEM_REF(__LAST_TOKEN_REVERSE_4)|__IS_MEM_REF(__LAST_TOKEN_REVERSE_3)|__IS_MEM_REF(__LAST_TOKEN_REVERSE_2)|__IS_MEM_REF(__LAST_TOKEN_REVERSE_1))}){}dnl
dnl
...
a,,,
            ...
            __LAST_TOKEN_NAME:$1,{__TOKEN_ULT:__TOKEN_WHILE},{__SET_TOKEN({__TOKEN_ULT_WHILE},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME:$1,{__TOKEN_UGT:__TOKEN_WHILE},{__SET_TOKEN({__TOKEN_UGT_WHILE},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME:$1,{__TOKEN_ULE:__TOKEN_WHILE},{__SET_TOKEN({__TOKEN_ULE_WHILE},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME:$1,{__TOKEN_UGE:__TOKEN_WHILE},{__SET_TOKEN({__TOKEN_UGE_WHILE},__LAST_TOKEN_INFO{ }$2)},

__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:__LAST_TOKEN_EVAL_REVERSE_1:$1,                        __TOKEN_PUSHS:1:0:__TOKEN_EQ,                {__SET_TOKEN({__TOKEN_0EQ},  __LAST_TOKEN_INFO{ }$2)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:__LAST_TOKEN_EVAL_REVERSE_1:$1,__TOKEN_CFETCH:__TOKEN_PUSHS:1:0:__TOKEN_CEQ,{define({__TEMP},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2){}__DELETE_LAST_TOKEN{}__SET_TOKEN({__TOKEN_CFETCH_0CEQ},__TEMP)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:__LAST_TOKEN_EVAL_REVERSE_1:$1,__TOKEN_CFETCH:__TOKEN_PUSHS:1:0:__TOKEN_CNE,{define({__TEMP},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2){}__DELETE_LAST_TOKEN{}__SET_TOKEN({__TOKEN_CFETCH_0CNE},__TEMP)},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:__LAST_TOKEN_EVAL_REVERSE_1:$1,                        __TOKEN_PUSHS:1:0:__TOKEN_CEQ,               {__SET_TOKEN({__TOKEN_0CEQ}, __LAST_TOKEN_INFO{ }$2)},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:__LAST_TOKEN_EVAL_REVERSE_1:$1,                        __TOKEN_PUSHS:1:0:__TOKEN_CNE,               {__SET_TOKEN({__TOKEN_0CNE}, __LAST_TOKEN_INFO{ }$2)},
            ...
            __LAST_TOKEN_NAME:$1,{__TOKEN_LT:__TOKEN_IF},{ifelse(__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS,__TOKEN_DUP_PUSHS:1,{__DELETE_LAST_TOKEN{}__SET_TOKEN({__TOKEN_DUP_PUSH_LT_IF},__LAST_TOKEN_INFO{ <}$2, __LAST_TOKEN_ARRAY)},{__SET_TOKEN({__TOKEN_LT_IF},__LAST_TOKEN_INFO{ }$2)})},
            __LAST_TOKEN_NAME:$1,{__TOKEN_GT:__TOKEN_IF},{ifelse(__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS,__TOKEN_DUP_PUSHS:1,{__DELETE_LAST_TOKEN{}__SET_TOKEN({__TOKEN_DUP_PUSH_GT_IF},__LAST_TOKEN_INFO{ >}$2, __LAST_TOKEN_ARRAY)},{__SET_TOKEN({__TOKEN_GT_IF},__LAST_TOKEN_INFO{ }$2)})},
            __LAST_TOKEN_NAME:$1,{__TOKEN_LE:__TOKEN_IF},{ifelse(__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS,__TOKEN_DUP_PUSHS:1,{__DELETE_LAST_TOKEN{}__SET_TOKEN({__TOKEN_DUP_PUSH_LE_IF},__LAST_TOKEN_INFO{ <=}$2,__LAST_TOKEN_ARRAY)},{__SET_TOKEN({__TOKEN_LE_IF},__LAST_TOKEN_INFO{ }$2)})},
            __LAST_TOKEN_NAME:$1,{__TOKEN_GE:__TOKEN_IF},{ifelse(__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS,__TOKEN_DUP_PUSHS:1,{__DELETE_LAST_TOKEN{}__SET_TOKEN({__TOKEN_DUP_PUSH_GE_IF},__LAST_TOKEN_INFO{ >=}$2,__LAST_TOKEN_ARRAY)},{__SET_TOKEN({__TOKEN_GE_IF},__LAST_TOKEN_INFO{ }$2)})},

            __LAST_TOKEN_NAME:$1,{__TOKEN_UEQ:__TOKEN_IF},{ifelse(__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS,__TOKEN_DUP_PUSH:1,{__DELETE_LAST_TOKEN{}__SET_TOKEN({__TOKEN_DUP_PUSH_UEQ_IF},__LAST_TOKEN_INFO{ u=}$2, __LAST_TOKEN_ARRAY)},{__SET_TOKEN({__TOKEN_UEQ_IF},__LAST_TOKEN_INFO{ }$2)})},
            __LAST_TOKEN_NAME:$1,{__TOKEN_UNE:__TOKEN_IF},{ifelse(__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS,__TOKEN_DUP_PUSH:1,{__DELETE_LAST_TOKEN{}__SET_TOKEN({__TOKEN_DUP_PUSH_UNE_IF},__LAST_TOKEN_INFO{ u<>}$2,__LAST_TOKEN_ARRAY)},{__SET_TOKEN({__TOKEN_UNE_IF},__LAST_TOKEN_INFO{ }$2)})},
            __LAST_TOKEN_NAME:$1,{__TOKEN_ULT:__TOKEN_IF},{ifelse(__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS,__TOKEN_DUP_PUSH:1,{__DELETE_LAST_TOKEN{}__SET_TOKEN({__TOKEN_DUP_PUSH_ULT_IF},__LAST_TOKEN_INFO{ u<}$2, __LAST_TOKEN_ARRAY)},{__SET_TOKEN({__TOKEN_ULT_IF},__LAST_TOKEN_INFO{ }$2)})},
            __LAST_TOKEN_NAME:$1,{__TOKEN_UGT:__TOKEN_IF},{ifelse(__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS,__TOKEN_DUP_PUSH:1,{__DELETE_LAST_TOKEN{}__SET_TOKEN({__TOKEN_DUP_PUSH_UGT_IF},__LAST_TOKEN_INFO{ u>}$2, __LAST_TOKEN_ARRAY)},{__SET_TOKEN({__TOKEN_UGT_IF},__LAST_TOKEN_INFO{ }$2)})},
            __LAST_TOKEN_NAME:$1,{__TOKEN_ULE:__TOKEN_IF},{ifelse(__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS,__TOKEN_DUP_PUSH:1,{__DELETE_LAST_TOKEN{}__SET_TOKEN({__TOKEN_DUP_PUSH_ULE_IF},__LAST_TOKEN_INFO{ u<=}$2,__LAST_TOKEN_ARRAY)},{__SET_TOKEN({__TOKEN_ULE_IF},__LAST_TOKEN_INFO{ }$2)})},
            __LAST_TOKEN_NAME:$1,{__TOKEN_UGE:__TOKEN_IF},{ifelse(__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS,__TOKEN_DUP_PUSH:1,{__DELETE_LAST_TOKEN{}__SET_TOKEN({__TOKEN_DUP_PUSH_UGE_IF},__LAST_TOKEN_INFO{ u>=}$2,__LAST_TOKEN_ARRAY)},{__SET_TOKEN({__TOKEN_UGE_IF},__LAST_TOKEN_INFO{ }$2)})},
...
_2,,,
            ...
            __LAST_TOKEN_NAME-$1,{__TOKEN_2DUP-__TOKEN_CSTORE},{__SET_TOKEN({__TOKEN_2DUP_CSTORE},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME-$1,{__TOKEN_2DUP-__TOKEN_HSTORE},{__SET_TOKEN({__TOKEN_2DUP_HSTORE},__LAST_TOKEN_INFO{ }$2)},
            __BEFORE_X_TOKEN_NAME(2):__BEFORELAST_TOKEN_NAME=__BEFORELAST_TOKEN_LAST_1_PAR:__LAST_TOKEN_NAME:$1,
               __TOKEN_OVER:__TOKEN_PUSH_RSHIFT=8:__TOKEN_OVER:__TOKEN_CSTORE,
                  {__SET_TOKEN_X(eval(__COUNT_TOKEN-2),{__TOKEN_2DUP_HSTORE},__BEFORE_X_TOKEN_INFO(2){ }__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2){}__DELETE_LAST_TOKEN{}__DELETE_LAST_TOKEN},
            
            __LAST_TOKEN_NAME-$1,{__TOKEN_2DUP_STORE-__TOKEN_2ADD},{__SET_TOKEN({__TOKEN_2DUP_STORE_2ADD},__LAST_TOKEN_INFO{ }$2)},

            __LAST_TOKEN_NAME-$1,{__TOKEN_2DUP-__TOKEN_CEQ}, {__SET_TOKEN({__TOKEN_2DUP_CEQ}, __LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME-$1,{__TOKEN_2DUP-__TOKEN_CNE}, {__SET_TOKEN({__TOKEN_2DUP_CNE}, __LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME-$1,{__TOKEN_2DUP-__TOKEN_CULT},{__SET_TOKEN({__TOKEN_2DUP_CULT},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME-$1,{__TOKEN_2DUP-__TOKEN_CUGT},{__SET_TOKEN({__TOKEN_2DUP_CUGT},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME-$1,{__TOKEN_2DUP-__TOKEN_CULE},{__SET_TOKEN({__TOKEN_2DUP_CULE},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME-$1,{__TOKEN_2DUP-__TOKEN_CUGE},{__SET_TOKEN({__TOKEN_2DUP_CUGE},__LAST_TOKEN_INFO{ }$2)},

            __LAST_TOKEN_NAME-$1,{__TOKEN_2DUP-__TOKEN_HEQ}, {__SET_TOKEN({__TOKEN_2DUP_HEQ}, __LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME-$1,{__TOKEN_2DUP-__TOKEN_HNE}, {__SET_TOKEN({__TOKEN_2DUP_HNE}, __LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME-$1,{__TOKEN_2DUP-__TOKEN_HULT},{__SET_TOKEN({__TOKEN_2DUP_HULT},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME-$1,{__TOKEN_2DUP-__TOKEN_HUGT},{__SET_TOKEN({__TOKEN_2DUP_HUGT},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME-$1,{__TOKEN_2DUP-__TOKEN_HULE},{__SET_TOKEN({__TOKEN_2DUP_HULE},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME-$1,{__TOKEN_2DUP-__TOKEN_HUGE},{__SET_TOKEN({__TOKEN_2DUP_HUGE},__LAST_TOKEN_INFO{ }$2)},
            ...
            __LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1,  __TOKEN_PUSHS:1:__TOKEN_2DUP, {__SET_TOKEN({__TOKEN_PUSHS},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY,__LAST_TOKEN_REVERSE_2,__LAST_TOKEN_REVERSE_1)},
...
c...,,,
           ...
           __LAST_TOKEN_NAME:$1,                              __TOKEN_CFETCH:__TOKEN_0CNE,               {__SET_TOKEN({__TOKEN_CFETCH_0CNE},__LAST_TOKEN_INFO{ }$2)},
           __LAST_TOKEN_NAME:$1,                              __TOKEN_CFETCH:__TOKEN_0CEQ,               {__SET_TOKEN({__TOKEN_CFETCH_0CEQ},__LAST_TOKEN_INFO{ }$2)},

dnl # DUP
dup,,,

__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1, __TOKEN_DUP:__TOKEN_DUP_TYPE_I:__TOKEN_DROP,{__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_DUP_TYPE_I},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__BEFORELAST_TOKEN_ARRAY){}__DELETE_LAST_TOKEN},
...
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1, __TOKEN_DUP:__TOKEN_DUP_EMIT:__TOKEN_DROP,{__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_DUP_EMIT},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__BEFORELAST_TOKEN_ARRAY){}__DELETE_LAST_TOKEN},
            ...
            __LAST_TOKEN_NAME:$1,                         __TOKEN_DUP:__TOKEN_UNTIL,                   {__SET_TOKEN({__TOKEN_DUP_UNTIL},__LAST_TOKEN_INFO{ }$2)},
            __BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1, __TOKEN_DUP:__TOKEN_0EQ:__TOKEN_UNTIL,       {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_DUP_0EQ_UNTIL},       __BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2){}__DELETE_LAST_TOKEN},
            __BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1, __TOKEN_DUP_CFETCH:__TOKEN_0EQ:__TOKEN_UNTIL,{__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_DUP_CFETCH_0EQ_UNTIL},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2){}__DELETE_LAST_TOKEN},
            __BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1, __TOKEN_DUP_CFETCH:__TOKEN_0EQ:__TOKEN_WHILE,{__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_DUP_CFETCH_0EQ_WHILE},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2){}__DELETE_LAST_TOKEN},
...
d...,,,
            ...
            __LAST_TOKEN_NAME:$1,   __TOKEN_PD0EQ:__TOKEN_IF, {__SET_TOKEN({__TOKEN_PD0EQ_IF},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME:$1,   __TOKEN_PD0NE:__TOKEN_IF, {__SET_TOKEN({__TOKEN_PD0NE_IF},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME:$1,   __TOKEN_PDEQ:__TOKEN_IF,  {__SET_TOKEN({__TOKEN_PDEQ_IF},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME:$1,   __TOKEN_PDNE:__TOKEN_IF,  {__SET_TOKEN({__TOKEN_PDNE_IF},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME:$1,   __TOKEN_PDULT:__TOKEN_IF, {__SET_TOKEN({__TOKEN_PDULT_IF},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME:$1,   __TOKEN_PDUGT:__TOKEN_IF, {__SET_TOKEN({__TOKEN_PDUGT_IF},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME:$1,   __TOKEN_PDULE:__TOKEN_IF, {__SET_TOKEN({__TOKEN_PDULE_IF},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME:$1,   __TOKEN_PDUGE:__TOKEN_IF, {__SET_TOKEN({__TOKEN_PDUGE_IF},__LAST_TOKEN_INFO{ }$2)},
...
dnl # H...
h....,,,
            __LAST_TOKEN_NAME:$1,         __TOKEN_HEX:__TOKEN_UDOT,   {__SET_TOKEN({__TOKEN_HEX_UDOT},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME:$1,         __TOKEN_HEX:__TOKEN_UDDOT,  {__SET_TOKEN({__TOKEN_HEX_UDDOT},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME:$1,         __TOKEN_HEX:__TOKEN_PUDOT,  {__SET_TOKEN({__TOKEN_HEX_PUDOT},__LAST_TOKEN_INFO{ }$2,$3)},
...
o...,,,
            ...
            __LAST_TOKEN_NAME-$1,{__TOKEN_OVER_SWAP-__TOKEN_CADD},{__SET_TOKEN({__TOKEN_OVER_SWAP_CADD},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME-$1,{__TOKEN_OVER_SWAP-__TOKEN_CSUB},{__SET_TOKEN({__TOKEN_OVER_SWAP_CSUB},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME-$1,{__TOKEN_OVER_SWAP-__TOKEN_HADD},{__SET_TOKEN({__TOKEN_OVER_SWAP_HADD},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME-$1,{__TOKEN_OVER_SWAP-__TOKEN_HSUB},{__SET_TOKEN({__TOKEN_OVER_SWAP_HSUB},__LAST_TOKEN_INFO{ }$2)},

            __LAST_TOKEN_NAME-$1,{__TOKEN_OVER_SWAP-__TOKEN_CSTORE},{__SET_TOKEN({__TOKEN_OVER_SWAP_CSTORE},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME-$1,{__TOKEN_OVER_SWAP-__TOKEN_HSTORE},{__SET_TOKEN({__TOKEN_OVER_SWAP_HSTORE},__LAST_TOKEN_INFO{ }$2)},
            __LAST_TOKEN_NAME-$1,{__TOKEN_OVER_SWAP-__TOKEN_STORE}, {__SET_TOKEN({__TOKEN_OVER_SWAP_STORE}, __LAST_TOKEN_INFO{ }$2)},

            __BEFORE_X_TOKEN_NAME(2):__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1,
               __TOKEN_OVER:__TOKEN_CFETCH:__TOKEN_OVER:__TOKEN_CFETCH,
                  {__SET_TOKEN_X(eval(__COUNT_TOKEN-2),{__TOKEN_OVER_CFETCH_OVER_CFETCH},__BEFORE_X_TOKEN_INFO(2){ }__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2){}__DELETE_LAST_TOKEN{}__DELETE_LAST_TOKEN},

            __LAST_TOKEN_NAME-$1,{__TOKEN_OVER_CFETCH_OVER_CFETCH-__TOKEN_CEQ},{__SET_TOKEN({__TOKEN_OVER_CFETCH_OVER_CFETCH_CEQ},__LAST_TOKEN_INFO{ }$2)},

            __LAST_TOKEN_NAME:$1,                              __TOKEN_OVER:__TOKEN_UNTIL,               {__SET_TOKEN({__TOKEN_OVER_UNTIL},__LAST_TOKEN_INFO{ }$2)},
            __BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1,      __TOKEN_OVER:__TOKEN_CFETCH:__TOKEN_UNTIL,{__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_OVER_CFETCH_UNTIL},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2){}__DELETE_LAST_TOKEN},
            __BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1,      __TOKEN_OVER:__TOKEN_CFETCH:__TOKEN_WHILE,{__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_OVER_CFETCH_WHILE},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2){}__DELETE_LAST_TOKEN},
            __BEFORE_X_TOKEN_NAME(2):__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1,  __TOKEN_OVER:__TOKEN_CFETCH:__TOKEN_0EQ:__TOKEN_UNTIL,   {__SET_TOKEN_X(eval(__COUNT_TOKEN-2),{__TOKEN_OVER_CFETCH_0EQ_UNTIL},__BEFORE_X_TOKEN_INFO(2){ }__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2){}__DELETE_LAST_TOKEN{}__DELETE_LAST_TOKEN},
            __BEFORE_X_TOKEN_NAME(2):__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1,  __TOKEN_OVER:__TOKEN_CFETCH:__TOKEN_0EQ:__TOKEN_WHILE,   {__SET_TOKEN_X(eval(__COUNT_TOKEN-2),{__TOKEN_OVER_CFETCH_0EQ_WHILE},__BEFORE_X_TOKEN_INFO(2){ }__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2){}__DELETE_LAST_TOKEN{}__DELETE_LAST_TOKEN},

            __BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1,      __TOKEN_OVER:__TOKEN_0EQ:__TOKEN_UNTIL,     {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_OVER_0EQ_UNTIL},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2){}__DELETE_LAST_TOKEN},
            __LAST_TOKEN_NAME:$1,                              __TOKEN_2OVER_NIP:__TOKEN_UNTIL,            {__SET_TOKEN({__TOKEN_2OVER_NIP_UNTIL},__LAST_TOKEN_INFO{ }$2)},
            __BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1,      __TOKEN_2OVER_NIP:__TOKEN_0EQ:__TOKEN_UNTIL,{__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_2OVER_NIP_0EQ_UNTIL},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2){}__DELETE_LAST_TOKEN},
            __BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1,      __TOKEN_2OVER_NIP:__TOKEN_CFETCH_0CEQ:__TOKEN_UNTIL,{__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_2OVER_NIP_CFETCH_0CEQ_UNTIL},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2){}__DELETE_LAST_TOKEN},
            __BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1,      __TOKEN_2OVER_NIP:__TOKEN_CFETCH_0CEQ:__TOKEN_WHILE,{__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_2OVER_NIP_CFETCH_0CEQ_WHILE},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2){}__DELETE_LAST_TOKEN},
...
dnl # PUSHDOT
pushdot,,,
            __LAST_TOKEN_NAME:$1:__IS_NUM($3),                 __TOKEN_PUSHS:__TOKEN_PUSHDOT:1, {__SET_TOKEN({__TOKEN_PUSHS},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY,__HEX_DE($3),__HEX_HL($3))},
            __LAST_TOKEN_NAME:$1:__IS_MEM_REF($3),             __TOKEN_PUSHS:__TOKEN_PUSHDOT:1, {__SET_TOKEN({__TOKEN_PUSHS},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY,($3+2),$3)},
...
__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS:__LAST_TOKEN_NAME:$1, __TOKEN_PUSHS:1:__TOKEN_DUP_EMIT:__TOKEN_DROP,{__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_PUSH_EMIT},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__BEFORELAST_TOKEN_ARRAY){}__DELETE_LAST_TOKEN},
            ...
            {__TOKEN_PUSH_FETCH:__TOKEN_PUSHS:1=1:__TOKEN_ADD},        {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_PUSH_FETCH_1ADD},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2,__BEFORELAST_TOKEN_ARRAY){}__DELETE_LAST_TOKEN},
            __BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS=__LAST_TOKEN_EVAL_REVERSE_1:$1,
            {__TOKEN_PUSH_FETCH:__TOKEN_PUSHS:1=2:__TOKEN_ADD},        {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_PUSH_FETCH_2ADD},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2,__BEFORELAST_TOKEN_ARRAY){}__DELETE_LAST_TOKEN},
            __BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,
            {__TOKEN_PUSH_FETCH:__TOKEN_PUSHS:1:__TOKEN_ADD},          {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_PUSH_FETCH_PUSH_ADD},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2,__BEFORELAST_TOKEN_ARRAY,__LAST_TOKEN_ARRAY){}__DELETE_LAST_TOKEN},
            __LAST_TOKEN_NAME:$1,
            {__TOKEN_PUSH2_FETCH:__TOKEN_ADD},                         {__SET_TOKEN({__TOKEN_PUSH_FETCH_PUSH_ADD},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_REVERSE_1,__LAST_TOKEN_REVERSE_2)},
            ...
            __LAST_TOKEN_NAME:$1:$#,                   {__TOKEN_PUSH_FETCH_PUSH_ADD:__TOKEN_PUSHS:3},{__SET_TOKEN({__TOKEN_PUSH_FETCH_PUSH_ADD_PUSH},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY,$3)},
            ...
            __LAST_TOKEN_NAME-$1,                      {__TOKEN_PUSH_FETCH_PUSH_ADD_PUSH-__TOKEN_STORE},{__SET_TOKEN({__TOKEN_PUSH_FETCH_PUSH_ADD_PUSH_STORE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            ...
            __LAST_TOKEN_NAME:$1,                                         __TOKEN_PUSH_CFETCH:__TOKEN_ADD,           {__SET_TOKEN({__TOKEN_PUSH_CFETCH_ADD},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},

            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_FOR,               {__SET_LOOP_BEGIN($3,__LAST_TOKEN_ARRAY_1){}__SET_TOKEN({__TOKEN_PUSH_FOR},__LAST_TOKEN_INFO{ }$2,$3)},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_QFOR,              {__SET_LOOP_BEGIN($3,__LAST_TOKEN_ARRAY_1){}__SET_TOKEN({__TOKEN_PUSH_QFOR},__LAST_TOKEN_INFO{ }$2,$3)},
            ...
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_I,                 {__SET_TOKEN({__TOKEN_PUSH_I},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY,$3)},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_J,                 {__SET_TOKEN({__TOKEN_PUSH_J},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY,shift(shift($@)))},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_K,                 {__SET_TOKEN({__TOKEN_PUSH_K},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY,shift(shift($@)))},
            ...
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_DUP,               {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY,__LAST_TOKEN_REVERSE_1)},
            ...
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_PUSH,              {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY,shift(shift($@)))},

            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_DO,                {ifelse(__GET_LOOP_BEGIN($3),{},{dnl
...
__{}__{}__{}__{}__SET_TOKEN({__TOKEN_DO},__LAST_TOKEN_INFO{ }$2,$3)},{__INC_TOKEN_COUNT{}__SET_TOKEN($@)})},
            ...
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_QDO,               {ifelse(__GET_LOOP_BEGIN($3),{},{dnl
__{}__{}__{}__{}__SET_LOOP_BEGIN($3,__LAST_TOKEN_ARRAY_1){}dnl
...
__{}__{}__{}__{}__SET_TOKEN({__TOKEN_QDO},__LAST_TOKEN_INFO{ }$2,$3)},{__INC_TOKEN_COUNT{}__SET_TOKEN($@)})},
            ...
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_MAX,               {__SET_TOKEN({__TOKEN_PUSH_MAX},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_MIN,               {__SET_TOKEN({__TOKEN_PUSH_MIN},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},

            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_N_TO_R,            {__SET_TOKEN({__TOKEN_PUSH_N_TO_R},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            ...
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_RPICK,             {__SET_TOKEN({__TOKEN_PUSH_RPICK},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            ...
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_OF,                {__SET_TOKEN({__TOKEN_PUSH_OF},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            ...
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_PICK,              {__SET_TOKEN({__TOKEN_PUSH_PICK},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            ...
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_R_FETCH,           {__SET_TOKEN({__TOKEN_PUSH_R_FETCH},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            ...
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_CSTORE,            {__SET_TOKEN({__TOKEN_PUSH_CSTORE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_HSTORE,            {__SET_TOKEN({__TOKEN_PUSH_HSTORE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_STORE,             {__SET_TOKEN({__TOKEN_PUSH_STORE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_2STORE,            {__SET_TOKEN({__TOKEN_PUSH_2STORE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_2FETCH,            {__SET_TOKEN({__TOKEN_PUSH_2FETCH},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},

            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_ALLOT,             {__SET_TOKEN({__TOKEN_PUSH_ALLOT},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},

            __BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1,   __TOKEN_PUSH_COMMA:__TOKEN_PUSH:__TOKEN_COMMA,
               {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_PUSHS_COMMA},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__BEFORELAST_TOKEN_ARRAY,__LAST_TOKEN_ARRAY){}__DELETE_LAST_TOKEN},

            __BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1,   __TOKEN_PUSHS_COMMA:__TOKEN_PUSH:__TOKEN_COMMA,
               {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_PUSHS_COMMA},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__BEFORELAST_TOKEN_ARRAY,__LAST_TOKEN_ARRAY){}__DELETE_LAST_TOKEN},

            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_COMMA,             {__SET_TOKEN({__TOKEN_PUSH_COMMA},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_LSHIFT,            {__SET_TOKEN({__TOKEN_PUSH_LSHIFT},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_RSHIFT,            {__SET_TOKEN({__TOKEN_PUSH_RSHIFT},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_SWAP,              {__SET_TOKEN({__TOKEN_PUSH_SWAP},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
...
__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS:__LAST_TOKEN_NAME:$1, __TOKEN_PUSHS:1:__TOKEN_DUP_TYPE_I:__TOKEN_DROP,{__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_PUSH_TYPE_I},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__BEFORELAST_TOKEN_ARRAY){}__DELETE_LAST_TOKEN},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_TYPE_Z,            {__SET_TOKEN({__TOKEN_PUSH_TYPE_Z},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
...
__{}__{}__{}__{}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__TOKEN_I,__BEFORELAST_TOKEN_INFO{ drop},__BEFORELAST_TOKEN_ARRAY_1)},
...
__{}__{}__{}__{}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__TOKEN_I,__BEFORELAST_TOKEN_INFO{ drop},__BEFORELAST_TOKEN_ARRAY_1)},
            ...
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_VALUE,             {__SET_TOKEN({__TOKEN_PUSH_VALUE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY,shift(shift($@)))},

            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_WITHIN,            {__SET_TOKEN({__TOKEN_PUSH_WITHIN},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_LO_WITHIN,         {__SET_TOKEN({__TOKEN_PUSH_LO_WITHIN},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},

            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_EQ,                {__SET_TOKEN({__TOKEN_PUSH_EQ},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            __LAST_TOKEN_NAME-$1,                      {__TOKEN_PUSH_EQ-__TOKEN_IF},             {__SET_TOKEN({__TOKEN_PUSH_EQ_IF},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},

            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                      __TOKEN_PUSHS:1:__TOKEN_NE,                {__SET_TOKEN({__TOKEN_PUSH_NE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
...
__{}__{}__{}__{}__SET_TOKEN({__TOKEN_DO},__LAST_TOKEN_INFO{ }$2,$3)},{__INC_TOKEN_COUNT{}__SET_TOKEN($@)})},
            ...
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                        {__TOKEN_PUSH:2:__TOKEN_QDO},             {ifelse(__GET_LOOP_BEGIN($3):__GET_LOOP_END($3),{:},{dnl
__{}__{}__{}__{}__SET_LOOP_END(  $3,__LAST_TOKEN_ARRAY_1){}dnl
__{}__{}__{}__{}__SET_LOOP_BEGIN($3,__LAST_TOKEN_ARRAY_2){}dnl
__{}__{}__{}__{}__SET_TOKEN({__TOKEN_QDO},__LAST_TOKEN_INFO{ }$2,$3)},{__INC_TOKEN_COUNT{}__SET_TOKEN($@)})},


            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1:__LAST_TOKEN_IS_NUM_1_2,{__TOKEN_PUSHS:2:__TOKEN_WITHIN:1},       {ifelse(eval(__LAST_TOKEN_ARRAY_1),eval(__LAST_TOKEN_ARRAY_2),
            ...
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,     {__TOKEN_PUSHS:2:__TOKEN_WITHIN},       {__SET_TOKEN({__TOKEN_PUSH2_WITHIN},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            ...
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,     {__TOKEN_PUSHS:2:__TOKEN_2OVER},        {__SET_TOKEN({__TOKEN_PUSH2_2OVER},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            ...
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,     {__TOKEN_PUSHS:2:__TOKEN_CSTORE},       {__SET_TOKEN({__TOKEN_PUSH2_CSTORE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,     {__TOKEN_PUSHS:2:__TOKEN_2FETCH},       {__SET_TOKEN({__TOKEN_PUSH2_2FETCH},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},

            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,     {__TOKEN_PUSHS:2:__TOKEN_ADDSTORE},     {__SET_TOKEN({__TOKEN_PUSH2_ADDSTORE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,     {__TOKEN_PUSHS:2:__TOKEN_RPICK},        {__SET_TOKEN({__TOKEN_PUSH2_RPICK},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            ...
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,     {__TOKEN_PUSHS:2:__TOKEN_CFETCH},         {__SET_TOKEN({__TOKEN_PUSH2_CFETCH},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
...
__LAST_TOKEN_NAME:$1,                                                             __TOKEN_PUSHS:__TOKEN_DUP,         {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY,__LAST_TOKEN_REVERSE_1)},
__LAST_TOKEN_NAME:$1,                                                             __TOKEN_PUSHS:__TOKEN_OVER,        {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY,__LAST_TOKEN_REVERSE_2)},

dnl # PUSH4
push4,,,

__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>2):$1:__LAST_TOKEN_IS_PTR_REVERSE_3_2_1,__TOKEN_PUSHS:1:__TOKEN_UMDIVMOD:0,{__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,ifelse(__LAST_TOKEN_ITEMS,3,,__DROP_3_PAR(__LAST_TOKEN_ARRAY){,})__EVAL_S16(um/mod,__LAST_TOKEN_LAST_3_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>2):$1:__LAST_TOKEN_IS_PTR_REVERSE_3_2_1,__TOKEN_PUSHS:1:__TOKEN_SMDIVREM:0,{__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,ifelse(__LAST_TOKEN_ITEMS,3,,__DROP_3_PAR(__LAST_TOKEN_ARRAY){,})__EVAL_S16(sm/rem,__LAST_TOKEN_LAST_3_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>2):$1:__LAST_TOKEN_IS_PTR_REVERSE_3_2_1,__TOKEN_PUSHS:1:__TOKEN_FMDIVMOD:0,{__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,ifelse(__LAST_TOKEN_ITEMS,3,,__DROP_3_PAR(__LAST_TOKEN_ARRAY){,})__EVAL_S16(fm/mod,__LAST_TOKEN_LAST_3_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>2):$1:__LAST_TOKEN_IS_PTR_REVERSE_3_2_1,__TOKEN_PUSHS:1:__TOKEN_MADD:0,    {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,ifelse(__LAST_TOKEN_ITEMS,3,,__DROP_3_PAR(__LAST_TOKEN_ARRAY){,})__EVAL_S16(    m+,__LAST_TOKEN_LAST_3_PAR))},


__LAST_TOKEN_NAME:eval((__LAST_TOKEN_ITEMS>1) && ifelse(__LAST_TOKEN_IS_PTR_REVERSE_2_1,0,{1},
...
__LAST_TOKEN_NAME:eval((__LAST_TOKEN_ITEMS>1) && ifelse(__LAST_TOKEN_IS_PTR_REVERSE_2_1,0,{1},
    ...
    __LAST_TOKEN_EVAL_REVERSE_2,0,{1},
    __LAST_TOKEN_HEX_REVERSE_1,0xFFFF,{1},
    __LAST_TOKEN_HEX_REVERSE_2,0xFFFF,{1},{0})):$1, __TOKEN_PUSHS:1:__TOKEN_OR,       {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(|,__LAST_TOKEN_LAST_2_PAR))},

__LAST_TOKEN_NAME:eval((__LAST_TOKEN_ITEMS>1) && ifelse(__LAST_TOKEN_IS_PTR_REVERSE_2_1,0,{1},
    __LAST_TOKEN_EVAL_REVERSE_1,0,{1},
    __LAST_TOKEN_EVAL_REVERSE_2,0,{1},{0})):$1,     __TOKEN_PUSHS:1:__TOKEN_XOR,      {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(^,__LAST_TOKEN_LAST_2_PAR))},

            __LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1,                                  __TOKEN_PUSHS:1:__TOKEN_AND,       {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH_AND}, __BEFORELAST_TOKEN_INFO{ }$2,ifelse(__BEFORELAST_TOKEN_IS_PTR_REVERSE_1,1,__BEFORELAST_TOKEN_REVERSE_2,__BEFORELAST_TOKEN_REVERSE_1)){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__BEFORELAST_TOKEN_NAME,__BEFORELAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__BEFORELAST_TOKEN_ARRAY){}ifelse(__BEFORELAST_TOKEN_ITEMS,2,,{,}){}ifelse(__BEFORELAST_TOKEN_IS_PTR_REVERSE_1,1,__BEFORELAST_TOKEN_REVERSE_1,__BEFORELAST_TOKEN_REVERSE_2))},
            __LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1,                                  __TOKEN_PUSHS:1:__TOKEN_OR,        {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH_OR},  __BEFORELAST_TOKEN_INFO{ }$2,ifelse(__BEFORELAST_TOKEN_IS_PTR_REVERSE_1,1,__BEFORELAST_TOKEN_REVERSE_2,__BEFORELAST_TOKEN_REVERSE_1)){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__BEFORELAST_TOKEN_NAME,__BEFORELAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__BEFORELAST_TOKEN_ARRAY){}ifelse(__BEFORELAST_TOKEN_ITEMS,2,,{,}){}ifelse(__BEFORELAST_TOKEN_IS_PTR_REVERSE_1,1,__BEFORELAST_TOKEN_REVERSE_1,__BEFORELAST_TOKEN_REVERSE_2))},
            __LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1,                                  __TOKEN_PUSHS:1:__TOKEN_XOR,       {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH_XOR}, __BEFORELAST_TOKEN_INFO{ }$2,ifelse(__BEFORELAST_TOKEN_IS_PTR_REVERSE_1,1,__BEFORELAST_TOKEN_REVERSE_2,__BEFORELAST_TOKEN_REVERSE_1)){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__BEFORELAST_TOKEN_NAME,__BEFORELAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__BEFORELAST_TOKEN_ARRAY){}ifelse(__BEFORELAST_TOKEN_ITEMS,2,,{,}){}ifelse(__BEFORELAST_TOKEN_IS_PTR_REVERSE_1,1,__BEFORELAST_TOKEN_REVERSE_1,__BEFORELAST_TOKEN_REVERSE_2))},

            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1:__LAST_TOKEN_HEX_REVERSE_1,               __TOKEN_PUSHS:1:__TOKEN_AND:0xFFFF,{__DELETE_LAST_TOKEN},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                                          __TOKEN_PUSHS:1:__TOKEN_AND,       {__SET_TOKEN({__TOKEN_PUSH_AND},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},

            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1:__LAST_TOKEN_EVAL_REVERSE_1,              __TOKEN_PUSHS:1:__TOKEN_OR:0,      {__DELETE_LAST_TOKEN},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                                          __TOKEN_PUSHS:1:__TOKEN_OR,        {__SET_TOKEN({__TOKEN_PUSH_OR},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},

            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1:__LAST_TOKEN_EVAL_REVERSE_1,              __TOKEN_PUSHS:1:__TOKEN_XOR:0,     {__DELETE_LAST_TOKEN},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                                          __TOKEN_PUSHS:1:__TOKEN_XOR,       {__SET_TOKEN({__TOKEN_PUSH_XOR},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},

__LAST_TOKEN_NAME:eval((__LAST_TOKEN_ITEMS>1) && ifelse(__LAST_TOKEN_IS_PTR_REVERSE_2_1,0,{1},
    __LAST_TOKEN_EVAL_REVERSE_1,0,{1},
    __LAST_TOKEN_EVAL_REVERSE_2,0,{1},{0})):$1, __TOKEN_PUSHS:1:__TOKEN_ADD,          {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(+,__LAST_TOKEN_LAST_2_PAR))},

            __LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1,                                  __TOKEN_PUSHS:1:__TOKEN_ADD,       {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH_ADD}, __BEFORELAST_TOKEN_INFO{ }$2,ifelse(__BEFORELAST_TOKEN_IS_PTR_REVERSE_1,1,__BEFORELAST_TOKEN_REVERSE_2,__BEFORELAST_TOKEN_REVERSE_1)){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__BEFORELAST_TOKEN_NAME,__BEFORELAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__BEFORELAST_TOKEN_ARRAY){}ifelse(__BEFORELAST_TOKEN_ITEMS,2,,{,}){}ifelse(__BEFORELAST_TOKEN_IS_PTR_REVERSE_1,1,__BEFORELAST_TOKEN_REVERSE_1,__BEFORELAST_TOKEN_REVERSE_2))},

            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1:__LAST_TOKEN_EVAL_REVERSE_1,              __TOKEN_PUSHS:1:__TOKEN_ADD:0,     {__DELETE_LAST_TOKEN},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                                          __TOKEN_PUSHS:1:__TOKEN_ADD,       {__SET_TOKEN({__TOKEN_PUSH_ADD},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},

__LAST_TOKEN_NAME:eval((__LAST_TOKEN_ITEMS>1) && ifelse(__LAST_TOKEN_IS_PTR_REVERSE_2_1,0,{1},
    __LAST_TOKEN_EVAL_REVERSE_1,0,{1},{0})):$1, __TOKEN_PUSHS:1:__TOKEN_SUB,          {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(-,__LAST_TOKEN_LAST_2_PAR))},

            __LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1,                                  __TOKEN_PUSHS:1:__TOKEN_SUB,       {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH_SUB}, __BEFORELAST_TOKEN_INFO{ }$2,__BEFORELAST_TOKEN_REVERSE_1){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__BEFORELAST_TOKEN_NAME,__BEFORELAST_TOKEN_INFO{ }$2,__DROP_1_PAR(__BEFORELAST_TOKEN_ARRAY))},

            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1:__LAST_TOKEN_EVAL_REVERSE_1,              __TOKEN_PUSHS:1:__TOKEN_SUB:0,     {__DELETE_LAST_TOKEN},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                                          __TOKEN_PUSHS:1:__TOKEN_SUB,       {__SET_TOKEN({__TOKEN_PUSH_SUB},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},

__LAST_TOKEN_NAME:eval((__LAST_TOKEN_ITEMS>1) && ifelse(__LAST_TOKEN_IS_PTR_REVERSE_2_1,0,{1},
    __LAST_TOKEN_EVAL_REVERSE_1,0,{1},
    __LAST_TOKEN_EVAL_REVERSE_2,0,{1},
    __LAST_TOKEN_EVAL_REVERSE_1,1,{1},
    __LAST_TOKEN_EVAL_REVERSE_2,1,{1},{0})):$1, __TOKEN_PUSHS:1:__TOKEN_MUL,          {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(*,__LAST_TOKEN_LAST_2_PAR))},

__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_EVAL_REVERSE_1,      __TOKEN_PUSHS:1:__TOKEN_MUL:2,     {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_1_PAR(__LAST_TOKEN_ARRAY)){}__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_2MUL},__BEFORELAST_TOKEN_INFO)},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_EVAL_REVERSE_2,      __TOKEN_PUSHS:1:__TOKEN_MUL:2,     {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__LAST_TOKEN_REVERSE_1){}__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_2MUL},__BEFORELAST_TOKEN_INFO)},

__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_EVAL_REVERSE_1,      __TOKEN_PUSHS:1:__TOKEN_MUL:-1,    {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_1_PAR(__LAST_TOKEN_ARRAY)){}__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_NEGATE},__BEFORELAST_TOKEN_INFO)},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_EVAL_REVERSE_2,      __TOKEN_PUSHS:1:__TOKEN_MUL:-1,    {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__LAST_TOKEN_REVERSE_1){}__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_NEGATE},__BEFORELAST_TOKEN_INFO)},

            __LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1,                                  __TOKEN_PUSHS:1:__TOKEN_MUL,       {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH_MUL}, __BEFORELAST_TOKEN_INFO{ }$2,ifelse(__BEFORELAST_TOKEN_IS_PTR_REVERSE_1,1,__BEFORELAST_TOKEN_REVERSE_2,__BEFORELAST_TOKEN_REVERSE_1)){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__BEFORELAST_TOKEN_NAME,__BEFORELAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__BEFORELAST_TOKEN_ARRAY){}ifelse(__BEFORELAST_TOKEN_ITEMS,2,,{,}){}ifelse(__BEFORELAST_TOKEN_IS_PTR_REVERSE_1,1,__BEFORELAST_TOKEN_REVERSE_1,__BEFORELAST_TOKEN_REVERSE_2))},

            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                                          __TOKEN_PUSHS:1:__TOKEN_MUL,       {__SET_TOKEN({__TOKEN_PUSH_MUL},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},

__LAST_TOKEN_NAME:eval((__LAST_TOKEN_ITEMS>1) && ifelse(__LAST_TOKEN_IS_PTR_REVERSE_2_1,0,{1},
    __LAST_TOKEN_EVAL_REVERSE_1,1,{1},
    __LAST_TOKEN_EVAL_REVERSE_2,0,{1},{0})):$1, __TOKEN_PUSHS:1:__TOKEN_DIV,          {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(/,__LAST_TOKEN_LAST_2_PAR))},

__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_EVAL_REVERSE_1,      __TOKEN_PUSHS:1:__TOKEN_DIV:-1,    {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_1_PAR(__LAST_TOKEN_ARRAY)){}__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_NEGATE},__BEFORELAST_TOKEN_INFO)},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_EVAL_REVERSE_1,      __TOKEN_PUSHS:1:__TOKEN_DIV:2,     {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_1_PAR(__LAST_TOKEN_ARRAY)){}__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_2DIV},__BEFORELAST_TOKEN_INFO)},

__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_UDIV:0,    {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(u/,__LAST_TOKEN_LAST_2_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_EVAL_REVERSE_2,      __TOKEN_PUSHS:1:__TOKEN_UDIV:0,    {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,})0))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_EVAL_REVERSE_1,      __TOKEN_PUSHS:1:__TOKEN_UDIV:1,    {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_1_PAR(__LAST_TOKEN_ARRAY))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_EVAL_REVERSE_1,      __TOKEN_PUSHS:1:__TOKEN_UDIV:2,    {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_1_PAR(__LAST_TOKEN_ARRAY)){}__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_2UDIV},__BEFORELAST_TOKEN_INFO)},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_EVAL_REVERSE_1,      __TOKEN_PUSHS:1:__TOKEN_UDIV:4,    {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_1_PAR(__LAST_TOKEN_ARRAY)){}__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_4UDIV},__BEFORELAST_TOKEN_INFO)},

__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1:__LAST_TOKEN_EVAL_REVERSE_1,      __TOKEN_PUSHS:1:__TOKEN_UDIV:1,            {__DELETE_LAST_TOKEN},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1:__LAST_TOKEN_EVAL_REVERSE_1,      __TOKEN_PUSHS:1:__TOKEN_UDIV:2,            {__SET_TOKEN({__TOKEN_2UDIV},__LAST_TOKEN_INFO{ }$2)},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1:__LAST_TOKEN_EVAL_REVERSE_1,      __TOKEN_PUSHS:1:__TOKEN_UDIV:4,            {__SET_TOKEN({__TOKEN_4UDIV},__LAST_TOKEN_INFO{ }$2)},

__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_MOD:0,      {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(%,__LAST_TOKEN_LAST_2_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_UMOD:0,     {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(u%,__LAST_TOKEN_LAST_2_PAR))},

__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_DIVMOD:0,   {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(/mod,__LAST_TOKEN_LAST_2_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_UDIVMOD:0,  {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(u/mod,__LAST_TOKEN_LAST_2_PAR))},

__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_MMUL:0,     {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(m*,__LAST_TOKEN_LAST_2_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_UMMUL:0,    {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(um*,__LAST_TOKEN_LAST_2_PAR))},

__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_MAX:0,      {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(>?,__LAST_TOKEN_LAST_2_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_MIN:0,      {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(<?,__LAST_TOKEN_LAST_2_PAR))},

__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_EQ:0,       {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(=,__LAST_TOKEN_LAST_2_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_NE:0,       {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(<>,__LAST_TOKEN_LAST_2_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_LT:0,       {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(<,__LAST_TOKEN_LAST_2_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_GT:0,       {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(>,__LAST_TOKEN_LAST_2_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_LE:0,       {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(<=,__LAST_TOKEN_LAST_2_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_GE:0,       {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(>=,__LAST_TOKEN_LAST_2_PAR))},

__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_UEQ:0,      {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(u=,__LAST_TOKEN_LAST_2_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_UNE:0,      {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(u<>,__LAST_TOKEN_LAST_2_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_ULT:0,      {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(u<,__LAST_TOKEN_LAST_2_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_UGT:0,      {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(u>,__LAST_TOKEN_LAST_2_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_ULE:0,      {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(u<=,__LAST_TOKEN_LAST_2_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_UGE:0,      {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S16(u>=,__LAST_TOKEN_LAST_2_PAR))},
...
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,         __TOKEN_PUSHS:3:__TOKEN_FILL,    {__SET_TOKEN({__TOKEN_PUSH3_FILL},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1, __TOKEN_PUSHS:1:__TOKEN_FILL,    {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH3_FILL},__REMOVE_COMMA(__BEFORELAST_TOKEN_LAST_3_PAR){ }$2,__BEFORELAST_TOKEN_LAST_3_PAR){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__TOKEN_PUSHS, __BEFORELAST_TOKEN_INFO{ 3drop},__DROP_3_PAR(__BEFORELAST_TOKEN_ARRAY))},

__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1:__LAST_TOKEN_EVAL_REVERSE_1,         __TOKEN_PUSHS:1:__TOKEN_CMOVE:0, {__SET_TOKEN({__TOKEN_2DROP},__LAST_TOKEN_INFO{ }$2)},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1:__LAST_TOKEN_EVAL_REVERSE_1,         __TOKEN_PUSHS:2:__TOKEN_CMOVE:0, {__SET_TOKEN({__TOKEN_DROP},__LAST_TOKEN_INFO{ }$2)},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1:__LAST_TOKEN_EVAL_REVERSE_1,         __TOKEN_PUSHS:3:__TOKEN_CMOVE:0, {__DELETE_LAST_TOKEN},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1:__LAST_TOKEN_EVAL_REVERSE_1, __TOKEN_PUSHS:1:__TOKEN_CMOVE:0, {__SET_TOKEN({__TOKEN_PUSHS},__LAST_TOKEN_INFO{ }$2,__DROP_3_PAR(__LAST_TOKEN_ARRAY))},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,         __TOKEN_PUSHS:1:__TOKEN_CMOVE,    {__SET_TOKEN({__TOKEN_PUSH_CMOVE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,         __TOKEN_PUSHS:2:__TOKEN_CMOVE,    {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH_CMOVE},__BEFORELAST_TOKEN_REVERSE_1{ }$2,__BEFORELAST_TOKEN_REVERSE_1){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__TOKEN_PUSHS, __BEFORELAST_TOKEN_INFO{ drop},__DROP_1_PAR(__BEFORELAST_TOKEN_ARRAY))},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,         __TOKEN_PUSHS:3:__TOKEN_CMOVE,    {__SET_TOKEN({__TOKEN_PUSH3_CMOVE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1, __TOKEN_PUSHS:1:__TOKEN_CMOVE,    {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH3_CMOVE},__REMOVE_COMMA(__BEFORELAST_TOKEN_LAST_3_PAR){ }$2,__BEFORELAST_TOKEN_LAST_3_PAR){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__TOKEN_PUSHS, __BEFORELAST_TOKEN_INFO{ 3drop},__DROP_3_PAR(__BEFORELAST_TOKEN_ARRAY))},

__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1:__LAST_TOKEN_EVAL_REVERSE_1,         __TOKEN_PUSHS:1:__TOKEN_MOVE:0,  {__SET_TOKEN({__TOKEN_2DROP},__LAST_TOKEN_INFO{ }$2)},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1:__LAST_TOKEN_EVAL_REVERSE_1,         __TOKEN_PUSHS:2:__TOKEN_MOVE:0,  {__SET_TOKEN({__TOKEN_DROP},__LAST_TOKEN_INFO{ }$2)},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1:__LAST_TOKEN_EVAL_REVERSE_1,         __TOKEN_PUSHS:3:__TOKEN_MOVE:0,  {__DELETE_LAST_TOKEN},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1:__LAST_TOKEN_EVAL_REVERSE_1, __TOKEN_PUSHS:1:__TOKEN_MOVE:0,  {__SET_TOKEN({__TOKEN_PUSHS},__LAST_TOKEN_INFO{ }$2,__DROP_3_PAR(__LAST_TOKEN_ARRAY))},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                                     __TOKEN_PUSHS:1:__TOKEN_MOVE,    {__SET_TOKEN({__TOKEN_PUSH_MOVE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                                     __TOKEN_PUSHS:2:__TOKEN_MOVE,    {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH_MOVE},__BEFORELAST_TOKEN_REVERSE_1{ }$2,__BEFORELAST_TOKEN_REVERSE_1){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__TOKEN_PUSHS, __BEFORELAST_TOKEN_INFO{ drop},__DROP_1_PAR(__BEFORELAST_TOKEN_ARRAY))},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                                     __TOKEN_PUSHS:3:__TOKEN_MOVE,    {__SET_TOKEN({__TOKEN_PUSH3_MOVE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1,                             __TOKEN_PUSHS:1:__TOKEN_MOVE,    {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH3_MOVE},__REMOVE_COMMA(__BEFORELAST_TOKEN_LAST_3_PAR){ }$2,__BEFORELAST_TOKEN_LAST_3_PAR){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__TOKEN_PUSHS, __BEFORELAST_TOKEN_INFO{ 3drop},__DROP_3_PAR(__BEFORELAST_TOKEN_ARRAY))},

__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1,                             __TOKEN_PUSHS:1:__TOKEN_SWAP,    {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__LAST_TOKEN_REVERSE_1,__LAST_TOKEN_REVERSE_2)},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>2):$1:__LAST_TOKEN_IS_NUM_1_2_3,   __TOKEN_PUSHS:1:__TOKEN_WITHIN:1,{__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_3_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,3,,{,}){}ifelse(eval((__LAST_TOKEN_REVERSE_3>=__LAST_TOKEN_REVERSE_2) && (__LAST_TOKEN_REVERSE_3<__LAST_TOKEN_REVERSE_1)),{1},{-1},{0}))},
...
__LAST_TOKEN_NAME:$1,                                                        __TOKEN_PUSHS:__TOKEN_PUSH,      {__SET_TOKEN({__TOKEN_PUSHS},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY,$3)},
__LAST_TOKEN_NAME:$1,                                                        __TOKEN_PUSHS:__TOKEN_PUSHS,     {__SET_TOKEN({__TOKEN_PUSHS},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY,shift(shift($@)))},

__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,         __TOKEN_PUSHS:1:__TOKEN_STORE,    {__SET_TOKEN({__TOKEN_PUSH_STORE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,         __TOKEN_PUSHS:2:__TOKEN_STORE,    {__SET_TOKEN({__TOKEN_PUSH2_STORE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>2):$1, __TOKEN_PUSHS:1:__TOKEN_STORE,    {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH2_STORE},__REMOVE_COMMA(__BEFORELAST_TOKEN_LAST_2_PAR){ }$2,__BEFORELAST_TOKEN_LAST_2_PAR){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__TOKEN_PUSHS, __BEFORELAST_TOKEN_INFO{ 2drop},__DROP_2_PAR(__BEFORELAST_TOKEN_ARRAY))},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,         __TOKEN_PUSHS:1:__TOKEN_2STORE,   {__SET_TOKEN({__TOKEN_PUSH_2STORE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,         __TOKEN_PUSHS:2:__TOKEN_2STORE,   {__SET_TOKEN({__TOKEN_PUSH2_2STORE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,         __TOKEN_PUSHS:3:__TOKEN_2STORE,   {__SET_TOKEN({__TOKEN_PUSH3_2STORE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1, __TOKEN_PUSHS:1:__TOKEN_2STORE,   {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH3_2STORE},__REMOVE_COMMA(__BEFORELAST_TOKEN_LAST_3_PAR){ }$2,__BEFORELAST_TOKEN_LAST_3_PAR){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__TOKEN_PUSHS, __BEFORELAST_TOKEN_INFO{ 3drop},__DROP_3_PAR(__BEFORELAST_TOKEN_ARRAY))},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,         __TOKEN_PUSHS:1:__TOKEN_FETCH,    {__SET_TOKEN({__TOKEN_PUSH_FETCH},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,         __TOKEN_PUSHS:2:__TOKEN_FETCH,    {__SET_TOKEN({__TOKEN_PUSH2_FETCH},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1, __TOKEN_PUSHS:1:__TOKEN_FETCH,    {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH_FETCH},__BEFORELAST_TOKEN_REVERSE_1,__BEFORELAST_TOKEN_REVERSE_1){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__TOKEN_PUSHS, __BEFORELAST_TOKEN_INFO{ drop},__DROP_1_PAR(__BEFORELAST_TOKEN_ARRAY))},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,         __TOKEN_PUSHS:1:__TOKEN_2FETCH,   {__SET_TOKEN({__TOKEN_PUSH_2FETCH},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1, __TOKEN_PUSHS:1:__TOKEN_2FETCH,   {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH_2FETCH},__BEFORELAST_TOKEN_REVERSE_1{ }$2,__BEFORELAST_TOKEN_REVERSE_1){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__TOKEN_PUSHS, __BEFORELAST_TOKEN_INFO{ drop},__DROP_1_PAR(__BEFORELAST_TOKEN_ARRAY))},

__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,         __TOKEN_PUSHS:1:__TOKEN_VALUE,    {__SET_TOKEN({__TOKEN_PUSH_VALUE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY,$3)},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1, __TOKEN_PUSHS:1:__TOKEN_VALUE,    {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH_VALUE},__BEFORELAST_TOKEN_REVERSE_1{ }$2,__BEFORELAST_TOKEN_REVERSE_1,$3){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__TOKEN_PUSHS, __BEFORELAST_TOKEN_INFO{ drop},__DROP_1_PAR(__BEFORELAST_TOKEN_ARRAY))},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,         __TOKEN_PUSHS:2:__TOKEN_DVALUE,   {__SET_TOKEN({__TOKEN_PUSHDOT_DVALUE},__LAST_TOKEN_REVERSE_2*65536+__LAST_TOKEN_REVERSE_1{. }$2,__LAST_TOKEN_REVERSE_2*65536+__LAST_TOKEN_REVERSE_1,$3)},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>2):$1, __TOKEN_PUSHS:1:__TOKEN_DVALUE,   {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSHDOT_DVALUE},__BEFORELAST_TOKEN_REVERSE_2*65536+__BEFORELAST_TOKEN_REVERSE_1{. }$2,__BEFORELAST_TOKEN_REVERSE_2*65536+__BEFORELAST_TOKEN_REVERSE_1,$3){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__TOKEN_PUSHS, __BEFORELAST_TOKEN_INFO{ 2drop},__DROP_2_PAR(__BEFORELAST_TOKEN_ARRAY))},

__LAST_TOKEN_NAME:eval(2*__LAST_TOKEN_ITEMS):$1, __TOKEN_PUSHS:__PSIZE_$4:__TOKEN_PVALUE,   {dnl
__{}ifelse(dnl
__{}__IS_ARRAY_NUM(__LAST_TOKEN_ARRAY),1,{dnl
__{}__{}define(_{_TEMP},0x{}__ARRAY2HEXSTRING(__LAST_TOKEN_ARRAY)){}dnl
...
__LAST_TOKEN_NAME:$1,                            __TOKEN_PUSHS:__TOKEN_PVALUE,     {dnl
__{}ifelse(eval(__PSIZE_$4>(2*__LAST_TOKEN_ITEMS)),1,{dnl
__{}__{}__INC_TOKEN_COUNT{}__SET_TOKEN($@)},
__{}__IS_ARRAY_NUM(__LAST_X_PAR(eval(($3+1)/2),__LAST_TOKEN_ARRAY)),1,{dnl
__{}__{}__{}define({__TEMP},0x{}__ARRAY2HEXSTRING(__LAST_X_PAR(eval(($3+1)/2),__LAST_TOKEN_ARRAY))){}dnl
__{}__{}__{}__SET_TOKEN({__TOKEN_PUSHS},__REMOVE_COMMA(}__FIRST_X_PAR(eval(__LAST_TOKEN_ITEMS-($3+1)/2),__LAST_TOKEN_ARRAY){),__FIRST_X_PAR(eval(__LAST_TOKEN_ITEMS-($3+1)/2),__LAST_TOKEN_ARRAY)){}dnl
...
__LAST_TOKEN_NAME:eval((__LAST_TOKEN_ITEMS>3) &&{}dnl
   ...
   ifelse(__LAST_TOKEN_IS_PTR_REVERSE_3_1,0,{1},
    ...
    __LAST_TOKEN_HEX_REVERSE_1,0xFFFF,{1},{0})):$1, __TOKEN_PUSHS:1:__TOKEN_DAND,     {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,4,,{,}){}__EVAL_S16(&,__LAST_TOKEN_REVERSE_4,__LAST_TOKEN_REVERSE_2),__EVAL_S16(&,__LAST_TOKEN_REVERSE_3,__LAST_TOKEN_REVERSE_1))},
...
__LAST_TOKEN_NAME:eval((__LAST_TOKEN_ITEMS>3) &&{}dnl
   ...
   ifelse(__LAST_TOKEN_IS_PTR_REVERSE_3_1,0,{1},
    ...
    __LAST_TOKEN_EVAL_REVERSE_1,0,{1},
    __LAST_TOKEN_HEX_REVERSE_3,0xFFFF,{1},
    __LAST_TOKEN_HEX_REVERSE_1,0xFFFF,{1},{0})):$1, __TOKEN_PUSHS:1:__TOKEN_DOR,      {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,4,,{,}){}__EVAL_S16(|,__LAST_TOKEN_REVERSE_4,__LAST_TOKEN_REVERSE_2),__EVAL_S16(|,__LAST_TOKEN_REVERSE_3,__LAST_TOKEN_REVERSE_1))},

__LAST_TOKEN_NAME:eval((__LAST_TOKEN_ITEMS>3) &&{}dnl
   ifelse(__LAST_TOKEN_IS_PTR_REVERSE_4_2,0,{1},
    __LAST_TOKEN_EVAL_REVERSE_4,0,{1},
    __LAST_TOKEN_EVAL_REVERSE_2,0,{1},{0}) &&{}dnl
   ifelse(__LAST_TOKEN_IS_PTR_REVERSE_3_1,0,{1},
    __LAST_TOKEN_EVAL_REVERSE_3,0,{1},
    __LAST_TOKEN_EVAL_REVERSE_1,0,{1},{0})):$1, __TOKEN_PUSHS:1:__TOKEN_DXOR,         {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,4,,{,}){}__EVAL_S16(^,__LAST_TOKEN_REVERSE_4,__LAST_TOKEN_REVERSE_2),__EVAL_S16(^,__LAST_TOKEN_REVERSE_3,__LAST_TOKEN_REVERSE_1))},
...
__LAST_TOKEN_NAME:eval((__LAST_TOKEN_ITEMS>3) &&{}dnl
   ifelse(__LAST_TOKEN_IS_PTR_REVERSE_4_2,0,{1},
    ...
    __LAST_TOKEN_EVAL_REVERSE_2,0,{1},
    __LAST_TOKEN_HEX_REVERSE_4,0xFFFF,{1},
    __LAST_TOKEN_HEX_REVERSE_2,0xFFFF,{1},{0})):$1, __TOKEN_PUSHS:1:__TOKEN_DAND,     {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH_AND},__BEFORELAST_TOKEN_INFO{ }$2,ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_1,0,__BEFORELAST_TOKEN_REVERSE_3,__BEFORELAST_TOKEN_REVERSE_1)){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__BEFORELAST_TOKEN_NAME,__BEFORELAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__BEFORELAST_TOKEN_ARRAY){}ifelse(__BEFORELAST_TOKEN_ITEMS,4,,{,}){}__EVAL_S16(&,__BEFORELAST_TOKEN_REVERSE_4,__BEFORELAST_TOKEN_REVERSE_2),ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_1,0,__BEFORELAST_TOKEN_REVERSE_1,__BEFORELAST_TOKEN_REVERSE_3))},
...
__LAST_TOKEN_NAME:eval((__LAST_TOKEN_ITEMS>3) &&{}dnl
   ifelse(__LAST_TOKEN_IS_PTR_REVERSE_4_2,0,{1},
    ...
    __LAST_TOKEN_EVAL_REVERSE_2,0,{1},
    __LAST_TOKEN_HEX_REVERSE_4,0xFFFF,{1},
    __LAST_TOKEN_HEX_REVERSE_2,0xFFFF,{1},{0})):$1, __TOKEN_PUSHS:1:__TOKEN_DOR,      {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH_OR}, __BEFORELAST_TOKEN_INFO{ }$2,ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_1,0,__BEFORELAST_TOKEN_REVERSE_3,__BEFORELAST_TOKEN_REVERSE_1)){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__BEFORELAST_TOKEN_NAME,__BEFORELAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__BEFORELAST_TOKEN_ARRAY){}ifelse(__BEFORELAST_TOKEN_ITEMS,4,,{,}){}__EVAL_S16(|,__BEFORELAST_TOKEN_REVERSE_4,__BEFORELAST_TOKEN_REVERSE_2),ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_1,0,__BEFORELAST_TOKEN_REVERSE_1,__BEFORELAST_TOKEN_REVERSE_3))},

__LAST_TOKEN_NAME:eval((__LAST_TOKEN_ITEMS>3) &&{}dnl
   ifelse(__LAST_TOKEN_IS_PTR_REVERSE_4_2,0,{1},
    __LAST_TOKEN_EVAL_REVERSE_4,0,{1},
    __LAST_TOKEN_EVAL_REVERSE_2,0,{1},{0})):$1, __TOKEN_PUSHS:1:__TOKEN_DXOR,         {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH_XOR},__BEFORELAST_TOKEN_INFO{ }$2,ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_1,0,__BEFORELAST_TOKEN_REVERSE_3,__BEFORELAST_TOKEN_REVERSE_1)){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__BEFORELAST_TOKEN_NAME,__BEFORELAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__BEFORELAST_TOKEN_ARRAY){}ifelse(__BEFORELAST_TOKEN_ITEMS,4,,{,}){}__EVAL_S16(^,__BEFORELAST_TOKEN_REVERSE_4,__BEFORELAST_TOKEN_REVERSE_2),ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_1,0,__BEFORELAST_TOKEN_REVERSE_1,__BEFORELAST_TOKEN_REVERSE_3))},
...
__LAST_TOKEN_NAME:eval((__LAST_TOKEN_ITEMS>3) &&{}dnl
   ifelse(__LAST_TOKEN_IS_PTR_REVERSE_3_1,0,{1},
    ...
    __LAST_TOKEN_EVAL_REVERSE_1,0,{1},
    __LAST_TOKEN_HEX_REVERSE_3,0xFFFF,{1},
    __LAST_TOKEN_HEX_REVERSE_1,0xFFFF,{1},{0})):$1, __TOKEN_PUSHS:1:__TOKEN_DAND,     {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_SWAP_PUSH_AND_SWAP},__BEFORELAST_TOKEN_INFO{ }$2,ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_2,0,__BEFORELAST_TOKEN_REVERSE_4,__BEFORELAST_TOKEN_REVERSE_2)){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__BEFORELAST_TOKEN_NAME,__BEFORELAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__BEFORELAST_TOKEN_ARRAY){}ifelse(__BEFORELAST_TOKEN_ITEMS,4,,{,}){}ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_2,0,__BEFORELAST_TOKEN_REVERSE_2,__BEFORELAST_TOKEN_REVERSE_4),__EVAL_S16(&,__BEFORELAST_TOKEN_REVERSE_3,__BEFORELAST_TOKEN_REVERSE_1))},
...
__LAST_TOKEN_NAME:eval((__LAST_TOKEN_ITEMS>3) &&{}dnl
   ifelse(__LAST_TOKEN_IS_PTR_REVERSE_3_1,0,{1},
    ...
    __LAST_TOKEN_EVAL_REVERSE_1,0,{1},
    __LAST_TOKEN_HEX_REVERSE_3,0xFFFF,{1},
    __LAST_TOKEN_HEX_REVERSE_1,0xFFFF,{1},{0})):$1, __TOKEN_PUSHS:1:__TOKEN_DOR,      {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_SWAP_PUSH_OR_SWAP}, __BEFORELAST_TOKEN_INFO{ }$2,ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_2,0,__BEFORELAST_TOKEN_REVERSE_4,__BEFORELAST_TOKEN_REVERSE_2)){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__BEFORELAST_TOKEN_NAME,__BEFORELAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__BEFORELAST_TOKEN_ARRAY){}ifelse(__BEFORELAST_TOKEN_ITEMS,4,,{,}){}ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_2,0,__BEFORELAST_TOKEN_REVERSE_2,__BEFORELAST_TOKEN_REVERSE_4),__EVAL_S16(|,__BEFORELAST_TOKEN_REVERSE_3,__BEFORELAST_TOKEN_REVERSE_1))},

__LAST_TOKEN_NAME:eval((__LAST_TOKEN_ITEMS>3) &&{}dnl
   ifelse(__LAST_TOKEN_IS_PTR_REVERSE_3_1,0,{1},
    __LAST_TOKEN_EVAL_REVERSE_3,0,{1},
    __LAST_TOKEN_EVAL_REVERSE_1,0,{1},{0})):$1, __TOKEN_PUSHS:1:__TOKEN_DXOR,         {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_SWAP_PUSH_XOR_SWAP},__BEFORELAST_TOKEN_INFO{ }$2,ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_2,0,__BEFORELAST_TOKEN_REVERSE_4,__BEFORELAST_TOKEN_REVERSE_2)){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__BEFORELAST_TOKEN_NAME,__BEFORELAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__BEFORELAST_TOKEN_ARRAY){}ifelse(__BEFORELAST_TOKEN_ITEMS,4,,{,}){}ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_2,0,__BEFORELAST_TOKEN_REVERSE_2,__BEFORELAST_TOKEN_REVERSE_4),__EVAL_S16(^,__BEFORELAST_TOKEN_REVERSE_3,__BEFORELAST_TOKEN_REVERSE_1))},

__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1,                                                             __TOKEN_PUSHS:1:__TOKEN_DAND,         {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH2_DAND}, __BEFORELAST_TOKEN_INFO{ }$2,ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_2,0,__BEFORELAST_TOKEN_REVERSE_4,__BEFORELAST_TOKEN_REVERSE_2),ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_1,0,__BEFORELAST_TOKEN_REVERSE_3,__BEFORELAST_TOKEN_REVERSE_1)){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__BEFORELAST_TOKEN_NAME,__BEFORELAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__BEFORELAST_TOKEN_ARRAY){}ifelse(__BEFORELAST_TOKEN_ITEMS,4,,{,}){}ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_2,0,__BEFORELAST_TOKEN_REVERSE_2,__BEFORELAST_TOKEN_REVERSE_4),ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_1,0,__BEFORELAST_TOKEN_REVERSE_1,__BEFORELAST_TOKEN_REVERSE_3))},

__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1,                                                             __TOKEN_PUSHS:1:__TOKEN_DOR,          {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH2_DOR},  __BEFORELAST_TOKEN_INFO{ }$2,ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_2,0,__BEFORELAST_TOKEN_REVERSE_4,__BEFORELAST_TOKEN_REVERSE_2),ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_1,0,__BEFORELAST_TOKEN_REVERSE_3,__BEFORELAST_TOKEN_REVERSE_1)){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__BEFORELAST_TOKEN_NAME,__BEFORELAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__BEFORELAST_TOKEN_ARRAY){}ifelse(__BEFORELAST_TOKEN_ITEMS,4,,{,}){}ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_2,0,__BEFORELAST_TOKEN_REVERSE_2,__BEFORELAST_TOKEN_REVERSE_4),ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_1,0,__BEFORELAST_TOKEN_REVERSE_1,__BEFORELAST_TOKEN_REVERSE_3))},

__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1,                                                             __TOKEN_PUSHS:1:__TOKEN_DXOR,         {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH2_DXOR}, __BEFORELAST_TOKEN_INFO{ }$2,ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_2,0,__BEFORELAST_TOKEN_REVERSE_4,__BEFORELAST_TOKEN_REVERSE_2),ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_1,0,__BEFORELAST_TOKEN_REVERSE_3,__BEFORELAST_TOKEN_REVERSE_1)){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__BEFORELAST_TOKEN_NAME,__BEFORELAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__BEFORELAST_TOKEN_ARRAY){}ifelse(__BEFORELAST_TOKEN_ITEMS,4,,{,}){}ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_2,0,__BEFORELAST_TOKEN_REVERSE_2,__BEFORELAST_TOKEN_REVERSE_4),ifelse(__BEFORELAST_TOKEN_IS_NUM_REVERSE_1,0,__BEFORELAST_TOKEN_REVERSE_1,__BEFORELAST_TOKEN_REVERSE_3))},
...
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1:__LAST_TOKEN_IS_PTR_REVERSE_4_3_2_1,  __TOKEN_PUSHS:1:__TOKEN_DGT:0,       {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,4,,{,}){}__EVAL_S32(d>,  __LAST_TOKEN_LAST_4_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1:__LAST_TOKEN_IS_PTR_REVERSE_4_3_2_1,  __TOKEN_PUSHS:1:__TOKEN_DLE:0,       {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,4,,{,}){}__EVAL_S32(d<=, __LAST_TOKEN_LAST_4_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1:__LAST_TOKEN_IS_PTR_REVERSE_4_3_2_1,  __TOKEN_PUSHS:1:__TOKEN_DGE:0,       {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,4,,{,}){}__EVAL_S32(d>=, __LAST_TOKEN_LAST_4_PAR))},

__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1:__LAST_TOKEN_IS_PTR_REVERSE_4_3_2_1,  __TOKEN_PUSHS:1:__TOKEN_DUEQ:0,      {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,4,,{,}){}__EVAL_S32(du=, __LAST_TOKEN_LAST_4_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1:__LAST_TOKEN_IS_PTR_REVERSE_4_3_2_1,  __TOKEN_PUSHS:1:__TOKEN_DUNE:0,      {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,4,,{,}){}__EVAL_S32(du<>,__LAST_TOKEN_LAST_4_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1:__LAST_TOKEN_IS_PTR_REVERSE_4_3_2_1,  __TOKEN_PUSHS:1:__TOKEN_DULT:0,      {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,4,,{,}){}__EVAL_S32(du<, __LAST_TOKEN_LAST_4_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1:__LAST_TOKEN_IS_PTR_REVERSE_4_3_2_1,  __TOKEN_PUSHS:1:__TOKEN_DUGT:0,      {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,4,,{,}){}__EVAL_S32(du>, __LAST_TOKEN_LAST_4_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1:__LAST_TOKEN_IS_PTR_REVERSE_4_3_2_1,  __TOKEN_PUSHS:1:__TOKEN_DULE:0,      {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,4,,{,}){}__EVAL_S32(du<=,__LAST_TOKEN_LAST_4_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1:__LAST_TOKEN_IS_PTR_REVERSE_4_3_2_1,  __TOKEN_PUSHS:1:__TOKEN_DUGE:0,      {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,4,,{,}){}__EVAL_S32(du>=,__LAST_TOKEN_LAST_4_PAR))},


__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1:__LAST_TOKEN_IS_PTR_REVERSE_4_3_2_1,  __TOKEN_PUSHS:1:__TOKEN_DADD:0,      {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,4,,{,}){}__EVAL_S32(d+,  __LAST_TOKEN_LAST_4_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):$1:__LAST_TOKEN_IS_PTR_REVERSE_4_3_2_1,  __TOKEN_PUSHS:1:__TOKEN_DSUB:0,      {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_4_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,4,,{,}){}__EVAL_S32(d-,  __LAST_TOKEN_LAST_4_PAR))},

__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                                              __TOKEN_PUSHS:2:__TOKEN_DADD,        {__SET_TOKEN({__TOKEN_PUSH2_DADD},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                                              __TOKEN_PUSHS:2:__TOKEN_DSUB,        {__SET_TOKEN({__TOKEN_PUSH2_DSUB},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},

__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>3):__LAST_TOKEN_IS_PTR_REVERSE_4_3:$1,      __TOKEN_PUSHS:1:0:__TOKEN_DADD,      {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH2_DADD},__BEFORELAST_TOKEN_REVERSE_4{ }__BEFORELAST_TOKEN_REVERSE_3{ }$2,__BEFORELAST_TOKEN_REVERSE_4,__BEFORELAST_TOKEN_REVERSE_3){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__TOKEN_PUSHS,__BEFORELAST_TOKEN_INFO{ 2swap 2drop},__DROP_4_PAR(__BEFORELAST_TOKEN_ARRAY){}ifelse(__BEFORELAST_TOKEN_ITEMS,4,{},{,})__BEFORELAST_TOKEN_LAST_2_PAR)},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>2):$1,                                      __TOKEN_PUSHS:1:__TOKEN_DADD,        {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH2_DADD},__BEFORELAST_TOKEN_REVERSE_2{ }__BEFORELAST_TOKEN_REVERSE_1{ }$2,__BEFORELAST_TOKEN_REVERSE_2,__BEFORELAST_TOKEN_REVERSE_1){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__TOKEN_PUSHS,__BEFORELAST_TOKEN_INFO{ 2drop},__DROP_2_PAR(__BEFORELAST_TOKEN_ARRAY))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>2):$1,                                      __TOKEN_PUSHS:1:__TOKEN_DSUB,        {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH2_DSUB},__BEFORELAST_TOKEN_REVERSE_2{ }__BEFORELAST_TOKEN_REVERSE_1{ }$2,__BEFORELAST_TOKEN_REVERSE_2,__BEFORELAST_TOKEN_REVERSE_1){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__TOKEN_PUSHS,__BEFORELAST_TOKEN_INFO{ 2drop},__DROP_2_PAR(__BEFORELAST_TOKEN_ARRAY))},

__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,      __TOKEN_PUSHS:1:__TOKEN_DABS:0,      {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S32(dabs,__LAST_TOKEN_LAST_2_PAR))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,      __TOKEN_PUSHS:1:__TOKEN_DNEGATE:0,   {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,__DROP_2_PAR(__LAST_TOKEN_ARRAY){}ifelse(__LAST_TOKEN_ITEMS,2,,{,}){}__EVAL_S32(dneg,__LAST_TOKEN_LAST_2_PAR))},

__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS=__LAST_TOKEN_EVAL_REVERSE_2:__LAST_TOKEN_EVAL_REVERSE_1:$1,        {__TOKEN_PUSHS:2=0:0:__TOKEN_DEQ},{__SET_TOKEN({__TOKEN_D0EQ},__LAST_TOKEN_INFO{ }$2)},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS=__LAST_TOKEN_EVAL_REVERSE_2:__LAST_TOKEN_EVAL_REVERSE_1:$1,        {__TOKEN_PUSHS:2=0:0:__TOKEN_DNE},{__SET_TOKEN({__TOKEN_D0NE},__LAST_TOKEN_INFO{ }$2)},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS=__LAST_TOKEN_EVAL_REVERSE_2:__LAST_TOKEN_EVAL_REVERSE_1:$1,        {__TOKEN_PUSHS:2=0:0:__TOKEN_DLT},{__SET_TOKEN({__TOKEN_D0LT},__LAST_TOKEN_INFO{ }$2)},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>2)=__LAST_TOKEN_EVAL_REVERSE_2:__LAST_TOKEN_EVAL_REVERSE_1:$1,{__TOKEN_PUSHS:1=0:0:__TOKEN_DEQ},{__SET_TOKEN(__TOKEN_PUSHS,__LAST_TOKEN_INFO{ 2drop},__DROP_2_PAR(__LAST_TOKEN_ARRAY)){}__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_D0EQ},{0. }$2)},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>2)=__LAST_TOKEN_EVAL_REVERSE_2:__LAST_TOKEN_EVAL_REVERSE_1:$1,{__TOKEN_PUSHS:1=0:0:__TOKEN_DNE},{__SET_TOKEN(__TOKEN_PUSHS,__LAST_TOKEN_INFO{ 2drop},__DROP_2_PAR(__LAST_TOKEN_ARRAY)){}__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_D0NE},{0. }$2)},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>2)=__LAST_TOKEN_EVAL_REVERSE_2:__LAST_TOKEN_EVAL_REVERSE_1:$1,{__TOKEN_PUSHS:1=0:0:__TOKEN_DLT},{__SET_TOKEN(__TOKEN_PUSHS,__LAST_TOKEN_INFO{ 2drop},__DROP_2_PAR(__LAST_TOKEN_ARRAY)){}__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_D0LT},{0. }$2)},

__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                                                    __TOKEN_PUSHS:2:__TOKEN_DEQ,                 {__SET_TOKEN({__TOKEN_PUSH2_DEQ}, __LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                                                    __TOKEN_PUSHS:2:__TOKEN_DNE,                 {__SET_TOKEN({__TOKEN_PUSH2_DNE}, __LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,                                                    __TOKEN_PUSHS:2:__TOKEN_DLT,                 {__SET_TOKEN({__TOKEN_PUSH2_DLT}, __LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>2):$1,                                            __TOKEN_PUSHS:1:__TOKEN_DEQ,                 {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH2_DEQ},__BEFORELAST_TOKEN_REVERSE_2{ }__BEFORELAST_TOKEN_REVERSE_1{ }$2,__BEFORELAST_TOKEN_LAST_2_PAR){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__TOKEN_PUSHS,__BEFORELAST_TOKEN_INFO{ 2drop},__DROP_2_PAR(__BEFORELAST_TOKEN_ARRAY))},
...
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:__LAST_TOKEN_IS_PTR_REVERSE_2_1:$1,              __TOKEN_PUSHS:2:0:__TOKEN_DMAX,      {__SET_TOKEN({__TOKEN_PUSHDOT_DMAX},__LAST_TOKEN_INFO{ }$2,eval(__HEX_HL(__LAST_TOKEN_ARRAY_1)*65536+__HEX_HL(__LAST_TOKEN_ARRAY_2)))},
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:__LAST_TOKEN_IS_PTR_REVERSE_2_1:$1,              __TOKEN_PUSHS:2:0:__TOKEN_DMIN,      {__SET_TOKEN({__TOKEN_PUSHDOT_DMIN},__LAST_TOKEN_INFO{ }$2,eval(__HEX_HL(__LAST_TOKEN_ARRAY_1)*65536+__HEX_HL(__LAST_TOKEN_ARRAY_2)))},

__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>2):__LAST_TOKEN_IS_PTR_REVERSE_2_1:$1,      __TOKEN_PUSHS:1:0:__TOKEN_DMAX,      {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSHDOT_DMAX},__BEFORELAST_TOKEN_REVERSE_2{ }__BEFORELAST_TOKEN_REVERSE_1{ }$2,eval(__HEX_HL(__BEFORELAST_TOKEN_REVERSE_2)*65536+__HEX_HL(__BEFORELAST_TOKEN_REVERSE_1))){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__TOKEN_PUSHS,__BEFORELAST_TOKEN_INFO{ 2drop},__DROP_2_PAR(__BEFORELAST_TOKEN_ARRAY))},
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>2):__LAST_TOKEN_IS_PTR_REVERSE_2_1:$1,      __TOKEN_PUSHS:1:0:__TOKEN_DMIN,      {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSHDOT_DMIN},__BEFORELAST_TOKEN_REVERSE_2{ }__BEFORELAST_TOKEN_REVERSE_1{ }$2,eval(__HEX_HL(__BEFORELAST_TOKEN_REVERSE_2)*65536+__HEX_HL(__BEFORELAST_TOKEN_REVERSE_1))){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),__TOKEN_PUSHS,__BEFORELAST_TOKEN_INFO{ 2drop},__DROP_2_PAR(__BEFORELAST_TOKEN_ARRAY))},
      ...
      __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1,{__TOKEN_PUSHS:2:__TOKEN_2SWAP},{__SET_TOKEN({__TOKEN_PUSH2_2SWAP},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
...
r...,,,
            ...
            __BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1,{__TOKEN_TO_R:__TOKEN_PUSHS:__TOKEN_R_FROM},{__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_TO_R_PUSHS_R_FROM},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY){}__DELETE_LAST_TOKEN},
...
s...,,,
            ...
            __BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1,  __TOKEN_SWAP:__TOKEN_1ADD:__TOKEN_SWAP,  {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_SWAP_1ADD_SWAP},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2){}__DELETE_LAST_TOKEN},
            __BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1,  __TOKEN_SWAP:__TOKEN_2ADD:__TOKEN_SWAP,  {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_SWAP_2ADD_SWAP},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2){}__DELETE_LAST_TOKEN},
            __BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1,  __TOKEN_SWAP:__TOKEN_1SUB:__TOKEN_SWAP,  {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_SWAP_1SUB_SWAP},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2){}__DELETE_LAST_TOKEN},
            __BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:$1,  __TOKEN_SWAP:__TOKEN_2SUB:__TOKEN_SWAP,  {__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_SWAP_2SUB_SWAP},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO{ }$2){}__DELETE_LAST_TOKEN},
...
dnl
dnl
define({__SET_CHECK_TOKEN}, {__SET_TOKEN($1,__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})}){}dnl
dnl
define({__SET_CHECK_TOKEN2},{__SET_TOKEN($1,__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__BEFORELAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})}){}dnl
dnl
define({__SET_CHECK_TOKEN3},{__SET_TOKEN($1,__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__BEFORELAST_TOKEN_ARRAY,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})}){}dnl
dnl
dnl
dnl
dnl # xxx + pushs = xxx_pushs ( after all pushs + xxx = pushs_xxx rule is done )
define({__CHECK_TOKEN},{ifelse(dnl
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_2SWAP:__TOKEN_2OVER_DADD,       {__SET_CHECK_TOKEN(__TOKEN_2SWAP_2OVER_DADD)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_2OVER_DADD:__TOKEN_2SWAP,       {__SET_CHECK_TOKEN(__TOKEN_2OVER_DADD_2SWAP)},

__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_PUSH_SWAP:__TOKEN_PUSH_SWAP,    {__SET_CHECK_TOKEN3(__TOKEN_PUSH_SWAP_PUSH_SWAP)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,           __TOKEN_PUSH_SWAP_PUSH_SWAP:__TOKEN_PUSH_SWAP,    {__SET_CHECK_TOKEN3(__TOKEN_PUSH_SWAP_PUSH_SWAP_PUSH_SWAP)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME, __TOKEN_PUSH_SWAP_PUSH_SWAP_PUSH_SWAP:__TOKEN_PUSH_SWAP,    {__SET_CHECK_TOKEN3(__TOKEN_PUSH_SWAP_PUSH_SWAP_PUSH_SWAP_PUSH_SWAP)},

__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP:__TOKEN_PUSH_EQ,            {__SET_CHECK_TOKEN(__TOKEN_DUP_PUSH_EQ)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP_PUSH_EQ:__TOKEN_UNTIL,      {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_EQ_UNTIL)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP_PUSH_EQ:__TOKEN_WHILE,      {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_EQ_WHILE)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP_PUSH_EQ:__TOKEN_IF,         {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_EQ_IF)},

__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP:__TOKEN_PUSH_NE,            {__SET_CHECK_TOKEN(__TOKEN_DUP_PUSH_NE)},
...
__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS:__LAST_TOKEN_NAME,  __TOKEN_DUP_PUSHS:1:__TOKEN_GE_IF,      {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_GE_IF)},
__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS:__LAST_TOKEN_NAME,  __TOKEN_DUP_PUSHS:1:__TOKEN_GT_IF,      {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_GT_IF)},
__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS:__LAST_TOKEN_NAME,  __TOKEN_DUP_PUSHS:1:__TOKEN_ULT_IF,     {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_ULT_IF)},
__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS:__LAST_TOKEN_NAME,  __TOKEN_DUP_PUSHS:1:__TOKEN_ULE_IF,     {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_ULE_IF)},
__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS:__LAST_TOKEN_NAME,  __TOKEN_DUP_PUSHS:1:__TOKEN_UGE_IF,     {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_UGE_IF)},
__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS:__LAST_TOKEN_NAME,  __TOKEN_DUP_PUSHS:1:__TOKEN_UGT_IF,     {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_UGT_IF)},

__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS:__LAST_TOKEN_NAME,  __TOKEN_DUP_PUSHS:1:__TOKEN_LT_WHILE,      {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_LT_WHILE)},
__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS:__LAST_TOKEN_NAME,  __TOKEN_DUP_PUSHS:1:__TOKEN_LE_WHILE,      {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_LE_WHILE)},
__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS:__LAST_TOKEN_NAME,  __TOKEN_DUP_PUSHS:1:__TOKEN_GE_WHILE,      {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_GE_WHILE)},
__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS:__LAST_TOKEN_NAME,  __TOKEN_DUP_PUSHS:1:__TOKEN_GT_WHILE,      {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_GT_WHILE)},
__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS:__LAST_TOKEN_NAME,  __TOKEN_DUP_PUSHS:1:__TOKEN_ULT_WHILE,     {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_ULT_WHILE)},
__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS:__LAST_TOKEN_NAME,  __TOKEN_DUP_PUSHS:1:__TOKEN_ULE_WHILE,     {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_ULE_WHILE)},
__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS:__LAST_TOKEN_NAME,  __TOKEN_DUP_PUSHS:1:__TOKEN_UGE_WHILE,     {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_UGE_WHILE)},
__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS:__LAST_TOKEN_NAME,  __TOKEN_DUP_PUSHS:1:__TOKEN_UGT_WHILE,     {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_UGT_WHILE)},

__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS:__LAST_TOKEN_NAME, __TOKEN_DUP_PUSHS:1:__TOKEN_CEQ,        {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_CEQ)},
__BEFORELAST_TOKEN_NAME:__BEFORELAST_TOKEN_ITEMS:__LAST_TOKEN_NAME, __TOKEN_DUP_PUSHS:1:__TOKEN_HEQ,        {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_HEQ)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP_PUSH_CEQ:__TOKEN_UNTIL,     {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_CEQ_UNTIL)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP_PUSH_HEQ:__TOKEN_UNTIL,     {__SET_CHECK_TOKEN2(__TOKEN_DUP_PUSH_HEQ_UNTIL)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP:__TOKEN_PUSH_CNE,           {__SET_CHECK_TOKEN(__TOKEN_DUP_PUSH_CNE)},

__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP:__TOKEN_PUSH_EQ_IF,         {__SET_CHECK_TOKEN(__TOKEN_DUP_PUSH_EQ_IF)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP:__TOKEN_PUSH_NE_IF,         {__SET_CHECK_TOKEN(__TOKEN_DUP_PUSH_NE_IF)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP:__TOKEN_PUSH_CEQ_IF,        {__SET_CHECK_TOKEN(__TOKEN_DUP_PUSH_CEQ_IF)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP:__TOKEN_PUSH_CNE_IF,        {__SET_CHECK_TOKEN(__TOKEN_DUP_PUSH_CNE_IF)},

__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP:__TOKEN_PUSH_SWAP,          {__SET_CHECK_TOKEN(__TOKEN_PUSH_OVER)},

__BEFORE_X_TOKEN_NAME(2):__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,
__TOKEN_DUP_PUSH_CSTORE:__TOKEN_DUP:__TOKEN_PUSH_CSTORE,
      {__SET_TOKEN(__TOKEN_DUP_PUSH_CSTORE_DUP_PUSH_CSTORE,__BEFORE_X_TOKEN_INFO(2){ }__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__BEFORE_X_TOKEN_ARRAY(2),__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE}){}__SET_TOKEN_X(eval(__COUNT_TOKEN-2),{__TOKEN_NOPE})},

__BEFORE_X_TOKEN_NAME(2):__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,
__TOKEN_DUP_PUSH_CSTORE_DUP_PUSH_CSTORE:__TOKEN_DUP:__TOKEN_PUSH_CSTORE,
      {__SET_TOKEN(__TOKEN_DUP_PUSH_CSTORE_DUP_PUSH_CSTORE_DUP_PUSH_CSTORE,__BEFORE_X_TOKEN_INFO(2){ }__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__BEFORE_X_TOKEN_ARRAY(2),__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE}){}__SET_TOKEN_X(eval(__COUNT_TOKEN-2),{__TOKEN_NOPE})},

__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP:__TOKEN_PUSH_CSTORE,        {__SET_CHECK_TOKEN(__TOKEN_DUP_PUSH_CSTORE)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP:__TOKEN_PUSH_HSTORE,        {__SET_CHECK_TOKEN(__TOKEN_DUP_PUSH_HSTORE)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP:__TOKEN_PUSH_STORE,         {__SET_CHECK_TOKEN(__TOKEN_DUP_PUSH_STORE)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP:__TOKEN_PUSH_ADD,           {__SET_CHECK_TOKEN(__TOKEN_DUP_PUSH_ADD)},

__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP:__TOKEN_PUSH2_WITHIN_IF,    {__SET_CHECK_TOKEN(__TOKEN_DUP_PUSH2_WITHIN_IF)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP:__TOKEN_PUSH2_WITHIN_WHILE, {__SET_CHECK_TOKEN(__TOKEN_DUP_PUSH2_WITHIN_WHILE)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP:__TOKEN_PUSH2_WITHIN_UNTIL, {__SET_CHECK_TOKEN(__TOKEN_DUP_PUSH2_WITHIN_UNTIL)},

__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_FETCH:__TOKEN_PUSHS,            {__SET_CHECK_TOKEN(__TOKEN_FETCH_PUSHS)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_NIP:__TOKEN_PUSHS,              {__SET_CHECK_TOKEN(__TOKEN_NIP_PUSHS)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_NIP:__TOKEN_PUSH_SWAP,          {__SET_CHECK_TOKEN(__TOKEN_NIP_PUSH_SWAP)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DROP:__TOKEN_PUSHS,             {__SET_CHECK_TOKEN(__TOKEN_DROP_PUSHS)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DROP:__TOKEN_PUSH_OVER,         {__SET_CHECK_TOKEN(__TOKEN_DROP_PUSH_OVER)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DROP:__TOKEN_PUSH_RPICK,        {__SET_CHECK_TOKEN(__TOKEN_DROP_PUSH_RPICK)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DROP:__TOKEN_PUSH_PICK,         {__SET_CHECK_TOKEN(__TOKEN_DROP_PUSH_PICK)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS,  __TOKEN_DROP_DUP:__TOKEN_PUSHS:1,       {__SET_CHECK_TOKEN(__TOKEN_DROP_DUP_PUSH)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DROP_DUP:__TOKEN_PUSH_SWAP,     {__SET_CHECK_TOKEN(__TOKEN_DROP_PUSH_OVER)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_OVER:__TOKEN_PUSHS,             {__SET_CHECK_TOKEN(__TOKEN_OVER_PUSHS)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_OVER:__TOKEN_PUSH_ADD,          {__SET_CHECK_TOKEN(__TOKEN_OVER_PUSH_ADD)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_OVER:__TOKEN_PUSH_SWAP,         {__SET_CHECK_TOKEN(__TOKEN_OVER_PUSH_SWAP)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_OVER_PUSH_SWAP:__TOKEN_CSTORE,  {__SET_CHECK_TOKEN2(__TOKEN_OVER_PUSH_SWAP_CSTORE)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_DUP:__TOKEN_PUSHS,              {__SET_CHECK_TOKEN(__TOKEN_DUP_PUSHS)},

__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_2DROP:__TOKEN_PUSHS,            {__SET_CHECK_TOKEN(__TOKEN_2DROP_PUSHS)},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                     __TOKEN_SWAP:__TOKEN_PUSHS,             {__SET_CHECK_TOKEN(__TOKEN_SWAP_PUSHS)},
xxx,yyy,{}){}dnl
}){}dnl
dnl
dnl
