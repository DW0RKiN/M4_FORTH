...
a,,,
            ...
            __LAST_TOKEN_NAME:$1,{__TOKEN_EQ:__TOKEN_IF},{ifelse(__BEFORELAST_TOKEN_NAME,__TOKEN_DUP_PUSH,{__DELETE_LAST_TOKEN{}__SET_TOKEN({__TOKEN_DUP_PUSH_EQ_IF},__LAST_TOKEN_INFO{ =}$2, __LAST_TOKEN_ARRAY)},{__SET_TOKEN({__TOKEN_EQ_IF},__LAST_TOKEN_INFO{ }$2)})},
            __LAST_TOKEN_NAME:$1,{__TOKEN_NE:__TOKEN_IF},{ifelse(__BEFORELAST_TOKEN_NAME,__TOKEN_DUP_PUSH,{__DELETE_LAST_TOKEN{}__SET_TOKEN({__TOKEN_DUP_PUSH_NE_IF},__LAST_TOKEN_INFO{ <>}$2,__LAST_TOKEN_ARRAY)},{__SET_TOKEN({__TOKEN_NE_IF},__LAST_TOKEN_INFO{ }$2)})},
...
push,,,
            ...
            __LAST_TOKEN_NAME-$1,                      {__TOKEN_I-__TOKEN_PUSH},                 {__SET_TOKEN(ifelse(__GET_LOOP_TYPE(LOOP_STACK),S,{__TOKEN_DUP_PUSH},{__TOKEN_I_PUSH}),__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY,$3)},
