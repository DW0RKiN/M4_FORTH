...
__LAST_TOKEN_NAME:eval(__LAST_TOKEN_ITEMS>1):$1:__LAST_TOKEN_IS_PTR_REVERSE_2_1,  __TOKEN_PUSHS:1:__TOKEN_AND:0,    {__SET_TOKEN(__TOKEN_PUSHS, __LAST_TOKEN_INFO{ }$2,ifelse(__LAST_TOKEN_ITEMS,2,,__DROP_2_PAR(__LAST_TOKEN_ARRAY){,})__EVAL_S16(&,__LAST_TOKEN_LAST_2_PAR))},            
