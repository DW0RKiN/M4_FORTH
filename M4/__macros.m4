...
d...,,,
            ...
            __LAST_TOKEN_NAME-$1,{__TOKEN_DLT-__TOKEN_IF},            {__SET_TOKEN({__TOKEN_DGL_IF},__LAST_TOKEN_INFO{ }$2)},
            ...
            __LAST_TOKEN_NAME-$1,{__TOKEN_DULT-__TOKEN_IF},           {__SET_TOKEN({__TOKEN_DUGL_IF},__LAST_TOKEN_INFO{ }$2)},
...
push2,,,
            ...
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_1_2,{__TOKEN_PUSH2-__TOKEN_MOD-1},       {__SET_TOKEN({__TOKEN_PUSH}, __LAST_TOKEN_INFO{ }$2,__EVAL_S16(%,__LAST_TOKEN_ARRAY))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_1_2,{__TOKEN_PUSH2-__TOKEN_DIVMOD-1},    {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__EVAL_S16(%,__LAST_TOKEN_ARRAY),__EVAL_S16(/,__LAST_TOKEN_ARRAY))},

            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_1_2,{__TOKEN_PUSH2-__TOKEN_UDIV-1},      {__SET_TOKEN({__TOKEN_PUSH}, __LAST_TOKEN_INFO{ }$2,__HEX_HL(__HEX_HL(__LAST_TOKEN_ARRAY_1)/__HEX_HL(__LAST_TOKEN_ARRAY_2)))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_1_2,{__TOKEN_PUSH2-__TOKEN_UMOD-1},      {__SET_TOKEN({__TOKEN_PUSH}, __LAST_TOKEN_INFO{ }$2,__HEX_HL(__HEX_HL(__LAST_TOKEN_ARRAY_1)%__HEX_HL(__LAST_TOKEN_ARRAY_2)))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_1_2,{__TOKEN_PUSH2-__TOKEN_UDIVMOD-1},   {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__HEX_HL(__HEX_HL(__LAST_TOKEN_ARRAY_1)%__HEX_HL(__LAST_TOKEN_ARRAY_2)),__HEX_HL(__HEX_HL(__LAST_TOKEN_ARRAY_1)/__HEX_HL(__LAST_TOKEN_ARRAY_2)))},

            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_1_2,{__TOKEN_PUSH2-__TOKEN_MMUL-1},      {__SET_TOKEN({__TOKEN_PUSHDOT},__LAST_TOKEN_INFO{ }$2,eval((__LAST_TOKEN_ARRAY_1)*(__LAST_TOKEN_ARRAY_2)))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_1_2,{__TOKEN_PUSH2-__TOKEN_UMMUL-1},     {__SET_TOKEN({__TOKEN_PUSHDOT},__LAST_TOKEN_INFO{ }$2,eval(__HEX_HL(__LAST_TOKEN_ARRAY_1)*__HEX_HL(__LAST_TOKEN_ARRAY_2)))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_1_2,{__TOKEN_PUSH2-__TOKEN_UMDIVMOD-1},  {__SET_TOKEN({__TOKEN_PUSH2},  __LAST_TOKEN_INFO{ }$2,__HEX_HL(__HEX_DEHL(__LAST_TOKEN_ARRAY_1)%__HEX_HL(__LAST_TOKEN_ARRAY_2)),__HEX_HL(__HEX_DEHL(__LAST_TOKEN_ARRAY_1)/__HEX_HL(__LAST_TOKEN_ARRAY_2)))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_1_2,{__TOKEN_PUSH2-__TOKEN_SMDIVREM-1},  {__SET_TOKEN({__TOKEN_PUSH2},  __LAST_TOKEN_INFO{ }$2,eval((__LAST_TOKEN_ARRAY_1)%(__LAST_TOKEN_ARRAY_2)),eval((__LAST_TOKEN_ARRAY_1)/(__LAST_TOKEN_ARRAY_2)))},

            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_1_2,{__TOKEN_PUSH2-__TOKEN_FMDIVMOD-1},
                {define({__REM},eval((__LAST_TOKEN_ARRAY_1)%(__LAST_TOKEN_ARRAY_2))){}define({__QUOT},eval((__LAST_TOKEN_ARRAY_1)/(__LAST_TOKEN_ARRAY_2))){}ifelse(__REM,0,
                        {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__REM,__QUOT)},
                    eval((__REM ^ (__LAST_TOKEN_ARRAY_2)) & 0x8000),{0},
                        {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__REM,__QUOT)},
                        {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,eval(__LAST_TOKEN_ARRAY_2+__REM),eval(__QUOT-1))})},

            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_1_2,{__TOKEN_PUSH2-__TOKEN_AND-1},       {__SET_TOKEN({__TOKEN_PUSH}, __LAST_TOKEN_INFO{ }$2,eval((__LAST_TOKEN_ARRAY_1)&(__LAST_TOKEN_ARRAY_2)))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_1_2,{__TOKEN_PUSH2-__TOKEN_OR-1},        {__SET_TOKEN({__TOKEN_PUSH}, __LAST_TOKEN_INFO{ }$2,eval((__LAST_TOKEN_ARRAY_1)|(__LAST_TOKEN_ARRAY_2)))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_1_2,{__TOKEN_PUSH2-__TOKEN_XOR-1},       {__SET_TOKEN({__TOKEN_PUSH}, __LAST_TOKEN_INFO{ }$2,eval((__LAST_TOKEN_ARRAY_1)^(__LAST_TOKEN_ARRAY_2)))},

            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_1_2,{__TOKEN_PUSH2-__TOKEN_MAX-1},       {__SET_TOKEN({__TOKEN_PUSH}, __LAST_TOKEN_INFO{ }$2,ifelse(eval(__LAST_TOKEN_ARRAY_1>=__LAST_TOKEN_ARRAY_2),{1},__LAST_TOKEN_ARRAY_1,__LAST_TOKEN_ARRAY_2))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_1_2,{__TOKEN_PUSH2-__TOKEN_MIN-1},       {__SET_TOKEN({__TOKEN_PUSH}, __LAST_TOKEN_INFO{ }$2,ifelse(eval(__LAST_TOKEN_ARRAY_1<=__LAST_TOKEN_ARRAY_2),{1},__LAST_TOKEN_ARRAY_1,__LAST_TOKEN_ARRAY_2))},


            __LAST_TOKEN_NAME-$1,                        {__TOKEN_PUSH2-__TOKEN_ADD},         {__SET_TOKEN({__TOKEN_PUSH}, __LAST_TOKEN_INFO{ }$2,+(__LAST_TOKEN_ARRAY_1)+(__LAST_TOKEN_ARRAY_2))},
            __LAST_TOKEN_NAME-$1,                        {__TOKEN_PUSH2-__TOKEN_SUB},         {__SET_TOKEN({__TOKEN_PUSH}, __LAST_TOKEN_INFO{ }$2,+(__LAST_TOKEN_ARRAY_1)-(__LAST_TOKEN_ARRAY_2))},
            __LAST_TOKEN_NAME-$1,                        {__TOKEN_PUSH2-__TOKEN_MUL},         {__SET_TOKEN({__TOKEN_PUSH}, __LAST_TOKEN_INFO{ }$2,+(__LAST_TOKEN_ARRAY_1)*(__LAST_TOKEN_ARRAY_2))},
            __LAST_TOKEN_NAME-$1,                        {__TOKEN_PUSH2-__TOKEN_UDIV},        {__SET_TOKEN({__TOKEN_PUSH}, __LAST_TOKEN_INFO{ }$2,+(__LAST_TOKEN_ARRAY_1)/(__LAST_TOKEN_ARRAY_2))},
            __LAST_TOKEN_NAME-$1,                        {__TOKEN_PUSH2-__TOKEN_DIV},         {__SET_TOKEN({__TOKEN_PUSH}, __LAST_TOKEN_INFO{ }$2,ifelse(dnl
__SAVE_EVAL(__LAST_TOKEN_ARRAY_1>=0),1,{+((~(__LAST_TOKEN_ARRAY_2))>>15)*__HEX_HL(__LAST_TOKEN_ARRAY_1)/(__LAST_TOKEN_ARRAY_2)-((__LAST_TOKEN_ARRAY_2)>>15)*__HEX_HL(__LAST_TOKEN_ARRAY_1)/(-(__LAST_TOKEN_ARRAY_2))},
__SAVE_EVAL(__LAST_TOKEN_ARRAY_1<0),1,{+((__LAST_TOKEN_ARRAY_2)>>15)*__HEX_HL(-(__LAST_TOKEN_ARRAY_1))/(-(__LAST_TOKEN_ARRAY_2))-((~(__LAST_TOKEN_ARRAY_2))>>15)*__HEX_HL(-(__LAST_TOKEN_ARRAY_1))/(__LAST_TOKEN_ARRAY_2)},
__SAVE_EVAL(__LAST_TOKEN_ARRAY_2>=0),1,{+(((__LAST_TOKEN_ARRAY_1)>>15) xor 1)*(__LAST_TOKEN_ARRAY_1)/__HEX_HL(__LAST_TOKEN_ARRAY_2)-((__LAST_TOKEN_ARRAY_1)>>15)*(-(__LAST_TOKEN_ARRAY_1))/__HEX_HL(__LAST_TOKEN_ARRAY_2)},
__SAVE_EVAL(__LAST_TOKEN_ARRAY_2<0),1,{+((__LAST_TOKEN_ARRAY_1)>>15)*(-(__LAST_TOKEN_ARRAY_1))/__HEX_HL(-(__LAST_TOKEN_ARRAY_2))-((~(__LAST_TOKEN_ARRAY_1))>>15)*(__LAST_TOKEN_ARRAY_1)/__HEX_HL(-(__LAST_TOKEN_ARRAY_2))},
{+((((__LAST_TOKEN_ARRAY_1)|(__LAST_TOKEN_ARRAY_2))>>15) xor 1)*(__LAST_TOKEN_ARRAY_1)/(__LAST_TOKEN_ARRAY_2)-(((~(__LAST_TOKEN_ARRAY_1))&(__LAST_TOKEN_ARRAY_2))>>15)*(__LAST_TOKEN_ARRAY_1)/(-(__LAST_TOKEN_ARRAY_2))-(((__LAST_TOKEN_ARRAY_1)&(~(__LAST_TOKEN_ARRAY_2)))>>15)*(-(__LAST_TOKEN_ARRAY_1))/(__LAST_TOKEN_ARRAY_2)+(((__LAST_TOKEN_ARRAY_1)&(__LAST_TOKEN_ARRAY_2))>>15)*(-(__LAST_TOKEN_ARRAY_1))/(-(__LAST_TOKEN_ARRAY_2))}))},
...
push3,,,
            ...
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_2_3,  {__TOKEN_PUSH3-__TOKEN_DIVMOD-1},  {__SET_TOKEN({__TOKEN_PUSH3},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,__EVAL_S16(%,__LAST_TOKEN_ARRAY_2,__LAST_TOKEN_ARRAY_3),__EVAL_S16(/,__LAST_TOKEN_ARRAY_2,__LAST_TOKEN_ARRAY_3))},

            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_2_3,  {__TOKEN_PUSH3-__TOKEN_UDIV-1},    {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,__HEX_HL(__HEX_HL(__LAST_TOKEN_ARRAY_2)/__HEX_HL(__LAST_TOKEN_ARRAY_3)))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_2_3,  {__TOKEN_PUSH3-__TOKEN_UMOD-1},    {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,__HEX_HL(__HEX_HL(__LAST_TOKEN_ARRAY_2)%__HEX_HL(__LAST_TOKEN_ARRAY_3)))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_2_3,  {__TOKEN_PUSH3-__TOKEN_UDIVMOD-1}, {__SET_TOKEN({__TOKEN_PUSH3},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,__HEX_HL(__HEX_HL(__LAST_TOKEN_ARRAY_2)%__HEX_HL(__LAST_TOKEN_ARRAY_3)),__HEX_HL(__HEX_HL(__LAST_TOKEN_ARRAY_2)/__HEX_HL(__LAST_TOKEN_ARRAY_3)))},

            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_2_3, x{__TOKEN_PUSH3-__TOKEN_MMUL-1},    {__SET_TOKEN({__TOKEN_PUSH2DOT},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,eval((__LAST_TOKEN_ARRAY_2)*(__LAST_TOKEN_ARRAY_3)))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_2_3, x{__TOKEN_PUSH3-__TOKEN_UMMUL-1},   {__SET_TOKEN({__TOKEN_PUSH2DOT},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,eval(__HEX_HL(__LAST_TOKEN_ARRAY_2)*__HEX_HL(__LAST_TOKEN_ARRAY_3)))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_2_3,  {__TOKEN_PUSH3-__TOKEN_UMDIVMOD-1},{__SET_TOKEN({__TOKEN_PUSH3},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,__HEX_HL(__HEX_DEHL(__LAST_TOKEN_ARRAY_2)%__HEX_HL(__LAST_TOKEN_ARRAY_3)),__HEX_HL(__HEX_DEHL(__LAST_TOKEN_ARRAY_2)/__HEX_HL(__LAST_TOKEN_ARRAY_3)))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_2_3,  {__TOKEN_PUSH3-__TOKEN_SMDIVREM-1},{__SET_TOKEN({__TOKEN_PUSH3},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,eval((__LAST_TOKEN_ARRAY_2)%(__LAST_TOKEN_ARRAY_3)),eval((__LAST_TOKEN_ARRAY_2)/(__LAST_TOKEN_ARRAY_3)))},

            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_2_3,{__TOKEN_PUSH3-__TOKEN_FMDIVMOD-1},
                {define({__REM},eval((__LAST_TOKEN_ARRAY_2)%(__LAST_TOKEN_ARRAY_3))){}define({__QUOT},eval((__LAST_TOKEN_ARRAY_2)/(__LAST_TOKEN_ARRAY_3))){}ifelse(__REM,0,
                        {__SET_TOKEN({__TOKEN_PUSH3},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,__REM,__QUOT)},
                    eval((__REM ^ (__LAST_TOKEN_ARRAY_3)) & 0x8000),{0},
                        {__SET_TOKEN({__TOKEN_PUSH3},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,__REM,__QUOT)},
                        {__SET_TOKEN({__TOKEN_PUSH3},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,eval(__LAST_TOKEN_ARRAY_3+__REM),eval(__QUOT-1))})},

            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_2_3,  {__TOKEN_PUSH3-__TOKEN_AND-1},     {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,eval((__LAST_TOKEN_ARRAY_2)&(__LAST_TOKEN_ARRAY_3)))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_2_3,  {__TOKEN_PUSH3-__TOKEN_OR-1},      {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,eval((__LAST_TOKEN_ARRAY_2)|(__LAST_TOKEN_ARRAY_3)))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_2_3,  {__TOKEN_PUSH3-__TOKEN_XOR-1},     {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,eval((__LAST_TOKEN_ARRAY_2)^(__LAST_TOKEN_ARRAY_3)))},

            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_2_3,  {__TOKEN_PUSH3-__TOKEN_MAX-1},     {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,ifelse(eval(__LAST_TOKEN_ARRAY_2>=__LAST_TOKEN_ARRAY_3),{1},__LAST_TOKEN_ARRAY_2,__LAST_TOKEN_ARRAY_3))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_2_3,  {__TOKEN_PUSH3-__TOKEN_MIN-1},     {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,ifelse(eval(__LAST_TOKEN_ARRAY_2<=__LAST_TOKEN_ARRAY_3),{1},__LAST_TOKEN_ARRAY_2,__LAST_TOKEN_ARRAY_3))},


            __LAST_TOKEN_NAME-$1,                          {__TOKEN_PUSH3-__TOKEN_ADD},       {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,+(__LAST_TOKEN_ARRAY_2)+(__LAST_TOKEN_ARRAY_3))},
            ...
            __LAST_TOKEN_NAME-$1,                          {__TOKEN_PUSH3-__TOKEN_UDIV},      {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,+(__LAST_TOKEN_ARRAY_2)/(__LAST_TOKEN_ARRAY_3))},
            __LAST_TOKEN_NAME-$1,                          {__TOKEN_PUSH3-__TOKEN_DIV},       {__SET_TOKEN({__TOKEN_PUSH2}, __LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,ifelse(dnl
__SAVE_EVAL(__LAST_TOKEN_ARRAY_2>=0),1,{+((~(__LAST_TOKEN_ARRAY_3))>>15)*__HEX_HL(__LAST_TOKEN_ARRAY_2)/(__LAST_TOKEN_ARRAY_3)-((__LAST_TOKEN_ARRAY_3)>>15)*__HEX_HL(__LAST_TOKEN_ARRAY_2)/(-(__LAST_TOKEN_ARRAY_3))},
__SAVE_EVAL(__LAST_TOKEN_ARRAY_2<0),1,{+((__LAST_TOKEN_ARRAY_3)>>15)*__HEX_HL(-(__LAST_TOKEN_ARRAY_2))/(-(__LAST_TOKEN_ARRAY_3))-((~(__LAST_TOKEN_ARRAY_3))>>15)*__HEX_HL(-(__LAST_TOKEN_ARRAY_2))/(__LAST_TOKEN_ARRAY_3)},
__SAVE_EVAL(__LAST_TOKEN_ARRAY_3>=0),1,{+(((__LAST_TOKEN_ARRAY_2)>>15) xor 1)*(__LAST_TOKEN_ARRAY_2)/__HEX_HL(__LAST_TOKEN_ARRAY_3)-((__LAST_TOKEN_ARRAY_2)>>15)*(-(__LAST_TOKEN_ARRAY_2))/__HEX_HL(__LAST_TOKEN_ARRAY_3)},
__SAVE_EVAL(__LAST_TOKEN_ARRAY_3<0),1,{+((__LAST_TOKEN_ARRAY_2)>>15)*(-(__LAST_TOKEN_ARRAY_2))/__HEX_HL(-(__LAST_TOKEN_ARRAY_3))-((~(__LAST_TOKEN_ARRAY_2))>>15)*(__LAST_TOKEN_ARRAY_2)/__HEX_HL(-(__LAST_TOKEN_ARRAY_3))},
{+((((__LAST_TOKEN_ARRAY_2)|(__LAST_TOKEN_ARRAY_3))>>15) xor 1)*(__LAST_TOKEN_ARRAY_2)/(__LAST_TOKEN_ARRAY_3)-(((~(__LAST_TOKEN_ARRAY_2))&(__LAST_TOKEN_ARRAY_3))>>15)*(__LAST_TOKEN_ARRAY_2)/(-(__LAST_TOKEN_ARRAY_3))-(((__LAST_TOKEN_ARRAY_2)&(~(__LAST_TOKEN_ARRAY_3)))>>15)*(-(__LAST_TOKEN_ARRAY_2))/(__LAST_TOKEN_ARRAY_3)+(((__LAST_TOKEN_ARRAY_2)&(__LAST_TOKEN_ARRAY_3))>>15)*(-(__LAST_TOKEN_ARRAY_2))/(-(__LAST_TOKEN_ARRAY_3))}))},
...
__{}__{}__{}{define({__TOKEN_COUNT},eval(__TOKEN_COUNT+1)){}__SET_TOKEN($@)})},
            ...
            __LAST_TOKEN_NAME-$1,                          {__TOKEN_PUSH3-__TOKEN_EQ},        {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,+((__LAST_TOKEN_ARRAY_2)=(__LAST_TOKEN_ARRAY_3)))},
            __LAST_TOKEN_NAME-$1,                          {__TOKEN_PUSH3-__TOKEN_NE},        {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,+((__LAST_TOKEN_ARRAY_2)!=(__LAST_TOKEN_ARRAY_3)))},

            __LAST_TOKEN_NAME-$1,                          {__TOKEN_PUSH3-__TOKEN_UEQ},       {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,+((__LAST_TOKEN_ARRAY_2)=(__LAST_TOKEN_ARRAY_3)))},
            __LAST_TOKEN_NAME-$1,                          {__TOKEN_PUSH3-__TOKEN_UNE},       {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,+((__LAST_TOKEN_ARRAY_2)!=(__LAST_TOKEN_ARRAY_3)))},
            __LAST_TOKEN_NAME-$1,                          {__TOKEN_PUSH3-__TOKEN_ULT},       {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,+((__LAST_TOKEN_ARRAY_2)<(__LAST_TOKEN_ARRAY_3)))},
            __LAST_TOKEN_NAME-$1,                          {__TOKEN_PUSH3-__TOKEN_UGT},       {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,+((__LAST_TOKEN_ARRAY_2)>(__LAST_TOKEN_ARRAY_3)))},
            __LAST_TOKEN_NAME-$1,                          {__TOKEN_PUSH3-__TOKEN_ULE},       {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,+((__LAST_TOKEN_ARRAY_2)<=(__LAST_TOKEN_ARRAY_3)))},
            __LAST_TOKEN_NAME-$1,                          {__TOKEN_PUSH3-__TOKEN_UGE},       {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,+((__LAST_TOKEN_ARRAY_2)>=(__LAST_TOKEN_ARRAY_3)))},

            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_2_3,{__TOKEN_PUSH3-__TOKEN_LT-1},        {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,__HEX_HL(-(__LAST_TOKEN_ARRAY_2<__LAST_TOKEN_ARRAY_3)))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_2_3,{__TOKEN_PUSH3-__TOKEN_GT-1},        {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,__HEX_HL(-(__LAST_TOKEN_ARRAY_2>__LAST_TOKEN_ARRAY_3)))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_2_3,{__TOKEN_PUSH3-__TOKEN_LE-1},        {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,__HEX_HL(-(__LAST_TOKEN_ARRAY_2<=__LAST_TOKEN_ARRAY_3)))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_2_3,{__TOKEN_PUSH3-__TOKEN_GE-1},        {__SET_TOKEN({__TOKEN_PUSH2},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,__HEX_HL(-(__LAST_TOKEN_ARRAY_2>=__LAST_TOKEN_ARRAY_3)))},
...
push4,,,
            ...
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_3_4,  {__TOKEN_PUSH4-__TOKEN_ADD-1},     {__SET_TOKEN({__TOKEN_PUSH3},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,__LAST_TOKEN_ARRAY_2,__EVAL_S16(+,__LAST_TOKEN_ARRAY_3,__LAST_TOKEN_ARRAY_4))},
            ...
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_3_4, x{__TOKEN_PUSH4-__TOKEN_UMMUL-1},   {__SET_TOKEN({__TOKEN_PUSH2DOT},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,__LAST_TOKEN_ARRAY_2,eval(__HEX_HL(__LAST_TOKEN_ARRAY_3)*__HEX_HL(__LAST_TOKEN_ARRAY_4)))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_3_4,  {__TOKEN_PUSH4-__TOKEN_UMDIVMOD-1},{__SET_TOKEN({__TOKEN_PUSH4},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,__LAST_TOKEN_ARRAY_2,__HEX_HL(__HEX_DEHL(__LAST_TOKEN_ARRAY_3)%__HEX_HL(__LAST_TOKEN_ARRAY_4)),__HEX_HL(__HEX_DEHL(__LAST_TOKEN_ARRAY_3)/__HEX_HL(__LAST_TOKEN_ARRAY_4)))},
            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_3_4,  {__TOKEN_PUSH4-__TOKEN_SMDIVREM-1},{__SET_TOKEN({__TOKEN_PUSH4},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY_1,__LAST_TOKEN_ARRAY_2,eval((__LAST_TOKEN_ARRAY_3)%(__LAST_TOKEN_ARRAY_4)),eval((__LAST_TOKEN_ARRAY_3)/(__LAST_TOKEN_ARRAY_4)))},

            __LAST_TOKEN_NAME-$1-__LAST_TOKEN_IS_NUM_3_4,{__TOKEN_PUSH4-__TOKEN_FMDIVMOD-1},
                {define({__REM},eval((__LAST_TOKEN_ARRAY_2)%(__LAST_TOKEN_ARRAY_3))){}define({__QUOT},eval((__LAST_TOKEN_ARRAY_2)/(__LAST_TOKEN_ARRAY_3))){}ifelse(__REM,0,
...
__SAVE_EVAL(__LAST_TOKEN_ARRAY_3<0),1,{+((__LAST_TOKEN_ARRAY_4)>>15)*__HEX_HL(-(__LAST_TOKEN_ARRAY_3))/(-(__LAST_TOKEN_ARRAY_4))-((~(__LAST_TOKEN_ARRAY_4))>>15)*__HEX_HL(-(__LAST_TOKEN_ARRAY_3))/(__LAST_TOKEN_ARRAY_4)},
__SAVE_EVAL(__LAST_TOKEN_ARRAY_4>=0),1,{+(((__LAST_TOKEN_ARRAY_3)>>15) xor 1)*(__LAST_TOKEN_ARRAY_3)/__HEX_HL(__LAST_TOKEN_ARRAY_4)-((__LAST_TOKEN_ARRAY_3)>>15)*(-(__LAST_TOKEN_ARRAY_3))/__HEX_HL(__LAST_TOKEN_ARRAY_4)},
__SAVE_EVAL(__LAST_TOKEN_ARRAY_4<0),1,{+((__LAST_TOKEN_ARRAY_3)>>15)*(-(__LAST_TOKEN_ARRAY_3))/__HEX_HL(-(__LAST_TOKEN_ARRAY_4))-((~(__LAST_TOKEN_ARRAY_3))>>15)*(__LAST_TOKEN_ARRAY_3)/__HEX_HL(-(__LAST_TOKEN_ARRAY_4))},
{+((((__LAST_TOKEN_ARRAY_3)|(__LAST_TOKEN_ARRAY_4))>>15) xor 1)*(__LAST_TOKEN_ARRAY_3)/(__LAST_TOKEN_ARRAY_4)-(((~(__LAST_TOKEN_ARRAY_3))&(__LAST_TOKEN_ARRAY_4))>>15)*(__LAST_TOKEN_ARRAY_3)/(-(__LAST_TOKEN_ARRAY_4))-(((__LAST_TOKEN_ARRAY_3)&(~(__LAST_TOKEN_ARRAY_4)))>>15)*(-(__LAST_TOKEN_ARRAY_3))/(__LAST_TOKEN_ARRAY_4)+(((__LAST_TOKEN_ARRAY_3)&(__LAST_TOKEN_ARRAY_4))>>15)*(-(__LAST_TOKEN_ARRAY_3))/(-(__LAST_TOKEN_ARRAY_4))}))},
...
pushdot,,,
            ...
            __LAST_TOKEN_NAME-$1,{__TOKEN_PUSHDOT-__TOKEN_DNE},{__SET_TOKEN({__TOKEN_PUSHDOT_DNE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            __LAST_TOKEN_NAME-$1,{__TOKEN_PUSHDOT-__TOKEN_DLT},{__SET_TOKEN({__TOKEN_PUSHDOT_DLT},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            __LAST_TOKEN_NAME-$1,{__TOKEN_PUSHDOT-__TOKEN_DGT},{__SET_TOKEN({__TOKEN_PUSHDOT_DGT},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            __LAST_TOKEN_NAME-$1,{__TOKEN_PUSHDOT-__TOKEN_DLE},{__SET_TOKEN({__TOKEN_PUSHDOT_DLE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            __LAST_TOKEN_NAME-$1,{__TOKEN_PUSHDOT-__TOKEN_DGE},{__SET_TOKEN({__TOKEN_PUSHDOT_DGE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
