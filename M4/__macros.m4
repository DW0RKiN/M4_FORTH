...
a,,,
            ...
            __LAST_TOKEN_NAME-$1,{__TOKEN_SWAP_PUSH-__TOKEN_EQ},          {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH_EQ}, __BEFORELAST_TOKEN_INFO{ }$2,__BEFORELAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_SWAP}, { swap})},
...
dup,,,
            ...
            __LAST_TOKEN_NAME-$1,{__TOKEN_DUP_PUSHS-__TOKEN_PUSHS},         {__SET_TOKEN({__TOKEN_DUP_PUSHS},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY,shift(shift($@)))},
...
d...,,,
       ...
       smaz __LAST_TOKEN_NAME-$1,{__TOKEN_DROP-__TOKEN_PUSHS},         {__SET_TOKEN({__TOKEN_DROP_PUSHS},__LAST_TOKEN_INFO{ }$2,shift(shift($@)))},
      smaz      __LAST_TOKEN_NAME-$1,{__TOKEN_DROP_PUSHS-__TOKEN_PUSHS},   {__SET_TOKEN({__TOKEN_DROP_PUSHS},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY,shift(shift($@)))},
                        
    smaz        __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1, __TOKEN_DROP_PUSHS:1:__TOKEN_OVER,    {__SET_TOKEN({__TOKEN_DROP_PUSH_OVER},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
    smaz        __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1, __TOKEN_DROP_PUSHS:1:__TOKEN_RPICK,   {__SET_TOKEN({__TOKEN_DROP_PUSH_RPICK},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
     smaz       __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:$1, __TOKEN_DROP_PUSHS:1:__TOKEN_PICK,    {__SET_TOKEN({__TOKEN_DROP_PUSH_PICK},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},

            __LAST_TOKEN_NAME-$1,{__TOKEN_DROP-__TOKEN_DUP},          {__SET_TOKEN({__TOKEN_DROP_DUP},__LAST_TOKEN_INFO{ }$2)},
      smaz      __LAST_TOKEN_NAME:$1:$#, __TOKEN_DROP_DUP:__TOKEN_PUSHS:3,{__SET_TOKEN({__TOKEN_DROP_DUP_PUSH},__LAST_TOKEN_INFO{ }$2,$3)},
      smaz      __LAST_TOKEN_NAME-$1,{__TOKEN_DROP_DUP_PUSH-__TOKEN_SWAP},{__SET_TOKEN({__TOKEN_DROP_PUSH_OVER},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
