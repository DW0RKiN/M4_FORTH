...
__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS:__LAST_TOKEN_EVAL_REVERSE_1:$1,                        __TOKEN_PUSHS:1:0:__TOKEN_CNE,               {__SET_TOKEN({__TOKEN_0CNE}, __LAST_TOKEN_INFO{ }$2)},
            ...
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS-$1,{__TOKEN_DUP_PUSHS:1-__TOKEN_EQ},           {__SET_TOKEN({__TOKEN_DUP_PUSH_EQ}, __LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS-$1,{__TOKEN_DUP_PUSHS:1-__TOKEN_NE},           {__SET_TOKEN({__TOKEN_DUP_PUSH_NE}, __LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS-$1,{__TOKEN_DUP_PUSHS:1-__TOKEN_CEQ},          {__SET_TOKEN({__TOKEN_DUP_PUSH_CEQ},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
            __LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS-$1,{__TOKEN_DUP_PUSHS:1-__TOKEN_CNE},          {__SET_TOKEN({__TOKEN_DUP_PUSH_CNE},__LAST_TOKEN_INFO{ }$2,__LAST_TOKEN_ARRAY)},
...
push,,,
            ...
            __LAST_TOKEN_NAME:$1:__IS_NUM($3),                 __TOKEN_PUSH3:__TOKEN_PUSHDOT:1, {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH3},__BEFORELAST_TOKEN_ARRAY_3{ }$2,__BEFORELAST_TOKEN_ARRAY_3,__HEX_DE($3),__HEX_HL($3)){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_PUSH2},__BEFORELAST_TOKEN_INFO{ drop},__DROP_1_PAR(__BEFORELAST_TOKEN_ARRAY))},
            __LAST_TOKEN_NAME:$1:__IS_NUM($3),                 __TOKEN_PUSH4:__TOKEN_PUSHDOT:1, {__INC_TOKEN_COUNT{}__SET_TOKEN({__TOKEN_PUSH3},__BEFORELAST_TOKEN_ARRAY_4{ }$2,__BEFORELAST_TOKEN_ARRAY_4,__HEX_DE($3),__HEX_HL($3)){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_PUSH3},__BEFORELAST_TOKEN_INFO{ drop},__DROP_1_PAR(__BEFORELAST_TOKEN_ARRAY))},
...
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                         {__TOKEN_DUP:__TOKEN_PUSH_SWAP},       {__SET_TOKEN({__TOKEN_PUSH_OVER},       __BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                         {__TOKEN_DUP:__TOKEN_PUSH_CSTORE},     {__SET_TOKEN({__TOKEN_DUP_PUSH_CSTORE}, __BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                         {__TOKEN_DUP:__TOKEN_PUSH_STORE},      {__SET_TOKEN({__TOKEN_DUP_PUSH_STORE},  __BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                         {__TOKEN_DUP:__TOKEN_PUSH_ADD},        {__SET_TOKEN({__TOKEN_DUP_PUSH_ADD},    __BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                         {__TOKEN_DUP:__TOKEN_PUSH2_WITHIN_IF}, {__SET_TOKEN({__TOKEN_DUP_PUSH2_WITHIN_IF},    __BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
...
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                         {__TOKEN_FETCH:__TOKEN_PUSHS},       {__SET_TOKEN({__TOKEN_FETCH_PUSHS},    __BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                         {__TOKEN_NIP:__TOKEN_PUSHS},         {__SET_TOKEN({__TOKEN_NIP_PUSHS},      __BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                         {__TOKEN_NIP:__TOKEN_PUSH_SWAP},     {__SET_TOKEN({__TOKEN_NIP_PUSH_SWAP},  __BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                         {__TOKEN_DROP:__TOKEN_PUSHS},        {__SET_TOKEN({__TOKEN_DROP_PUSHS},     __BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                          __TOKEN_DROP:__TOKEN_PUSH_OVER,     {__SET_TOKEN({__TOKEN_DROP_PUSH_OVER}, __BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                          __TOKEN_DROP:__TOKEN_PUSH_RPICK,    {__SET_TOKEN({__TOKEN_DROP_PUSH_RPICK},__BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                          __TOKEN_DROP:__TOKEN_PUSH_PICK,     {__SET_TOKEN({__TOKEN_DROP_PUSH_PICK}, __BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME:__LAST_TOKEN_ITEMS,       __TOKEN_DROP_DUP:__TOKEN_PUSHS:1,   {__SET_TOKEN({__TOKEN_DROP_DUP_PUSH},  __BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                         {__TOKEN_DROP_DUP:__TOKEN_PUSH_SWAP},{__SET_TOKEN({__TOKEN_DROP_PUSH_OVER}, __BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                         {__TOKEN_OVER:__TOKEN_PUSHS},        {__SET_TOKEN({__TOKEN_OVER_PUSHS},     __BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                         {__TOKEN_OVER:__TOKEN_PUSH_ADD},     {__SET_TOKEN({__TOKEN_OVER_PUSH_ADD},  __BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                         {__TOKEN_OVER:__TOKEN_PUSH_SWAP},    {__SET_TOKEN({__TOKEN_OVER_PUSH_SWAP}, __BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                          __TOKEN_DUP:__TOKEN_PUSHS,          {__SET_TOKEN(__TOKEN_DUP_PUSHS,        __BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},

__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                         {__TOKEN_2DROP:__TOKEN_PUSHS},       {__SET_TOKEN({__TOKEN_2DROP_PUSHS},    __BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
__BEFORELAST_TOKEN_NAME:__LAST_TOKEN_NAME,                         {__TOKEN_SWAP:__TOKEN_PUSHS},        {__SET_TOKEN({__TOKEN_SWAP_PUSHS},     __BEFORELAST_TOKEN_INFO{ }__LAST_TOKEN_INFO,__LAST_TOKEN_ARRAY){}__SET_TOKEN_X(eval(__COUNT_TOKEN-1),{__TOKEN_NOPE})},
xxx,yyy,{}){}dnl
}){}dnl
dnl
dnl
