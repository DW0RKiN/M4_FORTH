...
__{}__{}    ld    A, H          ; 1:4       __INFO    HL<$1 --> HL-$1<0 --> carry if true
__{}__{}    sbc   A, B          ; 1:4       __INFO    HL<$1 --> HL-$1<0 --> carry if true
...
__{}__{}    ld    A, L          ; 1:4       __INFO    HL<$1 --> HL-$1<0 --> carry if true
__{}__{}    sub   low __FORM({%-10s},$1); 2:7       __INFO    HL<$1 --> HL-$1<0 --> carry if true
__{}__{}    ld    A, H          ; 1:4       __INFO    HL<$1 --> HL-$1<0 --> carry if true
__{}__{}    sbc   A, high __FORM({%-6s},$1); 2:7       __INFO    HL<$1 --> HL-$1<0 --> carry if true
__{}__{}    jp   nc, format({%-11s},else{}IF_COUNT); 3:10      __INFO}){}dnl
}){}dnl
dnl
dnl
...
__{}__{}    ld    A, H          ; 1:4       __INFO    HL>=$1 --> HL-$1>=0 --> not carry if true
__{}__{}    sbc   A, B          ; 1:4       __INFO    HL>=$1 --> HL-$1>=0 --> not carry if true
__{}__{}    rra                 ; 1:4       __INFO
__{}__{}    xor   H             ; 1:4       __INFO
__{}__{}    xor   B             ; 1:4       __INFO
...
__{}__{}__{}  endif},
__{}__{}__{}eval(($1)>=0x8000 || ($1)<0),{0},{dnl
__{}__{}__{}    jp    c, format({%-11s},else{}IF_COUNT); 3:10      __INFO    negative HL >= positive constant ---> false},
__{}__{}__{}{dnl
__{}__{}__{}    jr   nc, $+11       ; 2:7/12    __INFO    positive HL >= negative constant ---> true})
__{}__{}    ld    A, L          ; 1:4       __INFO    HL>=$1 --> HL-$1>=0 --> not carry if true
__{}__{}    sub   low __FORM({%-10s},$1); 2:7       __INFO    HL>=$1 --> HL-$1>=0 --> not carry if true
__{}__{}    ld    A, H          ; 1:4       __INFO    HL>=$1 --> HL-$1>=0 --> not carry if true
__{}__{}    sbc   A, high __FORM({%-6s},$1); 2:7       __INFO    HL>=$1 --> HL-$1>=0 --> not carry if true
...
__{}__{}    ld    A, B          ; 1:4       __INFO    HL>$1 --> 0>$1-HL --> carry if true
__{}__{}    sbc   A, H          ; 1:4       __INFO    HL>$1 --> 0>$1-HL --> carry if true
__{}__{}    rra                 ; 1:4       __INFO
__{}__{}    xor   H             ; 1:4       __INFO
__{}__{}    xor   B             ; 1:4       __INFO
__{}__{}    jp    p, format({%-11s},else{}IF_COUNT); 3:10      __INFO},
...
__{}__{}__{}{dnl
__{}__{}__{}    jr   nc, $+11       ; 2:7/12    __INFO    positive HL > negative constant ---> true})
__{}__{}    ld    A, ifelse(__IS_MEM_REF($1),{1},{format({%-11s},$1); 3:13},{low __FORM({%-7s},$1); 2:7 })      __INFO    HL>$1 --> 0>$1-HL --> carry if true
__{}__{}    sub   L             ; 1:4       __INFO    HL>$1 --> 0>$1-HL --> carry if true
__{}__{}    ld    A, ifelse(__IS_MEM_REF($1),{1},{(format({%-10s},substr($1,1,eval(len($1)-2)){+1)}); 3:13},{high __FORM({%-6s},$1); 2:7 })      __INFO    HL>$1 --> 0>$1-HL --> carry if true
__{}__{}    sbc   A, H          ; 1:4       __INFO    HL>$1 --> 0>$1-HL --> carry if true
__{}__{}    jp   nc, format({%-11s},else{}IF_COUNT); 3:10      __INFO}){}dnl
}){}dnl
dnl
...
__{}$#,{1},,{
__{}__{}.error {$0}($@): $# parameters found in macro!})
__{}    ld    A, ifelse(__IS_MEM_REF($1),{1},{format({%-11s},$1); 3:13},{low __FORM({%-7s},$1); 2:7 })      __INFO    HL<=$1 --> 0<=$1-HL --> not carry if true
__{}    sub   L             ; 1:4       __INFO    HL<=$1 --> 0<=$1-HL --> not carry if true
__{}    ld    A, ifelse(__IS_MEM_REF($1),{1},{(format({%-10s},substr($1,1,eval(len($1)-2)){+1)}); 3:13},{high __FORM({%-6s},$1); 2:7 })      __INFO    HL<=$1 --> 0<=$1-HL --> not carry if true
__{}    sbc   A, H          ; 1:4       __INFO    HL<=$1 --> 0<=$1-HL --> not carry if true
__{}    jp    c, format({%-11s},else{}IF_COUNT); 3:10      __INFO}){}dnl
dnl
dnl
dnl # dup 123 u> if
...
__{}$#,{1},,{
__{}__{}.error {$0}($@): $# parameters found in macro!})
__{}    ld    A, ifelse(__IS_MEM_REF($1),{1},{format({%-11s},$1); 3:13},{low __FORM({%-7s},$1); 2:7 })      __INFO    HL>$1 --> 0>$1-HL --> carry if true
__{}    sub   L             ; 1:4       __INFO    HL>$1 --> 0>$1-HL --> carry if true
__{}    ld    A, ifelse(__IS_MEM_REF($1),{1},{(format({%-10s},substr($1,1,eval(len($1)-2)){+1)}); 3:13},{high __FORM({%-6s},$1); 2:7 })      __INFO    HL>$1 --> 0>$1-HL --> carry if true
__{}    sbc   A, H          ; 1:4       __INFO    HL>$1 --> 0>$1-HL --> carry if true
__{}    jp   nc, format({%-11s},else{}IF_COUNT); 3:10      __INFO}){}dnl
dnl
dnl
dnl
...
__{}__{}    ex   DE, HL         ; 1:4       __INFO
__{}__{}    pop  DE             ; 1:10      __INFO
__{}__{}    jp    c, format({%-11s},else{}IF_COUNT); 3:10      __INFO},
__{}x,xx,{
...
__{}__{}    sbc  HL, BC         ; 2:15      __INFO   HL<$1 --> HL-$1<0 --> no carry if false
__{}__{}    ex   DE, HL         ; 1:4       __INFO
__{}__{}    pop  DE             ; 1:10      __INFO
...
__{}__{}                       ;[16:72]     __INFO   ( x -- )  flag: x <= $1
__{}__{}    ld   BC, format({%-11s},$1); 4:20      __INFO   BC = $1
__{}__{}    ld    A, C          ; 1:4       __INFO   HL<=BC --> 0<=BC-HL --> carry if false
__{}__{}    sub   L             ; 1:4       __INFO   HL<=BC --> 0<=BC-HL --> carry if false
__{}__{}    ld    A, B          ; 1:4       __INFO   HL<=BC --> 0<=BC-HL --> carry if false
__{}__{}    sbc   A, H          ; 1:4       __INFO   HL<=BC --> 0<=BC-HL --> carry if false
__{}__{}    rra                 ; 1:4       __INFO
__{}__{}    xor   H             ; 1:4       __INFO
__{}__{}    xor   B             ; 1:4       __INFO
__{}__{}    ex   DE, HL         ; 1:4       __INFO
...
__{}__{}    or    H             ; 1:4       __INFO
__{}__{}    jr   nc, $+4        ; 2:7/12    __INFO
__{}__{}    sbc  HL, BC         ; 2:15      __INFO   HL<$1 --> HL-$1<0 --> carry if false
__{}__{}    ex   DE, HL         ; 1:4       __INFO
__{}__{}    pop  DE             ; 1:10      __INFO
__{}__{}    jp    c, format({%-11s},else{}IF_COUNT); 3:10      __INFO},
__{}__IS_NUM($1),0,{
...
__{}__{}    sub   L             ; 1:4       __INFO   HL<=$1 --> 0<=$1-HL
__{}__{}    ld    A, high __FORM({%-6s},$1); 2:7       __INFO   HL<=$1 --> 0<=$1-HL
__{}__{}    sbc   A, H          ; 1:4       __INFO   HL<=$1 --> 0<=$1-HL --> carry if false
__{}__{}    rra                 ; 1:4       __INFO
__{}__{}    xor   H             ; 1:4       __INFO
__{}__{}    ex   DE, HL         ; 1:4       __INFO
__{}__{}    pop  DE             ; 1:10      __INFO
...
__{}__{}    ex   DE, HL         ; 1:4       __INFO
__{}__{}    pop  DE             ; 1:10      __INFO
__{}__{}    jp    ifelse(eval(0x8000&($1)),0,m,p), format({%-11s},else{}IF_COUNT); 3:10      __INFO}){}dnl
}){}dnl
dnl
dnl
dnl
...
__{}__{}    sbc   A, high __FORM({%-6s},$1); 2:7       __INFO   HL<$1 --> H-$1<0 --> no carry if false
__{}__{}    rra                 ; 1:4       __INFO
__{}__{}    xor   H             ; 1:4       __INFO
__{}__{}    ex   DE, HL         ; 1:4       __INFO
__{}__{}    pop  DE             ; 1:10      __INFO
...
__{}__{}                       ;[16:72]     __INFO   ( x -- )  flag: x >= $1
__{}__{}    ld   BC, format({%-11s},$1); 4:20      __INFO   BC = $1
__{}__{}    ld    A, L          ; 1:4       __INFO   HL>=BC --> HL-BC>=0 --> carry if false
__{}__{}    sub   C             ; 1:4       __INFO   HL>=BC --> HL-BC>=0 --> carry if false
__{}__{}    ld    A, H          ; 1:4       __INFO   HL>=BC --> HL-BC>=0 --> carry if false
__{}__{}    sbc   A, B          ; 1:4       __INFO   HL>=BC --> HL-BC>=0 --> carry if false
__{}__{}    rra                 ; 1:4       __INFO
__{}__{}    xor   H             ; 1:4       __INFO
__{}__{}    xor   B             ; 1:4       __INFO
__{}__{}    ex   DE, HL         ; 1:4       __INFO
...
__{}__{}    sub  low __FORM({%-11s},$1); 2:7       __INFO   HL>=$1 --> L-$1>=0
__{}__{}    ld    A, H          ; 1:4       __INFO   HL>=$1 --> H-$1>=0
__{}__{}    sbc   A, high __FORM({%-6s},$1); 2:7       __INFO   HL>=$1 --> H-$1>=0 --> carry if false
__{}__{}    rra                 ; 1:4       __INFO
__{}__{}    xor   H             ; 1:4       __INFO
__{}__{}    ex   DE, HL         ; 1:4       __INFO
__{}__{}    pop  DE             ; 1:10      __INFO
...
__{}__{}    sub   __HEX_L($1)          ; 2:7       __INFO   HL>=$1 --> L-__HEX_L($1)>=0
__{}__{}    ld    A, H          ; 1:4       __INFO   HL>=$1 --> H-__HEX_H($1)>=0
__{}__{}    sbc   A, __HEX_H($1)       ; 2:7       __INFO   HL>=$1 --> H-__HEX_H($1)>=0 --> carry if false
__{}__{}    rra                 ; 1:4       __INFO
__{}__{}    xor   H             ; 1:4       __INFO
__{}__{}    ex   DE, HL         ; 1:4       __INFO
__{}__{}    pop  DE             ; 1:10      __INFO
