...
__{}pushdef({ELSE_STACK}, IF_COUNT){}dnl
__{}pushdef({THEN_STACK}, IF_COUNT){}dnl
__{}__MAKE_CODE_DLT_SET_CARRY($@,{( d -- )   # default version can be changed with "define({_TYP_DOUBLE},{function})"},3,10)
    jp   nc, else{}IF_COUNT    ; 3:10      __INFO}){}dnl
}){}dnl
dnl
dnl
dnl
...
__{}define({__INFO},__COMPILE_INFO)
    ...
    xor (HL)            ; 1:7       __INFO
    jp   nz, else{}IF_COUNT    ; 3:10      __INFO
    ld    B, E          ; 1:4       __INFO
    ld    C, L          ; 1:4       __INFO
    inc   L             ; 1:4       __INFO
    inc   E             ; 1:4       __INFO
...
__{}define({__INFO},__COMPILE_INFO)
    ...
    ld    E, B          ; 1:4       __INFO
    ld    L, C          ; 1:4       __INFO
    jp    c, else{}IF_COUNT    ; 3:10      __INFO}){}dnl
dnl
dnl
dnl
dnl [pd2] > [pd1]
