...
; ^^^^
    ...
    PUSH2(4, 0) SDO SI PUSH(0) QUESTIONSDO SJ DOT SI DOT SLOOP PUTCHAR({','}) SLOOP CR
      XDO(4, 0)     XI PUSH(0) QUESTIONSDO XI DOT SI DOT SLOOP PUTCHAR({','}) XLOOP CR
    ...
    PUSH2(12,3) SDO        SI DUP_DOT PUSH(7) GE IF LEAVE THEN         SLOOP    CR
                ...
                XDO(12,3)  XI DUP_DOT PUSH(7) GE IF LEAVE THEN PUSH_ADDXLOOP(2) CR
                XDO(550,3) XI DUP_DOT PUSH(7) GE IF LEAVE THEN PUSH_ADDXLOOP(2) CR
