...
;   ===  b e g i n  ===
    ...
    ld    A, L          ; 1:4       1283 *   256*L = 512x
    add  HL, BC         ; 1:11      1283 *      +1 = 3x 
    add   A, L          ; 1:4       1283 *  +256*L = 1280x 
    add   A, H          ; 1:4       1283 *
    ld    H, A          ; 1:4       1283 *     [1283x] = 3x + 1280x  
    ...
    ld    A, L          ; 1:4       1287 *   256*L = 512x
    add  HL, BC         ; 1:11      1287 *      +1 = 3x 
    add   A, L          ; 1:4       1287 *  +256*L = 1280x 
    add  HL, HL         ; 1:11      1287 *   1  *2 = 6x
    add  HL, BC         ; 1:11      1287 *      +1 = 7x 
    add   A, H          ; 1:4       1287 *
    ld    H, A          ; 1:4       1287 *     [1287x] = 7x + 1280x  
    ...
    add   A, H          ; 1:4       1311 *
    ld    H, A          ; 1:4       1311 *     [1311x] = 31x + 1280x  
    ...
    ld    A, L          ; 1:4       1329 *   256*L = 512x
    add  HL, BC         ; 1:11      1329 *      +1 = 3x 
    add   A, L          ; 1:4       1329 *  +256*L = 1280x 
    ...
    add   A, H          ; 1:4       1343 *
    ld    H, A          ; 1:4       1343 *     [1343x] = 63x + 1280x 
    ...
    ld    A, L          ; 1:4       1377 *   256*L = 512x
    add  HL, BC         ; 1:11      1377 *      +1 = 3x 
    add   A, L          ; 1:4       1377 *  +256*L = 1280x 
    ...
    add   A, H          ; 1:4       1407 *
    ld    H, A          ; 1:4       1407 *     [1407x] = 127x + 1280x  
    ...
    ld    A, L          ; 1:4       1473 *   256*L = 512x
    add  HL, BC         ; 1:11      1473 *      +1 = 3x 
    add   A, L          ; 1:4       1473 *  +256*L = 1280x 
    ...
    add   A, H          ; 1:4       1501 *
    ld    H, A          ; 1:4       1501 *     [1501x] = 221x + 1280x  
    ...
    ld    A, L          ; 1:4       1505 *   256*L = 512x
    add  HL, BC         ; 1:11      1505 *      +1 = 3x 
    add   A, L          ; 1:4       1505 *  +256*L = 1280x 
    ...
    add   A, H          ; 1:4       1517 *
    ld    H, A          ; 1:4       1517 *     [1517x] = 237x + 1280x  
    ...
    ld    A, L          ; 1:4       1521 *   256*L = 512x
    add  HL, BC         ; 1:11      1521 *      +1 = 3x 
    add   A, L          ; 1:4       1521 *  +256*L = 1280x 
    ...
    add   A, H          ; 1:4       1525 *
    ld    H, A          ; 1:4       1525 *     [1525x] = 245x + 1280x  
    ...
    ld    A, L          ; 1:4       1529 *   256*L = 512x
    add  HL, BC         ; 1:11      1529 *      +1 = 3x 
    add   A, L          ; 1:4       1529 *  +256*L = 1280x 
    ...
    add   A, H          ; 1:4       1533 *
    ld    H, A          ; 1:4       1533 *     [1533x] = 253x + 1280x  
    ...
    ld    H, A          ; 1:4       1537 *     [1537x] = 256 * 6x + 1x  
                        ;[9:50]     1539 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0110_0000_0011)
    ld    B, H          ; 1:4       1539 *
    ld    C, L          ; 1:4       1539 *   1       1x = base 
    ld    A, L          ; 1:4       1539 *   256*L = 256x 
    add  HL, HL         ; 1:11      1539 *   1  *2 = 2x
    add   A, L          ; 1:4       1539 *  +256*L = 768x
    add  HL, BC         ; 1:11      1539 *      +1 = 3x 
    add   A, L          ; 1:4       1539 *  +256*L = 1536x 
    add   A, H          ; 1:4       1539 *
    ld    H, A          ; 1:4       1539 *     [1539x] = 3x + 1536x  
