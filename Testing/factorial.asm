...
;   ===  b e g i n  ===
    ...
    add   A, H          ; 1:4       267 *
    ld    H, A          ; 1:4       267 *     [267x] = 11x + 256*1x  
    ...
    add   A, H          ; 1:4       269 *
    ld    H, A          ; 1:4       269 *     [269x] = 13x + 256*1x  
    ...
    add   A, H          ; 1:4       271 *
    ld    H, A          ; 1:4       271 *     [271x] = 15x + 256*1x  
    ...
    add   A, H          ; 1:4       275 *
    ld    H, A          ; 1:4       275 *     [275x] = 19x + 256*1x 
    ...
    add   A, H          ; 1:4       277 *
    ld    H, A          ; 1:4       277 *     [277x] = 21x + 256*1x  
    ...
    add   A, H          ; 1:4       279 *
    ld    H, A          ; 1:4       279 *     [279x] = 23x + 256*1x  
    ...
    add   A, H          ; 1:4       281 *
    ld    H, A          ; 1:4       281 *     [281x] = 25x + 256*1x  
    ...
    add   A, H          ; 1:4       283 *
    ld    H, A          ; 1:4       283 *     [283x] = 27x + 256*1x  
    ...
    add   A, H          ; 1:4       285 *
    ld    H, A          ; 1:4       285 *     [285x] = 29x + 256*1x  
    ...
    add   A, H          ; 1:4       287 *
    ld    H, A          ; 1:4       287 *     [287x] = 31x + 256*1x  
    ...
    add   A, H          ; 1:4       291 *
    ld    H, A          ; 1:4       291 *     [291x] = 35x + 256*1x  
    ...
    add   A, H          ; 1:4       295 *
    ld    H, A          ; 1:4       295 *     [295x] = 39x + 256*1x  
    ...
    add   A, H          ; 1:4       297 *
    ld    H, A          ; 1:4       297 *     [297x] = 41x + 256*1x 
    ...
    add   A, H          ; 1:4       299 *
    ld    H, A          ; 1:4       299 *     [299x] = 43x + 256*1x  
    ...
    add   A, H          ; 1:4       301 *
    ld    H, A          ; 1:4       301 *     [301x] = 45x + 256*1x  
    ...
    add   A, H          ; 1:4       303 *
    ld    H, A          ; 1:4       303 *     [303x] = 47x + 256*1x  
    ...
    add   A, H          ; 1:4       305 *
    ld    H, A          ; 1:4       305 *     [305x] = 49x + 256*1x  
    ...
    add   A, H          ; 1:4       307 *
    ld    H, A          ; 1:4       307 *     [307x] = 51x + 256*1x  
    ...
    add   A, H          ; 1:4       309 *
    ld    H, A          ; 1:4       309 *     [309x] = 53x + 256*1x  
    ...
    add   A, H          ; 1:4       311 *
    ld    H, A          ; 1:4       311 *     [311x] = 55x + 256*1x  
    ...
    add   A, H          ; 1:4       313 *
    ld    H, A          ; 1:4       313 *     [313x] = 57x + 256*1x  
    ...
    add   A, H          ; 1:4       315 *
    ld    H, A          ; 1:4       315 *     [315x] = 59x + 256*1x  
    ...
    add   A, H          ; 1:4       317 *
    ld    H, A          ; 1:4       317 *     [317x] = 61x + 256*1x  
    ...
    add   A, H          ; 1:4       319 *
    ld    H, A          ; 1:4       319 *     [319x] = 63x + 256*1x 
    ...
    add   A, H          ; 1:4       323 *
    ld    H, A          ; 1:4       323 *     [323x] = 67x + 256*1x  
    ...
    add   A, H          ; 1:4       325 *
    ld    H, A          ; 1:4       325 *     [325x] = 69x + 256*1x  
    ...
    add   A, H          ; 1:4       327 *
    ld    H, A          ; 1:4       327 *     [327x] = 71x + 256*1x  
    ...
    add   A, H          ; 1:4       329 *
    ld    H, A          ; 1:4       329 *     [329x] = 73x + 256*1x  
    ...
    add   A, H          ; 1:4       331 *
    ld    H, A          ; 1:4       331 *     [331x] = 75x + 256*1x  
    ...
    add   A, H          ; 1:4       333 *
    ld    H, A          ; 1:4       333 *     [333x] = 77x + 256*1x  
    ...
    add   A, H          ; 1:4       335 *
    ld    H, A          ; 1:4       335 *     [335x] = 79x + 256*1x  
    ...
    add   A, H          ; 1:4       337 *
    ld    H, A          ; 1:4       337 *     [337x] = 81x + 256*1x  
    ...
    add   A, H          ; 1:4       339 *
    ld    H, A          ; 1:4       339 *     [339x] = 83x + 256*1x  
    ...
    add   A, H          ; 1:4       341 *
    ld    H, A          ; 1:4       341 *     [341x] = 85x + 256*1x 
    ...
    add   A, H          ; 1:4       343 *
    ld    H, A          ; 1:4       343 *     [343x] = 87x + 256*1x  
    ...
    add   A, H          ; 1:4       345 *
    ld    H, A          ; 1:4       345 *     [345x] = 89x + 256*1x  
    ...
    add   A, H          ; 1:4       347 *
    ld    H, A          ; 1:4       347 *     [347x] = 91x + 256*1x  
    ...
    add   A, H          ; 1:4       349 *
    ld    H, A          ; 1:4       349 *     [349x] = 93x + 256*1x  
    ...
    add   A, H          ; 1:4       351 *
    ld    H, A          ; 1:4       351 *     [351x] = 95x + 256*1x  
    ...
    add   A, H          ; 1:4       353 *
    ld    H, A          ; 1:4       353 *     [353x] = 97x + 256*1x  
    ...
    add   A, H          ; 1:4       355 *
    ld    H, A          ; 1:4       355 *     [355x] = 99x + 256*1x  
    ...
    add   A, H          ; 1:4       357 *
    ld    H, A          ; 1:4       357 *     [357x] = 101x + 256*1x  
    ...
    add   A, H          ; 1:4       359 *
    ld    H, A          ; 1:4       359 *     [359x] = 103x + 256*1x  
    ...
    add   A, H          ; 1:4       361 *
    ld    H, A          ; 1:4       361 *     [361x] = 105x + 256*1x  
    ...
    add   A, H          ; 1:4       363 *
    ld    H, A          ; 1:4       363 *     [363x] = 107x + 256*1x 
    ...
    add   A, H          ; 1:4       365 *
    ld    H, A          ; 1:4       365 *     [365x] = 109x + 256*1x  
    ...
    add   A, H          ; 1:4       367 *
    ld    H, A          ; 1:4       367 *     [367x] = 111x + 256*1x  
    ...
    add   A, H          ; 1:4       369 *
    ld    H, A          ; 1:4       369 *     [369x] = 113x + 256*1x  
    ...
    add   A, H          ; 1:4       371 *
    ld    H, A          ; 1:4       371 *     [371x] = 115x + 256*1x  
    ...
    add   A, H          ; 1:4       373 *
    ld    H, A          ; 1:4       373 *     [373x] = 117x + 256*1x  
    ...
    add   A, H          ; 1:4       375 *
    ld    H, A          ; 1:4       375 *     [375x] = 119x + 256*1x  
    ...
    add   A, H          ; 1:4       377 *
    ld    H, A          ; 1:4       377 *     [377x] = 121x + 256*1x  
    ...
    add   A, H          ; 1:4       379 *
    ld    H, A          ; 1:4       379 *     [379x] = 123x + 256*1x  
    ...
    add   A, H          ; 1:4       381 *
    ld    H, A          ; 1:4       381 *     [381x] = 125x + 256*1x  
    ...
    add   A, H          ; 1:4       383 *
    ld    H, A          ; 1:4       383 *     [383x] = 127x + 256*1x  
    ...
    sbc  HL, BC         ; 2:15      511 *   [511x] = 512x - 1x   
                        ;[4:16]     513 *   Variant mk4: 256*...(((L*2^a)+L)*2^b)+...+HL = HL * (b_0010_0000_0001)
    ld    A, L          ; 1:4       513 *   1       1x 
    ...
    add   A, H          ; 1:4       523 *
    ld    H, A          ; 1:4       523 *     [523x] = 11x + 256*2x  
    ...
    add   A, H          ; 1:4       525 *
    ld    H, A          ; 1:4       525 *     [525x] = 13x + 256*2x  
    ...
    add   A, H          ; 1:4       527 *
    ld    H, A          ; 1:4       527 *     [527x] = 15x + 256*2x  
    ...
    add   A, H          ; 1:4       531 *
    ld    H, A          ; 1:4       531 *     [531x] = 19x + 256*2x  
    ...
    add   A, H          ; 1:4       533 *
    ld    H, A          ; 1:4       533 *     [533x] = 21x + 256*2x  
    ...
    add   A, H          ; 1:4       535 *
    ld    H, A          ; 1:4       535 *     [535x] = 23x + 256*2x  
    ...
    add   A, H          ; 1:4       537 *
    ld    H, A          ; 1:4       537 *     [537x] = 25x + 256*2x  
    ...
    add   A, H          ; 1:4       539 *
    ld    H, A          ; 1:4       539 *     [539x] = 27x + 256*2x 
    ...
    add   A, H          ; 1:4       541 *
    ld    H, A          ; 1:4       541 *     [541x] = 29x + 256*2x  
    ...
    add   A, H          ; 1:4       543 *
    ld    H, A          ; 1:4       543 *     [543x] = 31x + 256*2x  
    ...
    add   A, H          ; 1:4       547 *
    ld    H, A          ; 1:4       547 *     [547x] = 35x + 256*2x  
    ...
    add   A, H          ; 1:4       549 *
    ld    H, A          ; 1:4       549 *     [549x] = 37x + 256*2x  
    ...
    add   A, H          ; 1:4       551 *
    ld    H, A          ; 1:4       551 *     [551x] = 39x + 256*2x  
    ...
    add   A, H          ; 1:4       553 *
    ld    H, A          ; 1:4       553 *     [553x] = 41x + 256*2x  
    ...
    add   A, H          ; 1:4       555 *
    ld    H, A          ; 1:4       555 *     [555x] = 43x + 256*2x  
    ...
    add   A, H          ; 1:4       557 *
    ld    H, A          ; 1:4       557 *     [557x] = 45x + 256*2x  
    ...
    add   A, H          ; 1:4       559 *
    ld    H, A          ; 1:4       559 *     [559x] = 47x + 256*2x  
    ...
    add   A, H          ; 1:4       561 *
    ld    H, A          ; 1:4       561 *     [561x] = 49x + 256*2x 
    ...
    add   A, H          ; 1:4       563 *
    ld    H, A          ; 1:4       563 *     [563x] = 51x + 256*2x  
    ...
    add   A, H          ; 1:4       565 *
    ld    H, A          ; 1:4       565 *     [565x] = 53x + 256*2x  
    ...
    add   A, H          ; 1:4       567 *
    ld    H, A          ; 1:4       567 *     [567x] = 55x + 256*2x  
    ...
    add   A, H          ; 1:4       569 *
    ld    H, A          ; 1:4       569 *     [569x] = 57x + 256*2x  
    ...
    add   A, H          ; 1:4       571 *
    ld    H, A          ; 1:4       571 *     [571x] = 59x + 256*2x  
    ...
    add   A, H          ; 1:4       573 *
    ld    H, A          ; 1:4       573 *     [573x] = 61x + 256*2x  
    ...
    add   A, H          ; 1:4       575 *
    ld    H, A          ; 1:4       575 *     [575x] = 63x + 256*2x  
    ...
    add   A, H          ; 1:4       579 *
    ld    H, A          ; 1:4       579 *     [579x] = 67x + 256*2x  
    ...
    add   A, H          ; 1:4       581 *
    ld    H, A          ; 1:4       581 *     [581x] = 69x + 256*2x  
    ...
    add   A, H          ; 1:4       583 *
    ld    H, A          ; 1:4       583 *     [583x] = 71x + 256*2x 
    ...
    add   A, H          ; 1:4       585 *
    ld    H, A          ; 1:4       585 *     [585x] = 73x + 256*2x  
    ...
    add   A, H          ; 1:4       587 *
    ld    H, A          ; 1:4       587 *     [587x] = 75x + 256*2x  
    ...
    add   A, H          ; 1:4       589 *
    ld    H, A          ; 1:4       589 *     [589x] = 77x + 256*2x  
    ...
    add   A, H          ; 1:4       591 *
    ld    H, A          ; 1:4       591 *     [591x] = 79x + 256*2x  
    ...
    add   A, H          ; 1:4       593 *
    ld    H, A          ; 1:4       593 *     [593x] = 81x + 256*2x  
    ...
    add   A, H          ; 1:4       595 *
    ld    H, A          ; 1:4       595 *     [595x] = 83x + 256*2x  
    ...
    add   A, H          ; 1:4       597 *
    ld    H, A          ; 1:4       597 *     [597x] = 85x + 256*2x  
    ...
    add   A, H          ; 1:4       599 *
    ld    H, A          ; 1:4       599 *     [599x] = 87x + 256*2x  
    ...
    add   A, H          ; 1:4       601 *
    ld    H, A          ; 1:4       601 *     [601x] = 89x + 256*2x  
    ...
    add   A, H          ; 1:4       603 *
    ld    H, A          ; 1:4       603 *     [603x] = 91x + 256*2x  
    ...
    add   A, H          ; 1:4       605 *
    ld    H, A          ; 1:4       605 *     [605x] = 93x + 256*2x 
    ...
    add   A, H          ; 1:4       607 *
    ld    H, A          ; 1:4       607 *     [607x] = 95x + 256*2x  
    ...
    add   A, H          ; 1:4       609 *
    ld    H, A          ; 1:4       609 *     [609x] = 97x + 256*2x  
    ...
    add   A, H          ; 1:4       611 *
    ld    H, A          ; 1:4       611 *     [611x] = 99x + 256*2x  
    ...
    add   A, H          ; 1:4       613 *
    ld    H, A          ; 1:4       613 *     [613x] = 101x + 256*2x  
    ...
    add   A, H          ; 1:4       615 *
    ld    H, A          ; 1:4       615 *     [615x] = 103x + 256*2x  
    ...
    add   A, H          ; 1:4       617 *
    ld    H, A          ; 1:4       617 *     [617x] = 105x + 256*2x  
    ...
    add   A, H          ; 1:4       619 *
    ld    H, A          ; 1:4       619 *     [619x] = 107x + 256*2x  
    ...
    add   A, H          ; 1:4       621 *
    ld    H, A          ; 1:4       621 *     [621x] = 109x + 256*2x  
    ...
    add   A, H          ; 1:4       623 *
    ld    H, A          ; 1:4       623 *     [623x] = 111x + 256*2x  
    ...
    add   A, H          ; 1:4       625 *
    ld    H, A          ; 1:4       625 *     [625x] = 113x + 256*2x  
    ...
    add   A, H          ; 1:4       627 *
    ld    H, A          ; 1:4       627 *     [627x] = 115x + 256*2x 
    ...
    add   A, H          ; 1:4       629 *
    ld    H, A          ; 1:4       629 *     [629x] = 117x + 256*2x  
    ...
    add   A, H          ; 1:4       631 *
    ld    H, A          ; 1:4       631 *     [631x] = 119x + 256*2x  
    ...
    add   A, H          ; 1:4       633 *
    ld    H, A          ; 1:4       633 *     [633x] = 121x + 256*2x  
    ...
    add   A, H          ; 1:4       635 *
    ld    H, A          ; 1:4       635 *     [635x] = 123x + 256*2x  
    ...
    add   A, H          ; 1:4       637 *
    ld    H, A          ; 1:4       637 *     [637x] = 125x + 256*2x  
    ...
    add   A, H          ; 1:4       639 *
    ld    H, A          ; 1:4       639 *     [639x] = 127x + 256*2x  
    ...
    add   A, H          ; 1:4       643 *
    ld    H, A          ; 1:4       643 *     [643x] = 131x + 256*2x  
    ...
    add   A, H          ; 1:4       645 *
    ld    H, A          ; 1:4       645 *     [645x] = 133x + 256*2x  
    ...
    add   A, H          ; 1:4       647 *
    ld    H, A          ; 1:4       647 *     [647x] = 135x + 256*2x  
    ...
    add   A, H          ; 1:4       649 *
    ld    H, A          ; 1:4       649 *     [649x] = 137x + 256*2x 
    ...
    add   A, H          ; 1:4       651 *
    ld    H, A          ; 1:4       651 *     [651x] = 139x + 256*2x  
    ...
    add   A, H          ; 1:4       653 *
    ld    H, A          ; 1:4       653 *     [653x] = 141x + 256*2x  
    ...
    add   A, H          ; 1:4       655 *
    ld    H, A          ; 1:4       655 *     [655x] = 143x + 256*2x  
    ...
    add   A, H          ; 1:4       657 *
    ld    H, A          ; 1:4       657 *     [657x] = 145x + 256*2x  
    ...
    add   A, H          ; 1:4       659 *
    ld    H, A          ; 1:4       659 *     [659x] = 147x + 256*2x  
    ...
    add   A, H          ; 1:4       661 *
    ld    H, A          ; 1:4       661 *     [661x] = 149x + 256*2x  
    ...
    add   A, H          ; 1:4       663 *
    ld    H, A          ; 1:4       663 *     [663x] = 151x + 256*2x  
    ...
    add   A, H          ; 1:4       665 *
    ld    H, A          ; 1:4       665 *     [665x] = 153x + 256*2x  
    ...
    add   A, H          ; 1:4       667 *
    ld    H, A          ; 1:4       667 *     [667x] = 155x + 256*2x  
    ...
    add   A, H          ; 1:4       669 *
    ld    H, A          ; 1:4       669 *     [669x] = 157x + 256*2x  
    ...
    add   A, H          ; 1:4       671 *
    ld    H, A          ; 1:4       671 *     [671x] = 159x + 256*2x 
    ...
    add   A, H          ; 1:4       673 *
    ld    H, A          ; 1:4       673 *     [673x] = 161x + 256*2x  
    ...
    add   A, H          ; 1:4       675 *
    ld    H, A          ; 1:4       675 *     [675x] = 163x + 256*2x  
    ...
    add   A, H          ; 1:4       677 *
    ld    H, A          ; 1:4       677 *     [677x] = 165x + 256*2x  
    ...
    add   A, H          ; 1:4       679 *
    ld    H, A          ; 1:4       679 *     [679x] = 167x + 256*2x  
    ...
    add   A, H          ; 1:4       681 *
    ld    H, A          ; 1:4       681 *     [681x] = 169x + 256*2x  
    ...
    add   A, H          ; 1:4       683 *
    ld    H, A          ; 1:4       683 *     [683x] = 171x + 256*2x  
    ...
    add   A, H          ; 1:4       685 *
    ld    H, A          ; 1:4       685 *     [685x] = 173x + 256*2x  
    ...
    add   A, H          ; 1:4       687 *
    ld    H, A          ; 1:4       687 *     [687x] = 175x + 256*2x  
    ...
    add   A, H          ; 1:4       689 *
    ld    H, A          ; 1:4       689 *     [689x] = 177x + 256*2x  
    ...
    add   A, H          ; 1:4       691 *
    ld    H, A          ; 1:4       691 *     [691x] = 179x + 256*2x  
    ...
    add   A, H          ; 1:4       693 *
    ld    H, A          ; 1:4       693 *     [693x] = 181x + 256*2x 
    ...
    add   A, H          ; 1:4       695 *
    ld    H, A          ; 1:4       695 *     [695x] = 183x + 256*2x  
    ...
    add   A, H          ; 1:4       697 *
    ld    H, A          ; 1:4       697 *     [697x] = 185x + 256*2x  
    ...
    add   A, H          ; 1:4       699 *
    ld    H, A          ; 1:4       699 *     [699x] = 187x + 256*2x  
    ...
    add   A, H          ; 1:4       701 *
    ld    H, A          ; 1:4       701 *     [701x] = 189x + 256*2x  
    ...
    add   A, H          ; 1:4       703 *
    ld    H, A          ; 1:4       703 *     [703x] = 191x + 256*2x  
    ...
    add   A, H          ; 1:4       705 *
    ld    H, A          ; 1:4       705 *     [705x] = 193x + 256*2x  
    ...
    add   A, H          ; 1:4       707 *
    ld    H, A          ; 1:4       707 *     [707x] = 195x + 256*2x  
    ...
    add   A, H          ; 1:4       709 *
    ld    H, A          ; 1:4       709 *     [709x] = 197x + 256*2x  
    ...
    add   A, H          ; 1:4       711 *
    ld    H, A          ; 1:4       711 *     [711x] = 199x + 256*2x  
    ...
    add   A, H          ; 1:4       713 *
    ld    H, A          ; 1:4       713 *     [713x] = 201x + 256*2x  
    ...
    add   A, H          ; 1:4       715 *
    ld    H, A          ; 1:4       715 *     [715x] = 203x + 256*2x 
    ...
    add   A, H          ; 1:4       717 *
    ld    H, A          ; 1:4       717 *     [717x] = 205x + 256*2x  
    ...
    add   A, H          ; 1:4       719 *
    ld    H, A          ; 1:4       719 *     [719x] = 207x + 256*2x  
    ...
    add   A, H          ; 1:4       721 *
    ld    H, A          ; 1:4       721 *     [721x] = 209x + 256*2x  
    ...
    add   A, H          ; 1:4       723 *
    ld    H, A          ; 1:4       723 *     [723x] = 211x + 256*2x  
    ...
    add   A, H          ; 1:4       725 *
    ld    H, A          ; 1:4       725 *     [725x] = 213x + 256*2x  
    ...
    add   A, H          ; 1:4       727 *
    ld    H, A          ; 1:4       727 *     [727x] = 215x + 256*2x  
    ...
    add   A, H          ; 1:4       729 *
    ld    H, A          ; 1:4       729 *     [729x] = 217x + 256*2x  
    ...
    add   A, H          ; 1:4       731 *
    ld    H, A          ; 1:4       731 *     [731x] = 219x + 256*2x  
    ...
    add   A, H          ; 1:4       733 *
    ld    H, A          ; 1:4       733 *     [733x] = 221x + 256*2x  
    ...
    add   A, H          ; 1:4       735 *
    ld    H, A          ; 1:4       735 *     [735x] = 223x + 256*2x  
    ...
    add   A, H          ; 1:4       737 *
    ld    H, A          ; 1:4       737 *     [737x] = 225x + 256*2x 
    ...
    add   A, H          ; 1:4       739 *
    ld    H, A          ; 1:4       739 *     [739x] = 227x + 256*2x  
    ...
    add   A, H          ; 1:4       741 *
    ld    H, A          ; 1:4       741 *     [741x] = 229x + 256*2x  
    ...
    add   A, H          ; 1:4       743 *
    ld    H, A          ; 1:4       743 *     [743x] = 231x + 256*2x  
    ...
    add   A, H          ; 1:4       745 *
    ld    H, A          ; 1:4       745 *     [745x] = 233x + 256*2x  
    ...
    add   A, H          ; 1:4       747 *
    ld    H, A          ; 1:4       747 *     [747x] = 235x + 256*2x  
    ...
    add   A, H          ; 1:4       749 *
    ld    H, A          ; 1:4       749 *     [749x] = 237x + 256*2x  
    ...
    add   A, H          ; 1:4       753 *
    ld    H, A          ; 1:4       753 *     [753x] = 241x + 256*2x  
    ...
    add   A, H          ; 1:4       755 *
    ld    H, A          ; 1:4       755 *     [755x] = 243x + 256*2x  
    ...
    add   A, H          ; 1:4       757 *
    ld    H, A          ; 1:4       757 *     [757x] = 245x + 256*2x  
    ...
    add   A, H          ; 1:4       761 *
    ld    H, A          ; 1:4       761 *     [761x] = 249x + 256*2x  
    ...
    add   A, H          ; 1:4       765 *
    ld    H, A          ; 1:4       765 *     [765x] = 253x + 256*2x  
    ...
    sbc  HL, BC         ; 2:15      767 *   [767x] = 1024x - 257x   
                        ;[5:20]     769 *   Variant mk4: 256*...(((L*2^a)+L)*2^b)+...+HL = HL * (b_0011_0000_0001)
    ld    A, L          ; 1:4       769 *   1       1x 
    ...
    add   A, H          ; 1:4       781 *
    ld    H, A          ; 1:4       781 *     [781x] = 13x + 256*3x 
    ...
    add   A, H          ; 1:4       783 *
    ld    H, A          ; 1:4       783 *     [783x] = 15x + 256*3x  
    ...
    add   A, H          ; 1:4       791 *
    ld    H, A          ; 1:4       791 *     [791x] = 23x + 256*3x  
    ...
    add   A, H          ; 1:4       793 *
    ld    H, A          ; 1:4       793 *     [793x] = 25x + 256*3x  
    ...
    add   A, H          ; 1:4       795 *
    ld    H, A          ; 1:4       795 *     [795x] = 27x + 256*3x  
    ...
    add   A, H          ; 1:4       797 *
    ld    H, A          ; 1:4       797 *     [797x] = 29x + 256*3x  
    ...
    add   A, H          ; 1:4       799 *
    ld    H, A          ; 1:4       799 *     [799x] = 31x + 256*3x  
    ...
    add   A, H          ; 1:4       803 *
    ld    H, A          ; 1:4       803 *     [803x] = 35x + 256*3x 
    ...
    add   A, H          ; 1:4       815 *
    ld    H, A          ; 1:4       815 *     [815x] = 47x + 256*3x  
    ...
    add   A, H          ; 1:4       817 *
    ld    H, A          ; 1:4       817 *     [817x] = 49x + 256*3x  
    ...
    add   A, H          ; 1:4       819 *
    ld    H, A          ; 1:4       819 *     [819x] = 51x + 256*3x  
    ...
    add   A, H          ; 1:4       821 *
    ld    H, A          ; 1:4       821 *     [821x] = 53x + 256*3x  
    ...
    add   A, H          ; 1:4       823 *
    ld    H, A          ; 1:4       823 *     [823x] = 55x + 256*3x  
    ...
    add   A, H          ; 1:4       825 *
    ld    H, A          ; 1:4       825 *     [825x] = 57x + 256*3x 
    ...
    add   A, H          ; 1:4       827 *
    ld    H, A          ; 1:4       827 *     [827x] = 59x + 256*3x  
    ...
    add   A, H          ; 1:4       829 *
    ld    H, A          ; 1:4       829 *     [829x] = 61x + 256*3x  
    ...
    add   A, H          ; 1:4       831 *
    ld    H, A          ; 1:4       831 *     [831x] = 63x + 256*3x  
    ...
    add   A, H          ; 1:4       847 *
    ld    H, A          ; 1:4       847 *     [847x] = 79x + 256*3x 
    ...
    add   A, H          ; 1:4       863 *
    ld    H, A          ; 1:4       863 *     [863x] = 95x + 256*3x  
    ...
    add   A, H          ; 1:4       865 *
    ld    H, A          ; 1:4       865 *     [865x] = 97x + 256*3x  
    ...
    add   A, H          ; 1:4       867 *
    ld    H, A          ; 1:4       867 *     [867x] = 99x + 256*3x  
    ...
    add   A, H          ; 1:4       869 *
    ld    H, A          ; 1:4       869 *     [869x] = 101x + 256*3x 
    ...
    add   A, H          ; 1:4       871 *
    ld    H, A          ; 1:4       871 *     [871x] = 103x + 256*3x  
    ...
    add   A, H          ; 1:4       873 *
    ld    H, A          ; 1:4       873 *     [873x] = 105x + 256*3x  
    ...
    add   A, H          ; 1:4       875 *
    ld    H, A          ; 1:4       875 *     [875x] = 107x + 256*3x  
    ...
    add   A, H          ; 1:4       877 *
    ld    H, A          ; 1:4       877 *     [877x] = 109x + 256*3x  
    ...
    add   A, H          ; 1:4       879 *
    ld    H, A          ; 1:4       879 *     [879x] = 111x + 256*3x  
    ...
    add   A, H          ; 1:4       881 *
    ld    H, A          ; 1:4       881 *     [881x] = 113x + 256*3x  
    ...
    add   A, H          ; 1:4       883 *
    ld    H, A          ; 1:4       883 *     [883x] = 115x + 256*3x  
    ...
    add   A, H          ; 1:4       885 *
    ld    H, A          ; 1:4       885 *     [885x] = 117x + 256*3x  
    ...
    add   A, H          ; 1:4       887 *
    ld    H, A          ; 1:4       887 *     [887x] = 119x + 256*3x  
    ...
    add   A, H          ; 1:4       889 *
    ld    H, A          ; 1:4       889 *     [889x] = 121x + 256*3x  
    ...
    add   A, H          ; 1:4       891 *
    ld    H, A          ; 1:4       891 *     [891x] = 123x + 256*3x 
    ...
    add   A, H          ; 1:4       893 *
    ld    H, A          ; 1:4       893 *     [893x] = 125x + 256*3x  
    ...
    add   A, H          ; 1:4       895 *
    ld    H, A          ; 1:4       895 *     [895x] = 127x + 256*3x  
    ...
    add   A, H          ; 1:4       913 *
    ld    H, A          ; 1:4       913 *     [913x] = 145x + 256*3x 
    ...
    add   A, H          ; 1:4       935 *
    ld    H, A          ; 1:4       935 *     [935x] = 167x + 256*3x 
    ...
    add   A, H          ; 1:4       957 *
    ld    H, A          ; 1:4       957 *     [957x] = 189x + 256*3x 
    ...
    add   A, H          ; 1:4       961 *
    ld    H, A          ; 1:4       961 *     [961x] = 193x + 256*3x  
    ...
    add   A, H          ; 1:4       963 *
    ld    H, A          ; 1:4       963 *     [963x] = 195x + 256*3x  
    ...
    add   A, H          ; 1:4       965 *
    ld    H, A          ; 1:4       965 *     [965x] = 197x + 256*3x  
    ...
    add   A, H          ; 1:4       967 *
    ld    H, A          ; 1:4       967 *     [967x] = 199x + 256*3x  
    ...
    add   A, H          ; 1:4       969 *
    ld    H, A          ; 1:4       969 *     [969x] = 201x + 256*3x  
    ...
    add   A, H          ; 1:4       971 *
    ld    H, A          ; 1:4       971 *     [971x] = 203x + 256*3x  
    ...
    add   A, H          ; 1:4       973 *
    ld    H, A          ; 1:4       973 *     [973x] = 205x + 256*3x  
    ...
    add   A, H          ; 1:4       975 *
    ld    H, A          ; 1:4       975 *     [975x] = 207x + 256*3x  
    ...
    add   A, H          ; 1:4       977 *
    ld    H, A          ; 1:4       977 *     [977x] = 209x + 256*3x  
    ...
    add   A, H          ; 1:4       979 *
    ld    H, A          ; 1:4       979 *     [979x] = 211x + 256*3x 
    ...
    add   A, H          ; 1:4       981 *
    ld    H, A          ; 1:4       981 *     [981x] = 213x + 256*3x  
    ...
    add   A, H          ; 1:4       983 *
    ld    H, A          ; 1:4       983 *     [983x] = 215x + 256*3x  
    ...
    add   A, H          ; 1:4       985 *
    ld    H, A          ; 1:4       985 *     [985x] = 217x + 256*3x  
    ...
    add   A, H          ; 1:4       987 *
    ld    H, A          ; 1:4       987 *     [987x] = 219x + 256*3x  
    ...
    add   A, H          ; 1:4       989 *
    ld    H, A          ; 1:4       989 *     [989x] = 221x + 256*3x  
    ...
    add   A, H          ; 1:4       993 *
    ld    H, A          ; 1:4       993 *     [993x] = 225x + 256*3x  
    ...
    add   A, H          ; 1:4       995 *
    ld    H, A          ; 1:4       995 *     [995x] = 227x + 256*3x  
    ...
    add   A, H          ; 1:4       997 *
    ld    H, A          ; 1:4       997 *     [997x] = 229x + 256*3x  
    ...
    add   A, H          ; 1:4       999 *
    ld    H, A          ; 1:4       999 *     [999x] = 231x + 256*3x  
    ...
    add   A, H          ; 1:4       1001 *
    ld    H, A          ; 1:4       1001 *     [1001x] = 233x + 256*3x 
    ...
    add   A, H          ; 1:4       1003 *
    ld    H, A          ; 1:4       1003 *     [1003x] = 235x + 256*3x  
    ...
    add   A, H          ; 1:4       1005 *
    ld    H, A          ; 1:4       1005 *     [1005x] = 237x + 256*3x  
    ...
    add   A, H          ; 1:4       1009 *
    ld    H, A          ; 1:4       1009 *     [1009x] = 241x + 256*3x  
    ...
    add   A, H          ; 1:4       1011 *
    ld    H, A          ; 1:4       1011 *     [1011x] = 243x + 256*3x  
    ...
    add   A, H          ; 1:4       1013 *
    ld    H, A          ; 1:4       1013 *     [1013x] = 245x + 256*3x  
    ...
    add   A, H          ; 1:4       1017 *
    ld    H, A          ; 1:4       1017 *     [1017x] = 249x + 256*3x  
    ...
    sbc  HL, BC         ; 2:15      1023 *   [1023x] = 1024x - 1x   
                        ;[5:20]     1025 *   Variant mk4: 256*...(((L*2^a)+L)*2^b)+...+HL = HL * (b_0100_0000_0001)
    ...
    ld    A, L          ; 1:4       1027 *       L = 1x 
    add  HL, HL         ; 1:11      1027 *   1  *2 = 2x
    add  HL, BC         ; 1:11      1027 *      +1 = 3x 
    add   A, L          ; 1:4       1027 *      +L = 4x 
    add   A, H          ; 1:4       1027 *
    ld    H, A          ; 1:4       1027 *     [1027x] = 3x + 256*4x  
    ...
    add   A, H          ; 1:4       1055 *
    ld    H, A          ; 1:4       1055 *     [1055x] = 31x + 256*4x 
    ...
    add   A, H          ; 1:4       1059 *
    ld    H, A          ; 1:4       1059 *     [1059x] = 35x + 256*4x  
    ...
    add   A, H          ; 1:4       1061 *
    ld    H, A          ; 1:4       1061 *     [1061x] = 37x + 256*4x  
    ...
    add   A, H          ; 1:4       1063 *
    ld    H, A          ; 1:4       1063 *     [1063x] = 39x + 256*4x  
    ...
    add   A, H          ; 1:4       1065 *
    ld    H, A          ; 1:4       1065 *     [1065x] = 41x + 256*4x  
    ...
    add   A, H          ; 1:4       1067 *
    ld    H, A          ; 1:4       1067 *     [1067x] = 43x + 256*4x  
    ...
    add   A, H          ; 1:4       1087 *
    ld    H, A          ; 1:4       1087 *     [1087x] = 63x + 256*4x  
    ...
    add   A, H          ; 1:4       1091 *
    ld    H, A          ; 1:4       1091 *     [1091x] = 67x + 256*4x 
    ...
    add   A, H          ; 1:4       1093 *
    ld    H, A          ; 1:4       1093 *     [1093x] = 69x + 256*4x  
    ...
    add   A, H          ; 1:4       1095 *
    ld    H, A          ; 1:4       1095 *     [1095x] = 71x + 256*4x  
    ...
    add   A, H          ; 1:4       1097 *
    ld    H, A          ; 1:4       1097 *     [1097x] = 73x + 256*4x  
    ...
    add   A, H          ; 1:4       1099 *
    ld    H, A          ; 1:4       1099 *     [1099x] = 75x + 256*4x  
    ...
    add   A, H          ; 1:4       1101 *
    ld    H, A          ; 1:4       1101 *     [1101x] = 77x + 256*4x  
    ...
    add   A, H          ; 1:4       1103 *
    ld    H, A          ; 1:4       1103 *     [1103x] = 79x + 256*4x  
    ...
    add   A, H          ; 1:4       1105 *
    ld    H, A          ; 1:4       1105 *     [1105x] = 81x + 256*4x  
    ...
    add   A, H          ; 1:4       1107 *
    ld    H, A          ; 1:4       1107 *     [1107x] = 83x + 256*4x  
    ...
    add   A, H          ; 1:4       1109 *
    ld    H, A          ; 1:4       1109 *     [1109x] = 85x + 256*4x 
    ...
    add   A, H          ; 1:4       1111 *
    ld    H, A          ; 1:4       1111 *     [1111x] = 87x + 256*4x  
    ...
    add   A, H          ; 1:4       1113 *
    ld    H, A          ; 1:4       1113 *     [1113x] = 89x + 256*4x  
    ...
    add   A, H          ; 1:4       1115 *
    ld    H, A          ; 1:4       1115 *     [1115x] = 91x + 256*4x  
    ...
    add   A, H          ; 1:4       1117 *
    ld    H, A          ; 1:4       1117 *     [1117x] = 93x + 256*4x  
    ...
    add   A, H          ; 1:4       1151 *
    ld    H, A          ; 1:4       1151 *     [1151x] = 127x + 256*4x  
    ...
    add   A, H          ; 1:4       1155 *
    ld    H, A          ; 1:4       1155 *     [1155x] = 131x + 256*4x  
    ...
    add   A, H          ; 1:4       1157 *
    ld    H, A          ; 1:4       1157 *     [1157x] = 133x + 256*4x  
    ...
    add   A, H          ; 1:4       1159 *
    ld    H, A          ; 1:4       1159 *     [1159x] = 135x + 256*4x  
    ...
    add   A, H          ; 1:4       1161 *
    ld    H, A          ; 1:4       1161 *     [1161x] = 137x + 256*4x  
    ...
    add   A, H          ; 1:4       1163 *
    ld    H, A          ; 1:4       1163 *     [1163x] = 139x + 256*4x 
    ...
    add   A, H          ; 1:4       1165 *
    ld    H, A          ; 1:4       1165 *     [1165x] = 141x + 256*4x  
    ...
    add   A, H          ; 1:4       1167 *
    ld    H, A          ; 1:4       1167 *     [1167x] = 143x + 256*4x  
    ...
    add   A, H          ; 1:4       1169 *
    ld    H, A          ; 1:4       1169 *     [1169x] = 145x + 256*4x  
    ...
    add   A, H          ; 1:4       1171 *
    ld    H, A          ; 1:4       1171 *     [1171x] = 147x + 256*4x  
    ...
    add   A, H          ; 1:4       1173 *
    ld    H, A          ; 1:4       1173 *     [1173x] = 149x + 256*4x  
    ...
    add   A, H          ; 1:4       1175 *
    ld    H, A          ; 1:4       1175 *     [1175x] = 151x + 256*4x  
    ...
    add   A, H          ; 1:4       1177 *
    ld    H, A          ; 1:4       1177 *     [1177x] = 153x + 256*4x  
    ...
    add   A, H          ; 1:4       1179 *
    ld    H, A          ; 1:4       1179 *     [1179x] = 155x + 256*4x  
    ...
    add   A, H          ; 1:4       1181 *
    ld    H, A          ; 1:4       1181 *     [1181x] = 157x + 256*4x 
    ...
    add   A, H          ; 1:4       1183 *
    ld    H, A          ; 1:4       1183 *     [1183x] = 159x + 256*4x  
    ...
    add   A, H          ; 1:4       1185 *
    ld    H, A          ; 1:4       1185 *     [1185x] = 161x + 256*4x  
    ...
    add   A, H          ; 1:4       1187 *
    ld    H, A          ; 1:4       1187 *     [1187x] = 163x + 256*4x  
    ...
    add   A, H          ; 1:4       1189 *
    ld    H, A          ; 1:4       1189 *     [1189x] = 165x + 256*4x  
    ...
    add   A, H          ; 1:4       1191 *
    ld    H, A          ; 1:4       1191 *     [1191x] = 167x + 256*4x  
    ...
    add   A, H          ; 1:4       1193 *
    ld    H, A          ; 1:4       1193 *     [1193x] = 169x + 256*4x  
    ...
    add   A, H          ; 1:4       1195 *
    ld    H, A          ; 1:4       1195 *     [1195x] = 171x + 256*4x  
    ...
    add   A, H          ; 1:4       1197 *
    ld    H, A          ; 1:4       1197 *     [1197x] = 173x + 256*4x  
    ...
    add   A, H          ; 1:4       1199 *
    ld    H, A          ; 1:4       1199 *     [1199x] = 175x + 256*4x 
    ...
    add   A, H          ; 1:4       1201 *
    ld    H, A          ; 1:4       1201 *     [1201x] = 177x + 256*4x  
    ...
    add   A, H          ; 1:4       1203 *
    ld    H, A          ; 1:4       1203 *     [1203x] = 179x + 256*4x  
    ...
    add   A, H          ; 1:4       1205 *
    ld    H, A          ; 1:4       1205 *     [1205x] = 181x + 256*4x  
    ...
    add   A, H          ; 1:4       1207 *
    ld    H, A          ; 1:4       1207 *     [1207x] = 183x + 256*4x  
    ...
    add   A, H          ; 1:4       1209 *
    ld    H, A          ; 1:4       1209 *     [1209x] = 185x + 256*4x  
    ...
    add   A, H          ; 1:4       1211 *
    ld    H, A          ; 1:4       1211 *     [1211x] = 187x + 256*4x  
    ...
    add   A, H          ; 1:4       1213 *
    ld    H, A          ; 1:4       1213 *     [1213x] = 189x + 256*4x  
    ...
    add   A, H          ; 1:4       1261 *
    ld    H, A          ; 1:4       1261 *     [1261x] = 237x + 256*4x  
    ...
    add   A, H          ; 1:4       1269 *
    ld    H, A          ; 1:4       1269 *     [1269x] = 245x + 256*4x  
    ...
    add   A, H          ; 1:4       1277 *
    ld    H, A          ; 1:4       1277 *     [1277x] = 253x + 256*4x  
    ...
    sbc  HL, BC         ; 2:15      1279 *   [1279x] = 2048x - 769x   
                        ;[6:24]     1281 *   Variant mk4: 256*...(((L*2^a)+L)*2^b)+...+HL = HL * (b_0101_0000_0001)
    ...
    ld    H, A          ; 1:4       1281 *     [1281x] = 256 * 5x + 1x  
                        ;[8:46]     1283 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0000_0011)
    ld    B, H          ; 1:4       1283 *
    ld    C, L          ; 1:4       1283 *   1       1x = base 
    add  HL, HL         ; 1:11      1283 *   1  *2 = 2x
    ld    A, L          ; 1:4       1283 *      +L = 2x
    add  HL, BC         ; 1:11      1283 *      +1 = 3x 
    add   A, L          ; 1:4       1283 *      +L = 5x 
    add   A, H          ; 1:4       1283 *
    ld    H, A          ; 1:4       1283 *     [1283x] = 3x + 256*5x  
    ...
    ld    A, L          ; 1:4       1285 *       L = 5x 
    add   A, H          ; 1:4       1285 *
    ld    H, A          ; 1:4       1285 *     [1285x] = 5x + 256*5x  
                        ;[10:68]    1287 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0000_0111)
    ld    B, H          ; 1:4       1287 *
    ld    C, L          ; 1:4       1287 *   1       1x = base 
    add  HL, HL         ; 1:11      1287 *   1  *2 = 2x
    ld    A, L          ; 1:4       1287 *      +L = 2x
    add  HL, BC         ; 1:11      1287 *      +1 = 3x 
    add   A, L          ; 1:4       1287 *      +L = 5x 
    add  HL, HL         ; 1:11      1287 *   1  *2 = 6x
    add  HL, BC         ; 1:11      1287 *      +1 = 7x 
    add   A, H          ; 1:4       1287 *
    ld    H, A          ; 1:4       1287 *     [1287x] = 7x + 256*5x  
    ...
    add   A, H          ; 1:4       1307 *
    ld    H, A          ; 1:4       1307 *     [1307x] = 27x + 256*5x 

                        ;[13:101]   1309 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0001_1101)
    ld    B, H          ; 1:4       1309 *
    ld    C, L          ; 1:4       1309 *   1       1x = base 
    add  HL, HL         ; 1:11      1309 *   1  *2 = 2x
    ld    A, L          ; 1:4       1309 *      +L = 2x
    add  HL, BC         ; 1:11      1309 *      +1 = 3x 
    add   A, L          ; 1:4       1309 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1309 *
    ld    H, A          ; 1:4       1309 *     [1309x] = 29x + 256*5x  
                        ;[14:112]   1311 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0001_1111)
    ld    B, H          ; 1:4       1311 *
    ld    C, L          ; 1:4       1311 *   1       1x = base 
    add  HL, HL         ; 1:11      1311 *   1  *2 = 2x
    ld    A, L          ; 1:4       1311 *      +L = 2x
    add  HL, BC         ; 1:11      1311 *      +1 = 3x 
    add   A, L          ; 1:4       1311 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1311 *
    ld    H, A          ; 1:4       1311 *     [1311x] = 31x + 256*5x  
    ...
    add   A, H          ; 1:4       1319 *
    ld    H, A          ; 1:4       1319 *     [1319x] = 39x + 256*5x  
    ...
    add   A, H          ; 1:4       1323 *
    ld    H, A          ; 1:4       1323 *     [1323x] = 43x + 256*5x  
    ...
    add   A, H          ; 1:4       1325 *
    ld    H, A          ; 1:4       1325 *     [1325x] = 45x + 256*5x 
    ...
    add   A, H          ; 1:4       1327 *
    ld    H, A          ; 1:4       1327 *     [1327x] = 47x + 256*5x  
                        ;[13:101]   1329 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0011_0001)
    ld    B, H          ; 1:4       1329 *
    ld    C, L          ; 1:4       1329 *   1       1x = base 
    add  HL, HL         ; 1:11      1329 *   1  *2 = 2x
    ld    A, L          ; 1:4       1329 *      +L = 2x
    add  HL, BC         ; 1:11      1329 *      +1 = 3x 
    add   A, L          ; 1:4       1329 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1329 *
    ld    H, A          ; 1:4       1329 *     [1329x] = 49x + 256*5x  
                        ;[14:112]   1331 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0011_0011)
    ld    B, H          ; 1:4       1331 *
    ld    C, L          ; 1:4       1331 *   1       1x = base 
    add  HL, HL         ; 1:11      1331 *   1  *2 = 2x
    ld    A, L          ; 1:4       1331 *      +L = 2x
    add  HL, BC         ; 1:11      1331 *      +1 = 3x 
    add   A, L          ; 1:4       1331 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1331 *
    ld    H, A          ; 1:4       1331 *     [1331x] = 51x + 256*5x  
                        ;[14:112]   1333 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0011_0101)
    ld    B, H          ; 1:4       1333 *
    ld    C, L          ; 1:4       1333 *   1       1x = base 
    add  HL, HL         ; 1:11      1333 *   1  *2 = 2x
    ld    A, L          ; 1:4       1333 *      +L = 2x
    add  HL, BC         ; 1:11      1333 *      +1 = 3x 
    add   A, L          ; 1:4       1333 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1333 *
    ld    H, A          ; 1:4       1333 *     [1333x] = 53x + 256*5x  
                        ;[15:123]   1335 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0011_0111)
    ld    B, H          ; 1:4       1335 *
    ld    C, L          ; 1:4       1335 *   1       1x = base 
    add  HL, HL         ; 1:11      1335 *   1  *2 = 2x
    ld    A, L          ; 1:4       1335 *      +L = 2x
    add  HL, BC         ; 1:11      1335 *      +1 = 3x 
    add   A, L          ; 1:4       1335 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1335 *
    ld    H, A          ; 1:4       1335 *     [1335x] = 55x + 256*5x  
                        ;[14:112]   1337 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0011_1001)
    ld    B, H          ; 1:4       1337 *
    ld    C, L          ; 1:4       1337 *   1       1x = base 
    add  HL, HL         ; 1:11      1337 *   1  *2 = 2x
    ld    A, L          ; 1:4       1337 *      +L = 2x
    add  HL, BC         ; 1:11      1337 *      +1 = 3x 
    add   A, L          ; 1:4       1337 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1337 *
    ld    H, A          ; 1:4       1337 *     [1337x] = 57x + 256*5x  
                        ;[15:123]   1339 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0011_1011)
    ld    B, H          ; 1:4       1339 *
    ld    C, L          ; 1:4       1339 *   1       1x = base 
    add  HL, HL         ; 1:11      1339 *   1  *2 = 2x
    ld    A, L          ; 1:4       1339 *      +L = 2x
    add  HL, BC         ; 1:11      1339 *      +1 = 3x 
    add   A, L          ; 1:4       1339 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1339 *
    ld    H, A          ; 1:4       1339 *     [1339x] = 59x + 256*5x  
                        ;[15:123]   1341 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0011_1101)
    ld    B, H          ; 1:4       1341 *
    ld    C, L          ; 1:4       1341 *   1       1x = base 
    add  HL, HL         ; 1:11      1341 *   1  *2 = 2x
    ld    A, L          ; 1:4       1341 *      +L = 2x
    add  HL, BC         ; 1:11      1341 *      +1 = 3x 
    add   A, L          ; 1:4       1341 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1341 *
    ld    H, A          ; 1:4       1341 *     [1341x] = 61x + 256*5x  
                        ;[16:134]   1343 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0011_1111)
    ld    B, H          ; 1:4       1343 *
    ld    C, L          ; 1:4       1343 *   1       1x = base 
    add  HL, HL         ; 1:11      1343 *   1  *2 = 2x
    ld    A, L          ; 1:4       1343 *      +L = 2x
    add  HL, BC         ; 1:11      1343 *      +1 = 3x 
    add   A, L          ; 1:4       1343 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1343 *
    ld    H, A          ; 1:4       1343 *     [1343x] = 63x + 256*5x 
    ...
    add   A, H          ; 1:4       1359 *
    ld    H, A          ; 1:4       1359 *     [1359x] = 79x + 256*5x  
    ...
    add   A, H          ; 1:4       1361 *
    ld    H, A          ; 1:4       1361 *     [1361x] = 81x + 256*5x 
    ...
    add   A, H          ; 1:4       1363 *
    ld    H, A          ; 1:4       1363 *     [1363x] = 83x + 256*5x  
    ...
    add   A, H          ; 1:4       1365 *
    ld    H, A          ; 1:4       1365 *     [1365x] = 85x + 256*5x  
    ...
    add   A, H          ; 1:4       1367 *
    ld    H, A          ; 1:4       1367 *     [1367x] = 87x + 256*5x  
    ...
    add   A, H          ; 1:4       1369 *
    ld    H, A          ; 1:4       1369 *     [1369x] = 89x + 256*5x  
    ...
    add   A, H          ; 1:4       1371 *
    ld    H, A          ; 1:4       1371 *     [1371x] = 91x + 256*5x  
    ...
    add   A, H          ; 1:4       1373 *
    ld    H, A          ; 1:4       1373 *     [1373x] = 93x + 256*5x  
    ...
    add   A, H          ; 1:4       1375 *
    ld    H, A          ; 1:4       1375 *     [1375x] = 95x + 256*5x  
                        ;[14:112]   1377 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0110_0001)
    ld    B, H          ; 1:4       1377 *
    ld    C, L          ; 1:4       1377 *   1       1x = base 
    add  HL, HL         ; 1:11      1377 *   1  *2 = 2x
    ld    A, L          ; 1:4       1377 *      +L = 2x
    add  HL, BC         ; 1:11      1377 *      +1 = 3x 
    add   A, L          ; 1:4       1377 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1377 *
    ld    H, A          ; 1:4       1377 *     [1377x] = 97x + 256*5x  
                        ;[15:123]   1379 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0110_0011)
    ld    B, H          ; 1:4       1379 *
    ld    C, L          ; 1:4       1379 *   1       1x = base 
    add  HL, HL         ; 1:11      1379 *   1  *2 = 2x
    ld    A, L          ; 1:4       1379 *      +L = 2x
    add  HL, BC         ; 1:11      1379 *      +1 = 3x 
    add   A, L          ; 1:4       1379 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1379 *
    ld    H, A          ; 1:4       1379 *     [1379x] = 99x + 256*5x 

                        ;[15:123]   1381 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0110_0101)
    ld    B, H          ; 1:4       1381 *
    ld    C, L          ; 1:4       1381 *   1       1x = base 
    add  HL, HL         ; 1:11      1381 *   1  *2 = 2x
    ld    A, L          ; 1:4       1381 *      +L = 2x
    add  HL, BC         ; 1:11      1381 *      +1 = 3x 
    add   A, L          ; 1:4       1381 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1381 *
    ld    H, A          ; 1:4       1381 *     [1381x] = 101x + 256*5x  
                        ;[16:134]   1383 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0110_0111)
    ld    B, H          ; 1:4       1383 *
    ld    C, L          ; 1:4       1383 *   1       1x = base 
    add  HL, HL         ; 1:11      1383 *   1  *2 = 2x
    ld    A, L          ; 1:4       1383 *      +L = 2x
    add  HL, BC         ; 1:11      1383 *      +1 = 3x 
    add   A, L          ; 1:4       1383 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1383 *
    ld    H, A          ; 1:4       1383 *     [1383x] = 103x + 256*5x  
                        ;[15:123]   1385 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0110_1001)
    ld    B, H          ; 1:4       1385 *
    ld    C, L          ; 1:4       1385 *   1       1x = base 
    add  HL, HL         ; 1:11      1385 *   1  *2 = 2x
    ld    A, L          ; 1:4       1385 *      +L = 2x
    add  HL, BC         ; 1:11      1385 *      +1 = 3x 
    add   A, L          ; 1:4       1385 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1385 *
    ld    H, A          ; 1:4       1385 *     [1385x] = 105x + 256*5x  
                        ;[16:134]   1387 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0110_1011)
    ld    B, H          ; 1:4       1387 *
    ld    C, L          ; 1:4       1387 *   1       1x = base 
    add  HL, HL         ; 1:11      1387 *   1  *2 = 2x
    ld    A, L          ; 1:4       1387 *      +L = 2x
    add  HL, BC         ; 1:11      1387 *      +1 = 3x 
    add   A, L          ; 1:4       1387 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1387 *
    ld    H, A          ; 1:4       1387 *     [1387x] = 107x + 256*5x  
                        ;[16:134]   1389 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0110_1101)
    ld    B, H          ; 1:4       1389 *
    ld    C, L          ; 1:4       1389 *   1       1x = base 
    add  HL, HL         ; 1:11      1389 *   1  *2 = 2x
    ld    A, L          ; 1:4       1389 *      +L = 2x
    add  HL, BC         ; 1:11      1389 *      +1 = 3x 
    add   A, L          ; 1:4       1389 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1389 *
    ld    H, A          ; 1:4       1389 *     [1389x] = 109x + 256*5x  
                        ;[17:145]   1391 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0110_1111)
    ld    B, H          ; 1:4       1391 *
    ld    C, L          ; 1:4       1391 *   1       1x = base 
    add  HL, HL         ; 1:11      1391 *   1  *2 = 2x
    ld    A, L          ; 1:4       1391 *      +L = 2x
    add  HL, BC         ; 1:11      1391 *      +1 = 3x 
    add   A, L          ; 1:4       1391 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1391 *
    ld    H, A          ; 1:4       1391 *     [1391x] = 111x + 256*5x  
                        ;[15:123]   1393 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0111_0001)
    ld    B, H          ; 1:4       1393 *
    ld    C, L          ; 1:4       1393 *   1       1x = base 
    add  HL, HL         ; 1:11      1393 *   1  *2 = 2x
    ld    A, L          ; 1:4       1393 *      +L = 2x
    add  HL, BC         ; 1:11      1393 *      +1 = 3x 
    add   A, L          ; 1:4       1393 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1393 *
    ld    H, A          ; 1:4       1393 *     [1393x] = 113x + 256*5x  
                        ;[16:134]   1395 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0111_0011)
    ld    B, H          ; 1:4       1395 *
    ld    C, L          ; 1:4       1395 *   1       1x = base 
    add  HL, HL         ; 1:11      1395 *   1  *2 = 2x
    ld    A, L          ; 1:4       1395 *      +L = 2x
    add  HL, BC         ; 1:11      1395 *      +1 = 3x 
    add   A, L          ; 1:4       1395 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1395 *
    ld    H, A          ; 1:4       1395 *     [1395x] = 115x + 256*5x  
                        ;[16:134]   1397 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0111_0101)
    ld    B, H          ; 1:4       1397 *
    ld    C, L          ; 1:4       1397 *   1       1x = base 
    add  HL, HL         ; 1:11      1397 *   1  *2 = 2x
    ld    A, L          ; 1:4       1397 *      +L = 2x
    add  HL, BC         ; 1:11      1397 *      +1 = 3x 
    add   A, L          ; 1:4       1397 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1397 *
    ld    H, A          ; 1:4       1397 *     [1397x] = 117x + 256*5x 

                        ;[17:145]   1399 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0111_0111)
    ld    B, H          ; 1:4       1399 *
    ld    C, L          ; 1:4       1399 *   1       1x = base 
    add  HL, HL         ; 1:11      1399 *   1  *2 = 2x
    ld    A, L          ; 1:4       1399 *      +L = 2x
    add  HL, BC         ; 1:11      1399 *      +1 = 3x 
    add   A, L          ; 1:4       1399 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1399 *
    ld    H, A          ; 1:4       1399 *     [1399x] = 119x + 256*5x  
                        ;[16:134]   1401 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0111_1001)
    ld    B, H          ; 1:4       1401 *
    ld    C, L          ; 1:4       1401 *   1       1x = base 
    add  HL, HL         ; 1:11      1401 *   1  *2 = 2x
    ld    A, L          ; 1:4       1401 *      +L = 2x
    add  HL, BC         ; 1:11      1401 *      +1 = 3x 
    add   A, L          ; 1:4       1401 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1401 *
    ld    H, A          ; 1:4       1401 *     [1401x] = 121x + 256*5x  
                        ;[17:145]   1403 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0111_1011)
    ld    B, H          ; 1:4       1403 *
    ld    C, L          ; 1:4       1403 *   1       1x = base 
    add  HL, HL         ; 1:11      1403 *   1  *2 = 2x
    ld    A, L          ; 1:4       1403 *      +L = 2x
    add  HL, BC         ; 1:11      1403 *      +1 = 3x 
    add   A, L          ; 1:4       1403 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1403 *
    ld    H, A          ; 1:4       1403 *     [1403x] = 123x + 256*5x  
                        ;[17:145]   1405 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0111_1101)
    ld    B, H          ; 1:4       1405 *
    ld    C, L          ; 1:4       1405 *   1       1x = base 
    add  HL, HL         ; 1:11      1405 *   1  *2 = 2x
    ld    A, L          ; 1:4       1405 *      +L = 2x
    add  HL, BC         ; 1:11      1405 *      +1 = 3x 
    add   A, L          ; 1:4       1405 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1405 *
    ld    H, A          ; 1:4       1405 *     [1405x] = 125x + 256*5x  
                        ;[18:156]   1407 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_0111_1111)
    ld    B, H          ; 1:4       1407 *
    ld    C, L          ; 1:4       1407 *   1       1x = base 
    add  HL, HL         ; 1:11      1407 *   1  *2 = 2x
    ld    A, L          ; 1:4       1407 *      +L = 2x
    add  HL, BC         ; 1:11      1407 *      +1 = 3x 
    add   A, L          ; 1:4       1407 *      +L = 5x 
    ...
    add   A, H          ; 1:4       1407 *
    ld    H, A          ; 1:4       1407 *     [1407x] = 127x + 256*5x  
    ...
    add   A, H          ; 1:4       1439 *
    ld    H, A          ; 1:4       1439 *     [1439x] = 159x + 256*5x  
    ...
    add   A, H          ; 1:4       1441 *
    ld    H, A          ; 1:4       1441 *     [1441x] = 161x + 256*5x  
    ...
    add   A, H          ; 1:4       1443 *
    ld    H, A          ; 1:4       1443 *     [1443x] = 163x + 256*5x  
    ...
    add   A, H          ; 1:4       1445 *
    ld    H, A          ; 1:4       1445 *     [1445x] = 165x + 256*5x  
    ...
    add   A, H          ; 1:4       1447 *
    ld    H, A          ; 1:4       1447 *     [1447x] = 167x + 256*5x  
    ...
    add   A, H          ; 1:4       1449 *
    ld    H, A          ; 1:4       1449 *     [1449x] = 169x + 256*5x  
    ...
    add   A, H          ; 1:4       1451 *
    ld    H, A          ; 1:4       1451 *     [1451x] = 171x + 256*5x 
    ...
    add   A, H          ; 1:4       1453 *
    ld    H, A          ; 1:4       1453 *     [1453x] = 173x + 256*5x  
    ...
    add   A, H          ; 1:4       1455 *
    ld    H, A          ; 1:4       1455 *     [1455x] = 175x + 256*5x  
    ...
    add   A, H          ; 1:4       1457 *
    ld    H, A          ; 1:4       1457 *     [1457x] = 177x + 256*5x  
    ...
    add   A, H          ; 1:4       1459 *
    ld    H, A          ; 1:4       1459 *     [1459x] = 179x + 256*5x  
    ...
    add   A, H          ; 1:4       1461 *
    ld    H, A          ; 1:4       1461 *     [1461x] = 181x + 256*5x  
    ...
    add   A, H          ; 1:4       1463 *
    ld    H, A          ; 1:4       1463 *     [1463x] = 183x + 256*5x  
    ...
    add   A, H          ; 1:4       1465 *
    ld    H, A          ; 1:4       1465 *     [1465x] = 185x + 256*5x  
    ...
    add   A, H          ; 1:4       1467 *
    ld    H, A          ; 1:4       1467 *     [1467x] = 187x + 256*5x  
    ...
    add   A, H          ; 1:4       1469 *
    ld    H, A          ; 1:4       1469 *     [1469x] = 189x + 256*5x 
    ...
    add   A, H          ; 1:4       1471 *
    ld    H, A          ; 1:4       1471 *     [1471x] = 191x + 256*5x  
                        ;[15:123]   1473 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1100_0001)
    ld    B, H          ; 1:4       1473 *
    ld    C, L          ; 1:4       1473 *   1       1x = base 
    add  HL, HL         ; 1:11      1473 *   1  *2 = 2x
    ld    A, L          ; 1:4       1473 *      +L = 2x
    add  HL, BC         ; 1:11      1473 *      +1 = 3x 
    add   A, L          ; 1:4       1473 *      +L = 5x 
    add  HL, HL         ; 1:11      1473 *   0  *2 = 6x 
    add  HL, HL         ; 1:11      1473 *   0  *2 = 12x 
    add  HL, HL         ; 1:11      1473 *   0  *2 = 24x 
    add  HL, HL         ; 1:11      1473 *   0  *2 = 48x 
    add  HL, HL         ; 1:11      1473 *   0  *2 = 96x 
    add  HL, HL         ; 1:11      1473 *   1  *2 = 192x
    add  HL, BC         ; 1:11      1473 *      +1 = 193x 
    add   A, H          ; 1:4       1473 *
    ld    H, A          ; 1:4       1473 *     [1473x] = 193x + 256*5x  
                        ;[16:134]   1475 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1100_0011)
    ld    B, H          ; 1:4       1475 *
    ld    C, L          ; 1:4       1475 *   1       1x = base 
    add  HL, HL         ; 1:11      1475 *   1  *2 = 2x
    ld    A, L          ; 1:4       1475 *      +L = 2x
    add  HL, BC         ; 1:11      1475 *      +1 = 3x 
    add   A, L          ; 1:4       1475 *      +L = 5x 
    add  HL, HL         ; 1:11      1475 *   0  *2 = 6x 
    add  HL, HL         ; 1:11      1475 *   0  *2 = 12x 
    add  HL, HL         ; 1:11      1475 *   0  *2 = 24x 
    add  HL, HL         ; 1:11      1475 *   0  *2 = 48x 
    add  HL, HL         ; 1:11      1475 *   1  *2 = 96x
    add  HL, BC         ; 1:11      1475 *      +1 = 97x 
    add  HL, HL         ; 1:11      1475 *   1  *2 = 194x
    add  HL, BC         ; 1:11      1475 *      +1 = 195x 
    add   A, H          ; 1:4       1475 *
    ld    H, A          ; 1:4       1475 *     [1475x] = 195x + 256*5x  
                        ;[16:134]   1477 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1100_0101)
    ld    B, H          ; 1:4       1477 *
    ld    C, L          ; 1:4       1477 *   1       1x = base 
    add  HL, HL         ; 1:11      1477 *   1  *2 = 2x
    ld    A, L          ; 1:4       1477 *      +L = 2x
    add  HL, BC         ; 1:11      1477 *      +1 = 3x 
    add   A, L          ; 1:4       1477 *      +L = 5x 
    add  HL, HL         ; 1:11      1477 *   0  *2 = 6x 
    add  HL, HL         ; 1:11      1477 *   0  *2 = 12x 
    add  HL, HL         ; 1:11      1477 *   0  *2 = 24x 
    add  HL, HL         ; 1:11      1477 *   1  *2 = 48x
    add  HL, BC         ; 1:11      1477 *      +1 = 49x 
    add  HL, HL         ; 1:11      1477 *   0  *2 = 98x 
    add  HL, HL         ; 1:11      1477 *   1  *2 = 196x
    add  HL, BC         ; 1:11      1477 *      +1 = 197x 
    add   A, H          ; 1:4       1477 *
    ld    H, A          ; 1:4       1477 *     [1477x] = 197x + 256*5x  
                        ;[17:145]   1479 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1100_0111)
    ld    B, H          ; 1:4       1479 *
    ld    C, L          ; 1:4       1479 *   1       1x = base 
    add  HL, HL         ; 1:11      1479 *   1  *2 = 2x
    ld    A, L          ; 1:4       1479 *      +L = 2x
    add  HL, BC         ; 1:11      1479 *      +1 = 3x 
    add   A, L          ; 1:4       1479 *      +L = 5x 
    add  HL, HL         ; 1:11      1479 *   0  *2 = 6x 
    add  HL, HL         ; 1:11      1479 *   0  *2 = 12x 
    add  HL, HL         ; 1:11      1479 *   0  *2 = 24x 
    add  HL, HL         ; 1:11      1479 *   1  *2 = 48x
    add  HL, BC         ; 1:11      1479 *      +1 = 49x 
    add  HL, HL         ; 1:11      1479 *   1  *2 = 98x
    add  HL, BC         ; 1:11      1479 *      +1 = 99x 
    add  HL, HL         ; 1:11      1479 *   1  *2 = 198x
    add  HL, BC         ; 1:11      1479 *      +1 = 199x 
    add   A, H          ; 1:4       1479 *
    ld    H, A          ; 1:4       1479 *     [1479x] = 199x + 256*5x  
                        ;[16:134]   1481 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1100_1001)
    ld    B, H          ; 1:4       1481 *
    ld    C, L          ; 1:4       1481 *   1       1x = base 
    add  HL, HL         ; 1:11      1481 *   1  *2 = 2x
    ld    A, L          ; 1:4       1481 *      +L = 2x
    add  HL, BC         ; 1:11      1481 *      +1 = 3x 
    add   A, L          ; 1:4       1481 *      +L = 5x 
    add  HL, HL         ; 1:11      1481 *   0  *2 = 6x 
    add  HL, HL         ; 1:11      1481 *   0  *2 = 12x 
    add  HL, HL         ; 1:11      1481 *   1  *2 = 24x
    add  HL, BC         ; 1:11      1481 *      +1 = 25x 
    add  HL, HL         ; 1:11      1481 *   0  *2 = 50x 
    add  HL, HL         ; 1:11      1481 *   0  *2 = 100x 
    add  HL, HL         ; 1:11      1481 *   1  *2 = 200x
    add  HL, BC         ; 1:11      1481 *      +1 = 201x 
    add   A, H          ; 1:4       1481 *
    ld    H, A          ; 1:4       1481 *     [1481x] = 201x + 256*5x  
                        ;[17:145]   1483 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1100_1011)
    ld    B, H          ; 1:4       1483 *
    ld    C, L          ; 1:4       1483 *   1       1x = base 
    add  HL, HL         ; 1:11      1483 *   1  *2 = 2x
    ld    A, L          ; 1:4       1483 *      +L = 2x
    add  HL, BC         ; 1:11      1483 *      +1 = 3x 
    add   A, L          ; 1:4       1483 *      +L = 5x 
    add  HL, HL         ; 1:11      1483 *   0  *2 = 6x 
    add  HL, HL         ; 1:11      1483 *   0  *2 = 12x 
    add  HL, HL         ; 1:11      1483 *   1  *2 = 24x
    add  HL, BC         ; 1:11      1483 *      +1 = 25x 
    add  HL, HL         ; 1:11      1483 *   0  *2 = 50x 
    add  HL, HL         ; 1:11      1483 *   1  *2 = 100x
    add  HL, BC         ; 1:11      1483 *      +1 = 101x 
    add  HL, HL         ; 1:11      1483 *   1  *2 = 202x
    add  HL, BC         ; 1:11      1483 *      +1 = 203x 
    add   A, H          ; 1:4       1483 *
    ld    H, A          ; 1:4       1483 *     [1483x] = 203x + 256*5x  
                        ;[17:145]   1485 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1100_1101)
    ld    B, H          ; 1:4       1485 *
    ld    C, L          ; 1:4       1485 *   1       1x = base 
    add  HL, HL         ; 1:11      1485 *   1  *2 = 2x
    ld    A, L          ; 1:4       1485 *      +L = 2x
    add  HL, BC         ; 1:11      1485 *      +1 = 3x 
    add   A, L          ; 1:4       1485 *      +L = 5x 
    add  HL, HL         ; 1:11      1485 *   0  *2 = 6x 
    add  HL, HL         ; 1:11      1485 *   0  *2 = 12x 
    add  HL, HL         ; 1:11      1485 *   1  *2 = 24x
    add  HL, BC         ; 1:11      1485 *      +1 = 25x 
    add  HL, HL         ; 1:11      1485 *   1  *2 = 50x
    add  HL, BC         ; 1:11      1485 *      +1 = 51x 
    add  HL, HL         ; 1:11      1485 *   0  *2 = 102x 
    add  HL, HL         ; 1:11      1485 *   1  *2 = 204x
    add  HL, BC         ; 1:11      1485 *      +1 = 205x 
    add   A, H          ; 1:4       1485 *
    ld    H, A          ; 1:4       1485 *     [1485x] = 205x + 256*5x  
                        ;[18:156]   1487 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1100_1111)
    ld    B, H          ; 1:4       1487 *
    ld    C, L          ; 1:4       1487 *   1       1x = base 
    add  HL, HL         ; 1:11      1487 *   1  *2 = 2x
    ld    A, L          ; 1:4       1487 *      +L = 2x
    add  HL, BC         ; 1:11      1487 *      +1 = 3x 
    add   A, L          ; 1:4       1487 *      +L = 5x 
    add  HL, HL         ; 1:11      1487 *   0  *2 = 6x 
    add  HL, HL         ; 1:11      1487 *   0  *2 = 12x 
    add  HL, HL         ; 1:11      1487 *   1  *2 = 24x
    add  HL, BC         ; 1:11      1487 *      +1 = 25x 
    add  HL, HL         ; 1:11      1487 *   1  *2 = 50x
    add  HL, BC         ; 1:11      1487 *      +1 = 51x 
    add  HL, HL         ; 1:11      1487 *   1  *2 = 102x
    add  HL, BC         ; 1:11      1487 *      +1 = 103x 
    add  HL, HL         ; 1:11      1487 *   1  *2 = 206x
    add  HL, BC         ; 1:11      1487 *      +1 = 207x 
    add   A, H          ; 1:4       1487 *
    ld    H, A          ; 1:4       1487 *     [1487x] = 207x + 256*5x 

                        ;[16:134]   1489 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1101_0001)
    ld    B, H          ; 1:4       1489 *
    ld    C, L          ; 1:4       1489 *   1       1x = base 
    add  HL, HL         ; 1:11      1489 *   1  *2 = 2x
    ld    A, L          ; 1:4       1489 *      +L = 2x
    add  HL, BC         ; 1:11      1489 *      +1 = 3x 
    add   A, L          ; 1:4       1489 *      +L = 5x 
    add  HL, HL         ; 1:11      1489 *   0  *2 = 6x 
    add  HL, HL         ; 1:11      1489 *   1  *2 = 12x
    add  HL, BC         ; 1:11      1489 *      +1 = 13x 
    add  HL, HL         ; 1:11      1489 *   0  *2 = 26x 
    add  HL, HL         ; 1:11      1489 *   0  *2 = 52x 
    add  HL, HL         ; 1:11      1489 *   0  *2 = 104x 
    add  HL, HL         ; 1:11      1489 *   1  *2 = 208x
    add  HL, BC         ; 1:11      1489 *      +1 = 209x 
    add   A, H          ; 1:4       1489 *
    ld    H, A          ; 1:4       1489 *     [1489x] = 209x + 256*5x  
                        ;[17:145]   1491 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1101_0011)
    ld    B, H          ; 1:4       1491 *
    ld    C, L          ; 1:4       1491 *   1       1x = base 
    add  HL, HL         ; 1:11      1491 *   1  *2 = 2x
    ld    A, L          ; 1:4       1491 *      +L = 2x
    add  HL, BC         ; 1:11      1491 *      +1 = 3x 
    add   A, L          ; 1:4       1491 *      +L = 5x 
    add  HL, HL         ; 1:11      1491 *   0  *2 = 6x 
    add  HL, HL         ; 1:11      1491 *   1  *2 = 12x
    add  HL, BC         ; 1:11      1491 *      +1 = 13x 
    add  HL, HL         ; 1:11      1491 *   0  *2 = 26x 
    add  HL, HL         ; 1:11      1491 *   0  *2 = 52x 
    add  HL, HL         ; 1:11      1491 *   1  *2 = 104x
    add  HL, BC         ; 1:11      1491 *      +1 = 105x 
    add  HL, HL         ; 1:11      1491 *   1  *2 = 210x
    add  HL, BC         ; 1:11      1491 *      +1 = 211x 
    add   A, H          ; 1:4       1491 *
    ld    H, A          ; 1:4       1491 *     [1491x] = 211x + 256*5x  
                        ;[17:145]   1493 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1101_0101)
    ld    B, H          ; 1:4       1493 *
    ld    C, L          ; 1:4       1493 *   1       1x = base 
    add  HL, HL         ; 1:11      1493 *   1  *2 = 2x
    ld    A, L          ; 1:4       1493 *      +L = 2x
    add  HL, BC         ; 1:11      1493 *      +1 = 3x 
    add   A, L          ; 1:4       1493 *      +L = 5x 
    add  HL, HL         ; 1:11      1493 *   0  *2 = 6x 
    add  HL, HL         ; 1:11      1493 *   1  *2 = 12x
    add  HL, BC         ; 1:11      1493 *      +1 = 13x 
    add  HL, HL         ; 1:11      1493 *   0  *2 = 26x 
    add  HL, HL         ; 1:11      1493 *   1  *2 = 52x
    add  HL, BC         ; 1:11      1493 *      +1 = 53x 
    add  HL, HL         ; 1:11      1493 *   0  *2 = 106x 
    add  HL, HL         ; 1:11      1493 *   1  *2 = 212x
    add  HL, BC         ; 1:11      1493 *      +1 = 213x 
    add   A, H          ; 1:4       1493 *
    ld    H, A          ; 1:4       1493 *     [1493x] = 213x + 256*5x  
                        ;[18:156]   1495 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1101_0111)
    ld    B, H          ; 1:4       1495 *
    ld    C, L          ; 1:4       1495 *   1       1x = base 
    add  HL, HL         ; 1:11      1495 *   1  *2 = 2x
    ld    A, L          ; 1:4       1495 *      +L = 2x
    add  HL, BC         ; 1:11      1495 *      +1 = 3x 
    add   A, L          ; 1:4       1495 *      +L = 5x 
    add  HL, HL         ; 1:11      1495 *   0  *2 = 6x 
    add  HL, HL         ; 1:11      1495 *   1  *2 = 12x
    add  HL, BC         ; 1:11      1495 *      +1 = 13x 
    add  HL, HL         ; 1:11      1495 *   0  *2 = 26x 
    add  HL, HL         ; 1:11      1495 *   1  *2 = 52x
    add  HL, BC         ; 1:11      1495 *      +1 = 53x 
    add  HL, HL         ; 1:11      1495 *   1  *2 = 106x
    add  HL, BC         ; 1:11      1495 *      +1 = 107x 
    add  HL, HL         ; 1:11      1495 *   1  *2 = 214x
    add  HL, BC         ; 1:11      1495 *      +1 = 215x 
    add   A, H          ; 1:4       1495 *
    ld    H, A          ; 1:4       1495 *     [1495x] = 215x + 256*5x  
                        ;[17:145]   1497 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1101_1001)
    ld    B, H          ; 1:4       1497 *
    ld    C, L          ; 1:4       1497 *   1       1x = base 
    add  HL, HL         ; 1:11      1497 *   1  *2 = 2x
    ld    A, L          ; 1:4       1497 *      +L = 2x
    add  HL, BC         ; 1:11      1497 *      +1 = 3x 
    add   A, L          ; 1:4       1497 *      +L = 5x 
    add  HL, HL         ; 1:11      1497 *   0  *2 = 6x 
    add  HL, HL         ; 1:11      1497 *   1  *2 = 12x
    add  HL, BC         ; 1:11      1497 *      +1 = 13x 
    add  HL, HL         ; 1:11      1497 *   1  *2 = 26x
    add  HL, BC         ; 1:11      1497 *      +1 = 27x 
    add  HL, HL         ; 1:11      1497 *   0  *2 = 54x 
    add  HL, HL         ; 1:11      1497 *   0  *2 = 108x 
    add  HL, HL         ; 1:11      1497 *   1  *2 = 216x
    add  HL, BC         ; 1:11      1497 *      +1 = 217x 
    add   A, H          ; 1:4       1497 *
    ld    H, A          ; 1:4       1497 *     [1497x] = 217x + 256*5x  
                        ;[18:156]   1499 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1101_1011)
    ld    B, H          ; 1:4       1499 *
    ld    C, L          ; 1:4       1499 *   1       1x = base 
    add  HL, HL         ; 1:11      1499 *   1  *2 = 2x
    ld    A, L          ; 1:4       1499 *      +L = 2x
    add  HL, BC         ; 1:11      1499 *      +1 = 3x 
    add   A, L          ; 1:4       1499 *      +L = 5x 
    add  HL, HL         ; 1:11      1499 *   0  *2 = 6x 
    add  HL, HL         ; 1:11      1499 *   1  *2 = 12x
    add  HL, BC         ; 1:11      1499 *      +1 = 13x 
    add  HL, HL         ; 1:11      1499 *   1  *2 = 26x
    add  HL, BC         ; 1:11      1499 *      +1 = 27x 
    add  HL, HL         ; 1:11      1499 *   0  *2 = 54x 
    add  HL, HL         ; 1:11      1499 *   1  *2 = 108x
    add  HL, BC         ; 1:11      1499 *      +1 = 109x 
    add  HL, HL         ; 1:11      1499 *   1  *2 = 218x
    add  HL, BC         ; 1:11      1499 *      +1 = 219x 
    add   A, H          ; 1:4       1499 *
    ld    H, A          ; 1:4       1499 *     [1499x] = 219x + 256*5x  
                        ;[18:156]   1501 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1101_1101)
    ld    B, H          ; 1:4       1501 *
    ld    C, L          ; 1:4       1501 *   1       1x = base 
    add  HL, HL         ; 1:11      1501 *   1  *2 = 2x
    ld    A, L          ; 1:4       1501 *      +L = 2x
    add  HL, BC         ; 1:11      1501 *      +1 = 3x 
    add   A, L          ; 1:4       1501 *      +L = 5x 
    add  HL, HL         ; 1:11      1501 *   0  *2 = 6x 
    add  HL, HL         ; 1:11      1501 *   1  *2 = 12x
    add  HL, BC         ; 1:11      1501 *      +1 = 13x 
    add  HL, HL         ; 1:11      1501 *   1  *2 = 26x
    add  HL, BC         ; 1:11      1501 *      +1 = 27x 
    add  HL, HL         ; 1:11      1501 *   1  *2 = 54x
    add  HL, BC         ; 1:11      1501 *      +1 = 55x 
    add  HL, HL         ; 1:11      1501 *   0  *2 = 110x 
    add  HL, HL         ; 1:11      1501 *   1  *2 = 220x
    add  HL, BC         ; 1:11      1501 *      +1 = 221x 
    add   A, H          ; 1:4       1501 *
    ld    H, A          ; 1:4       1501 *     [1501x] = 221x + 256*5x  
    ...
    ld    H, A          ; 1:4       1503 *   [1503x] = 2048x - 2048x    
                        ;[16:134]   1505 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1110_0001)
    ld    B, H          ; 1:4       1505 *
    ld    C, L          ; 1:4       1505 *   1       1x = base 
    add  HL, HL         ; 1:11      1505 *   1  *2 = 2x
    ld    A, L          ; 1:4       1505 *      +L = 2x
    add  HL, BC         ; 1:11      1505 *      +1 = 3x 
    add   A, L          ; 1:4       1505 *      +L = 5x 
    add  HL, HL         ; 1:11      1505 *   1  *2 = 6x
    add  HL, BC         ; 1:11      1505 *      +1 = 7x 
    add  HL, HL         ; 1:11      1505 *   0  *2 = 14x 
    add  HL, HL         ; 1:11      1505 *   0  *2 = 28x 
    add  HL, HL         ; 1:11      1505 *   0  *2 = 56x 
    add  HL, HL         ; 1:11      1505 *   0  *2 = 112x 
    add  HL, HL         ; 1:11      1505 *   1  *2 = 224x
    add  HL, BC         ; 1:11      1505 *      +1 = 225x 
    add   A, H          ; 1:4       1505 *
    ld    H, A          ; 1:4       1505 *     [1505x] = 225x + 256*5x 

                        ;[17:145]   1507 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1110_0011)
    ld    B, H          ; 1:4       1507 *
    ld    C, L          ; 1:4       1507 *   1       1x = base 
    add  HL, HL         ; 1:11      1507 *   1  *2 = 2x
    ld    A, L          ; 1:4       1507 *      +L = 2x
    add  HL, BC         ; 1:11      1507 *      +1 = 3x 
    add   A, L          ; 1:4       1507 *      +L = 5x 
    add  HL, HL         ; 1:11      1507 *   1  *2 = 6x
    add  HL, BC         ; 1:11      1507 *      +1 = 7x 
    add  HL, HL         ; 1:11      1507 *   0  *2 = 14x 
    add  HL, HL         ; 1:11      1507 *   0  *2 = 28x 
    add  HL, HL         ; 1:11      1507 *   0  *2 = 56x 
    add  HL, HL         ; 1:11      1507 *   1  *2 = 112x
    add  HL, BC         ; 1:11      1507 *      +1 = 113x 
    add  HL, HL         ; 1:11      1507 *   1  *2 = 226x
    add  HL, BC         ; 1:11      1507 *      +1 = 227x 
    add   A, H          ; 1:4       1507 *
    ld    H, A          ; 1:4       1507 *     [1507x] = 227x + 256*5x  
                        ;[17:145]   1509 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1110_0101)
    ld    B, H          ; 1:4       1509 *
    ld    C, L          ; 1:4       1509 *   1       1x = base 
    add  HL, HL         ; 1:11      1509 *   1  *2 = 2x
    ld    A, L          ; 1:4       1509 *      +L = 2x
    add  HL, BC         ; 1:11      1509 *      +1 = 3x 
    add   A, L          ; 1:4       1509 *      +L = 5x 
    add  HL, HL         ; 1:11      1509 *   1  *2 = 6x
    add  HL, BC         ; 1:11      1509 *      +1 = 7x 
    add  HL, HL         ; 1:11      1509 *   0  *2 = 14x 
    add  HL, HL         ; 1:11      1509 *   0  *2 = 28x 
    add  HL, HL         ; 1:11      1509 *   1  *2 = 56x
    add  HL, BC         ; 1:11      1509 *      +1 = 57x 
    add  HL, HL         ; 1:11      1509 *   0  *2 = 114x 
    add  HL, HL         ; 1:11      1509 *   1  *2 = 228x
    add  HL, BC         ; 1:11      1509 *      +1 = 229x 
    add   A, H          ; 1:4       1509 *
    ld    H, A          ; 1:4       1509 *     [1509x] = 229x + 256*5x  
                        ;[18:156]   1511 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1110_0111)
    ld    B, H          ; 1:4       1511 *
    ld    C, L          ; 1:4       1511 *   1       1x = base 
    add  HL, HL         ; 1:11      1511 *   1  *2 = 2x
    ld    A, L          ; 1:4       1511 *      +L = 2x
    add  HL, BC         ; 1:11      1511 *      +1 = 3x 
    add   A, L          ; 1:4       1511 *      +L = 5x 
    add  HL, HL         ; 1:11      1511 *   1  *2 = 6x
    add  HL, BC         ; 1:11      1511 *      +1 = 7x 
    add  HL, HL         ; 1:11      1511 *   0  *2 = 14x 
    add  HL, HL         ; 1:11      1511 *   0  *2 = 28x 
    add  HL, HL         ; 1:11      1511 *   1  *2 = 56x
    add  HL, BC         ; 1:11      1511 *      +1 = 57x 
    add  HL, HL         ; 1:11      1511 *   1  *2 = 114x
    add  HL, BC         ; 1:11      1511 *      +1 = 115x 
    add  HL, HL         ; 1:11      1511 *   1  *2 = 230x
    add  HL, BC         ; 1:11      1511 *      +1 = 231x 
    add   A, H          ; 1:4       1511 *
    ld    H, A          ; 1:4       1511 *     [1511x] = 231x + 256*5x  
                        ;[17:145]   1513 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1110_1001)
    ld    B, H          ; 1:4       1513 *
    ld    C, L          ; 1:4       1513 *   1       1x = base 
    add  HL, HL         ; 1:11      1513 *   1  *2 = 2x
    ld    A, L          ; 1:4       1513 *      +L = 2x
    add  HL, BC         ; 1:11      1513 *      +1 = 3x 
    add   A, L          ; 1:4       1513 *      +L = 5x 
    add  HL, HL         ; 1:11      1513 *   1  *2 = 6x
    add  HL, BC         ; 1:11      1513 *      +1 = 7x 
    add  HL, HL         ; 1:11      1513 *   0  *2 = 14x 
    add  HL, HL         ; 1:11      1513 *   1  *2 = 28x
    add  HL, BC         ; 1:11      1513 *      +1 = 29x 
    add  HL, HL         ; 1:11      1513 *   0  *2 = 58x 
    add  HL, HL         ; 1:11      1513 *   0  *2 = 116x 
    add  HL, HL         ; 1:11      1513 *   1  *2 = 232x
    add  HL, BC         ; 1:11      1513 *      +1 = 233x 
    add   A, H          ; 1:4       1513 *
    ld    H, A          ; 1:4       1513 *     [1513x] = 233x + 256*5x  
                        ;[18:156]   1515 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1110_1011)
    ld    B, H          ; 1:4       1515 *
    ld    C, L          ; 1:4       1515 *   1       1x = base 
    add  HL, HL         ; 1:11      1515 *   1  *2 = 2x
    ld    A, L          ; 1:4       1515 *      +L = 2x
    add  HL, BC         ; 1:11      1515 *      +1 = 3x 
    add   A, L          ; 1:4       1515 *      +L = 5x 
    add  HL, HL         ; 1:11      1515 *   1  *2 = 6x
    add  HL, BC         ; 1:11      1515 *      +1 = 7x 
    add  HL, HL         ; 1:11      1515 *   0  *2 = 14x 
    add  HL, HL         ; 1:11      1515 *   1  *2 = 28x
    add  HL, BC         ; 1:11      1515 *      +1 = 29x 
    add  HL, HL         ; 1:11      1515 *   0  *2 = 58x 
    add  HL, HL         ; 1:11      1515 *   1  *2 = 116x
    add  HL, BC         ; 1:11      1515 *      +1 = 117x 
    add  HL, HL         ; 1:11      1515 *   1  *2 = 234x
    add  HL, BC         ; 1:11      1515 *      +1 = 235x 
    add   A, H          ; 1:4       1515 *
    ld    H, A          ; 1:4       1515 *     [1515x] = 235x + 256*5x  
                        ;[18:156]   1517 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1110_1101)
    ld    B, H          ; 1:4       1517 *
    ld    C, L          ; 1:4       1517 *   1       1x = base 
    add  HL, HL         ; 1:11      1517 *   1  *2 = 2x
    ld    A, L          ; 1:4       1517 *      +L = 2x
    add  HL, BC         ; 1:11      1517 *      +1 = 3x 
    add   A, L          ; 1:4       1517 *      +L = 5x 
    add  HL, HL         ; 1:11      1517 *   1  *2 = 6x
    add  HL, BC         ; 1:11      1517 *      +1 = 7x 
    add  HL, HL         ; 1:11      1517 *   0  *2 = 14x 
    add  HL, HL         ; 1:11      1517 *   1  *2 = 28x
    add  HL, BC         ; 1:11      1517 *      +1 = 29x 
    add  HL, HL         ; 1:11      1517 *   1  *2 = 58x
    add  HL, BC         ; 1:11      1517 *      +1 = 59x 
    add  HL, HL         ; 1:11      1517 *   0  *2 = 118x 
    add  HL, HL         ; 1:11      1517 *   1  *2 = 236x
    add  HL, BC         ; 1:11      1517 *      +1 = 237x 
    add   A, H          ; 1:4       1517 *
    ld    H, A          ; 1:4       1517 *     [1517x] = 237x + 256*5x  
    ...
    ld    H, A          ; 1:4       1519 *   [1519x] = 2048x - 2048x    
                        ;[17:145]   1521 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1111_0001)
    ld    B, H          ; 1:4       1521 *
    ld    C, L          ; 1:4       1521 *   1       1x = base 
    add  HL, HL         ; 1:11      1521 *   1  *2 = 2x
    ld    A, L          ; 1:4       1521 *      +L = 2x
    add  HL, BC         ; 1:11      1521 *      +1 = 3x 
    add   A, L          ; 1:4       1521 *      +L = 5x 
    add  HL, HL         ; 1:11      1521 *   1  *2 = 6x
    add  HL, BC         ; 1:11      1521 *      +1 = 7x 
    add  HL, HL         ; 1:11      1521 *   1  *2 = 14x
    add  HL, BC         ; 1:11      1521 *      +1 = 15x 
    add  HL, HL         ; 1:11      1521 *   0  *2 = 30x 
    add  HL, HL         ; 1:11      1521 *   0  *2 = 60x 
    add  HL, HL         ; 1:11      1521 *   0  *2 = 120x 
    add  HL, HL         ; 1:11      1521 *   1  *2 = 240x
    add  HL, BC         ; 1:11      1521 *      +1 = 241x 
    add   A, H          ; 1:4       1521 *
    ld    H, A          ; 1:4       1521 *     [1521x] = 241x + 256*5x  
                        ;[18:156]   1523 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1111_0011)
    ld    B, H          ; 1:4       1523 *
    ld    C, L          ; 1:4       1523 *   1       1x = base 
    add  HL, HL         ; 1:11      1523 *   1  *2 = 2x
    ld    A, L          ; 1:4       1523 *      +L = 2x
    add  HL, BC         ; 1:11      1523 *      +1 = 3x 
    add   A, L          ; 1:4       1523 *      +L = 5x 
    add  HL, HL         ; 1:11      1523 *   1  *2 = 6x
    add  HL, BC         ; 1:11      1523 *      +1 = 7x 
    add  HL, HL         ; 1:11      1523 *   1  *2 = 14x
    add  HL, BC         ; 1:11      1523 *      +1 = 15x 
    add  HL, HL         ; 1:11      1523 *   0  *2 = 30x 
    add  HL, HL         ; 1:11      1523 *   0  *2 = 60x 
    add  HL, HL         ; 1:11      1523 *   1  *2 = 120x
    add  HL, BC         ; 1:11      1523 *      +1 = 121x 
    add  HL, HL         ; 1:11      1523 *   1  *2 = 242x
    add  HL, BC         ; 1:11      1523 *      +1 = 243x 
    add   A, H          ; 1:4       1523 *
    ld    H, A          ; 1:4       1523 *     [1523x] = 243x + 256*5x 

                        ;[18:156]   1525 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1111_0101)
    ld    B, H          ; 1:4       1525 *
    ld    C, L          ; 1:4       1525 *   1       1x = base 
    add  HL, HL         ; 1:11      1525 *   1  *2 = 2x
    ld    A, L          ; 1:4       1525 *      +L = 2x
    add  HL, BC         ; 1:11      1525 *      +1 = 3x 
    add   A, L          ; 1:4       1525 *      +L = 5x 
    add  HL, HL         ; 1:11      1525 *   1  *2 = 6x
    add  HL, BC         ; 1:11      1525 *      +1 = 7x 
    add  HL, HL         ; 1:11      1525 *   1  *2 = 14x
    add  HL, BC         ; 1:11      1525 *      +1 = 15x 
    add  HL, HL         ; 1:11      1525 *   0  *2 = 30x 
    add  HL, HL         ; 1:11      1525 *   1  *2 = 60x
    add  HL, BC         ; 1:11      1525 *      +1 = 61x 
    add  HL, HL         ; 1:11      1525 *   0  *2 = 122x 
    add  HL, HL         ; 1:11      1525 *   1  *2 = 244x
    add  HL, BC         ; 1:11      1525 *      +1 = 245x 
    add   A, H          ; 1:4       1525 *
    ld    H, A          ; 1:4       1525 *     [1525x] = 245x + 256*5x  
    ...
    inc  HL             ; 1:6       1527 *   [1527x] = 0-1527x    
                        ;[18:156]   1529 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1111_1001)
    ld    B, H          ; 1:4       1529 *
    ld    C, L          ; 1:4       1529 *   1       1x = base 
    add  HL, HL         ; 1:11      1529 *   1  *2 = 2x
    ld    A, L          ; 1:4       1529 *      +L = 2x
    add  HL, BC         ; 1:11      1529 *      +1 = 3x 
    add   A, L          ; 1:4       1529 *      +L = 5x 
    add  HL, HL         ; 1:11      1529 *   1  *2 = 6x
    add  HL, BC         ; 1:11      1529 *      +1 = 7x 
    add  HL, HL         ; 1:11      1529 *   1  *2 = 14x
    add  HL, BC         ; 1:11      1529 *      +1 = 15x 
    add  HL, HL         ; 1:11      1529 *   1  *2 = 30x
    add  HL, BC         ; 1:11      1529 *      +1 = 31x 
    add  HL, HL         ; 1:11      1529 *   0  *2 = 62x 
    add  HL, HL         ; 1:11      1529 *   0  *2 = 124x 
    add  HL, HL         ; 1:11      1529 *   1  *2 = 248x
    add  HL, BC         ; 1:11      1529 *      +1 = 249x 
    add   A, H          ; 1:4       1529 *
    ld    H, A          ; 1:4       1529 *     [1529x] = 249x + 256*5x  
                        ;[19:167]   1531 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1111_1011)
    ld    B, H          ; 1:4       1531 *
    ld    C, L          ; 1:4       1531 *   1       1x = base 
    add  HL, HL         ; 1:11      1531 *   1  *2 = 2x
    ld    A, L          ; 1:4       1531 *      +L = 2x
    add  HL, BC         ; 1:11      1531 *      +1 = 3x 
    add   A, L          ; 1:4       1531 *      +L = 5x 
    add  HL, HL         ; 1:11      1531 *   1  *2 = 6x
    add  HL, BC         ; 1:11      1531 *      +1 = 7x 
    add  HL, HL         ; 1:11      1531 *   1  *2 = 14x
    add  HL, BC         ; 1:11      1531 *      +1 = 15x 
    add  HL, HL         ; 1:11      1531 *   1  *2 = 30x
    add  HL, BC         ; 1:11      1531 *      +1 = 31x 
    add  HL, HL         ; 1:11      1531 *   0  *2 = 62x 
    add  HL, HL         ; 1:11      1531 *   1  *2 = 124x
    add  HL, BC         ; 1:11      1531 *      +1 = 125x 
    add  HL, HL         ; 1:11      1531 *   1  *2 = 250x
    add  HL, BC         ; 1:11      1531 *      +1 = 251x 
    add   A, H          ; 1:4       1531 *
    ld    H, A          ; 1:4       1531 *     [1531x] = 251x + 256*5x  
                        ;[19:167]   1533 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0101_1111_1101)
    ld    B, H          ; 1:4       1533 *
    ld    C, L          ; 1:4       1533 *   1       1x = base 
    add  HL, HL         ; 1:11      1533 *   1  *2 = 2x
    ld    A, L          ; 1:4       1533 *      +L = 2x
    add  HL, BC         ; 1:11      1533 *      +1 = 3x 
    add   A, L          ; 1:4       1533 *      +L = 5x 
    add  HL, HL         ; 1:11      1533 *   1  *2 = 6x
    add  HL, BC         ; 1:11      1533 *      +1 = 7x 
    add  HL, HL         ; 1:11      1533 *   1  *2 = 14x
    add  HL, BC         ; 1:11      1533 *      +1 = 15x 
    add  HL, HL         ; 1:11      1533 *   1  *2 = 30x
    add  HL, BC         ; 1:11      1533 *      +1 = 31x 
    add  HL, HL         ; 1:11      1533 *   1  *2 = 62x
    add  HL, BC         ; 1:11      1533 *      +1 = 63x 
    add  HL, HL         ; 1:11      1533 *   0  *2 = 126x 
    add  HL, HL         ; 1:11      1533 *   1  *2 = 252x
    add  HL, BC         ; 1:11      1533 *      +1 = 253x 
    add   A, H          ; 1:4       1533 *
    ld    H, A          ; 1:4       1533 *     [1533x] = 253x + 256*5x  
    ...
    sbc  HL, BC         ; 2:15      1535 *   [1535x] = 2048x - 513x   
                        ;[6:24]     1537 *   Variant mk4: 256*...(((L*2^a)+L)*2^b)+...+HL = HL * (b_0110_0000_0001)
    ...
    ld    H, A          ; 1:4       1537 *     [1537x] = 256 * 6x + 1x  
                        ;[8:46]     1539 *   Variant mk4: ...(((HL*2^a)+256*L+HL)*2^b)+... = HL * (b_0110_0000_0011)
    ld    B, H          ; 1:4       1539 *
    ld    C, L          ; 1:4       1539 *   1       1x = base 
    add  HL, HL         ; 1:11      1539 *   1  *2 = 2x
    add  HL, BC         ; 1:11      1539 *      +1 = 3x 
    ld    A, L          ; 1:4       1539 *       L = 3x 
    add   A, L          ; 1:4       1539 *      +L = 6x 
    add   A, H          ; 1:4       1539 *
    ld    H, A          ; 1:4       1539 *     [1539x] = 3x + 256*6x  
    ...
    ld    A, L          ; 1:4       1543 *      +L = 6x
    add  HL, BC         ; 1:11      1543 *      +1 = 7x 
    add   A, H          ; 1:4       1543 *
    ld    H, A          ; 1:4       1543 *     [1543x] = 7x + 256*6x  
    ...
    ld    A, L          ; 1:4       1549 *       L = 6x 
    add  HL, HL         ; 1:11      1549 *   1  *2 = 12x
    add  HL, BC         ; 1:11      1549 *      +1 = 13x 
    add   A, H          ; 1:4       1549 *
    ld    H, A          ; 1:4       1549 *     [1549x] = 13x + 256*6x  
    ...
    add   A, H          ; 1:4       1567 *
    ld    H, A          ; 1:4       1567 *     [1567x] = 31x + 256*6x  
    ...
    ld    A, L          ; 1:4       1571 *       L = 2x 
    add  HL, HL         ; 1:11      1571 *   0  *2 = 4x 
    add   A, L          ; 1:4       1571 *      +L = 6x 
    ...
    add   A, H          ; 1:4       1583 *
    ld    H, A          ; 1:4       1583 *     [1583x] = 47x + 256*6x  
    ...
    add   A, H          ; 1:4       1587 *
    ld    H, A          ; 1:4       1587 *     [1587x] = 51x + 256*6x  
    ...
    add   A, H          ; 1:4       1589 *
    ld    H, A          ; 1:4       1589 *     [1589x] = 53x + 256*6x  
    ...
    add   A, H          ; 1:4       1591 *
    ld    H, A          ; 1:4       1591 *     [1591x] = 55x + 256*6x  
    ...
    add   A, H          ; 1:4       1593 *
    ld    H, A          ; 1:4       1593 *     [1593x] = 57x + 256*6x  
    ...
    add   A, H          ; 1:4       1595 *
    ld    H, A          ; 1:4       1595 *     [1595x] = 59x + 256*6x 
    ...
    add   A, H          ; 1:4       1597 *
    ld    H, A          ; 1:4       1597 *     [1597x] = 61x + 256*6x  
    ...
    add   A, H          ; 1:4       1599 *
    ld    H, A          ; 1:4       1599 *     [1599x] = 63x + 256*6x  
    ...
    ld    A, L          ; 1:4       1603 *       L = 2x 
    add  HL, HL         ; 1:11      1603 *   0  *2 = 4x 
    add   A, L          ; 1:4       1603 *      +L = 6x 
    ...
    add   A, H          ; 1:4       1631 *
    ld    H, A          ; 1:4       1631 *     [1631x] = 95x + 256*6x 
    ...
    add   A, H          ; 1:4       1633 *
    ld    H, A          ; 1:4       1633 *     [1633x] = 97x + 256*6x  
    ...
    add   A, H          ; 1:4       1635 *
    ld    H, A          ; 1:4       1635 *     [1635x] = 99x + 256*6x  
    ...
    add   A, H          ; 1:4       1637 *
    ld    H, A          ; 1:4       1637 *     [1637x] = 101x + 256*6x  
    ...
    add   A, H          ; 1:4       1639 *
    ld    H, A          ; 1:4       1639 *     [1639x] = 103x + 256*6x  
    ...
    add   A, H          ; 1:4       1641 *
    ld    H, A          ; 1:4       1641 *     [1641x] = 105x + 256*6x  
    ...
    add   A, H          ; 1:4       1643 *
    ld    H, A          ; 1:4       1643 *     [1643x] = 107x + 256*6x  
    ...
    add   A, H          ; 1:4       1645 *
    ld    H, A          ; 1:4       1645 *     [1645x] = 109x + 256*6x  
    ...
    add   A, H          ; 1:4       1647 *
    ld    H, A          ; 1:4       1647 *     [1647x] = 111x + 256*6x  
    ...
    add   A, H          ; 1:4       1649 *
    ld    H, A          ; 1:4       1649 *     [1649x] = 113x + 256*6x 
    ...
    add   A, H          ; 1:4       1651 *
    ld    H, A          ; 1:4       1651 *     [1651x] = 115x + 256*6x  
    ...
    add   A, H          ; 1:4       1653 *
    ld    H, A          ; 1:4       1653 *     [1653x] = 117x + 256*6x  
    ...
    add   A, H          ; 1:4       1655 *
    ld    H, A          ; 1:4       1655 *     [1655x] = 119x + 256*6x  
    ...
    add   A, H          ; 1:4       1657 *
    ld    H, A          ; 1:4       1657 *     [1657x] = 121x + 256*6x  
    ...
    add   A, H          ; 1:4       1659 *
    ld    H, A          ; 1:4       1659 *     [1659x] = 123x + 256*6x  
    ...
    add   A, H          ; 1:4       1661 *
    ld    H, A          ; 1:4       1661 *     [1661x] = 125x + 256*6x  
    ...
    add   A, H          ; 1:4       1663 *
    ld    H, A          ; 1:4       1663 *     [1663x] = 127x + 256*6x  
    ...
    ld    A, L          ; 1:4       1667 *       L = 2x 
    add  HL, HL         ; 1:11      1667 *   0  *2 = 4x 
    add   A, L          ; 1:4       1667 *      +L = 6x 
    ...
    add   A, H          ; 1:4       1727 *
    ld    H, A          ; 1:4       1727 *     [1727x] = 191x + 256*6x  
    ...
    add   A, H          ; 1:4       1729 *
    ld    H, A          ; 1:4       1729 *     [1729x] = 193x + 256*6x  
    ...
    add   A, H          ; 1:4       1731 *
    ld    H, A          ; 1:4       1731 *     [1731x] = 195x + 256*6x  
    ...
    add   A, H          ; 1:4       1733 *
    ld    H, A          ; 1:4       1733 *     [1733x] = 197x + 256*6x  
    ...
    add   A, H          ; 1:4       1735 *
    ld    H, A          ; 1:4       1735 *     [1735x] = 199x + 256*6x  
    ...
    add   A, H          ; 1:4       1737 *
    ld    H, A          ; 1:4       1737 *     [1737x] = 201x + 256*6x  
    ...
    add   A, H          ; 1:4       1739 *
    ld    H, A          ; 1:4       1739 *     [1739x] = 203x + 256*6x 
    ...
    add   A, H          ; 1:4       1741 *
    ld    H, A          ; 1:4       1741 *     [1741x] = 205x + 256*6x  
    ...
    add   A, H          ; 1:4       1743 *
    ld    H, A          ; 1:4       1743 *     [1743x] = 207x + 256*6x  
    ...
    add   A, H          ; 1:4       1745 *
    ld    H, A          ; 1:4       1745 *     [1745x] = 209x + 256*6x  
    ...
    add   A, H          ; 1:4       1747 *
    ld    H, A          ; 1:4       1747 *     [1747x] = 211x + 256*6x  
    ...
    add   A, H          ; 1:4       1749 *
    ld    H, A          ; 1:4       1749 *     [1749x] = 213x + 256*6x  
    ...
    add   A, H          ; 1:4       1751 *
    ld    H, A          ; 1:4       1751 *     [1751x] = 215x + 256*6x  
    ...
    add   A, H          ; 1:4       1753 *
    ld    H, A          ; 1:4       1753 *     [1753x] = 217x + 256*6x  
    ...
    add   A, H          ; 1:4       1755 *
    ld    H, A          ; 1:4       1755 *     [1755x] = 219x + 256*6x  
    ...
    add   A, H          ; 1:4       1757 *
    ld    H, A          ; 1:4       1757 *     [1757x] = 221x + 256*6x 
    ...
    add   A, H          ; 1:4       1759 *
    ld    H, A          ; 1:4       1759 *     [1759x] = 223x + 256*6x  
    ...
    add   A, H          ; 1:4       1761 *
    ld    H, A          ; 1:4       1761 *     [1761x] = 225x + 256*6x  
    ...
    add   A, H          ; 1:4       1763 *
    ld    H, A          ; 1:4       1763 *     [1763x] = 227x + 256*6x  
    ...
    add   A, H          ; 1:4       1765 *
    ld    H, A          ; 1:4       1765 *     [1765x] = 229x + 256*6x  
    ...
    add   A, H          ; 1:4       1767 *
    ld    H, A          ; 1:4       1767 *     [1767x] = 231x + 256*6x  
    ...
    add   A, H          ; 1:4       1769 *
    ld    H, A          ; 1:4       1769 *     [1769x] = 233x + 256*6x  
    ...
    add   A, H          ; 1:4       1771 *
    ld    H, A          ; 1:4       1771 *     [1771x] = 235x + 256*6x  
    ...
    add   A, H          ; 1:4       1773 *
    ld    H, A          ; 1:4       1773 *     [1773x] = 237x + 256*6x  
    ...
    add   A, H          ; 1:4       1777 *
    ld    H, A          ; 1:4       1777 *     [1777x] = 241x + 256*6x  
    ...
    add   A, H          ; 1:4       1779 *
    ld    H, A          ; 1:4       1779 *     [1779x] = 243x + 256*6x  
    ...
    add   A, H          ; 1:4       1781 *
    ld    H, A          ; 1:4       1781 *     [1781x] = 245x + 256*6x  
    ...
    add   A, H          ; 1:4       1785 *
    ld    H, A          ; 1:4       1785 *     [1785x] = 249x + 256*6x  
    ...
    add   A, H          ; 1:4       1787 *
    ld    H, A          ; 1:4       1787 *     [1787x] = 251x + 256*6x  
    ...
    add   A, H          ; 1:4       1789 *
    ld    H, A          ; 1:4       1789 *     [1789x] = 253x + 256*6x  
    ...
    sbc  HL, BC         ; 2:15      1791 *   [1791x] = 2048x - 257x   
                        ;[7:28]     1793 *   Variant mk4: 256*...(((L*2^a)+L)*2^b)+...+HL = HL * (b_0111_0000_0001)
    ...
    ld    A, L          ; 1:4       1799 *       L = 7x 
    add   A, H          ; 1:4       1799 *
    ld    H, A          ; 1:4       1799 *     [1799x] = 7x + 256*7x  
    ...
    ld    A, L          ; 1:4       1807 *       L = 7x 
    add  HL, HL         ; 1:11      1807 *   1  *2 = 14x
    add  HL, BC         ; 1:11      1807 *      +1 = 15x 
    add   A, H          ; 1:4       1807 *
    ld    H, A          ; 1:4       1807 *     [1807x] = 15x + 256*7x  
    ...
    ld    A, L          ; 1:4       1827 *       L = 1x 
    add  HL, HL         ; 1:11      1827 *   0  *2 = 2x 
    add   A, L          ; 1:4       1827 *      +L = 3x 
    add  HL, HL         ; 1:11      1827 *   0  *2 = 4x 
    add   A, L          ; 1:4       1827 *      +L = 7x 
    ...
    add   A, H          ; 1:4       1847 *
    ld    H, A          ; 1:4       1847 *     [1847x] = 55x + 256*7x 
    ...
    add   A, H          ; 1:4       1851 *
    ld    H, A          ; 1:4       1851 *     [1851x] = 59x + 256*7x  
    ...
    add   A, H          ; 1:4       1853 *
    ld    H, A          ; 1:4       1853 *     [1853x] = 61x + 256*7x  
    ...
    add   A, H          ; 1:4       1855 *
    ld    H, A          ; 1:4       1855 *     [1855x] = 63x + 256*7x  
    ...
    ld    A, L          ; 1:4       1859 *       L = 1x 
    add  HL, HL         ; 1:11      1859 *   0  *2 = 2x 
    add   A, L          ; 1:4       1859 *      +L = 3x 
    add  HL, HL         ; 1:11      1859 *   0  *2 = 4x 
    add   A, L          ; 1:4       1859 *      +L = 7x 
    ...
    add   A, H          ; 1:4       1903 *
    ld    H, A          ; 1:4       1903 *     [1903x] = 111x + 256*7x  
    ...
    add   A, H          ; 1:4       1905 *
    ld    H, A          ; 1:4       1905 *     [1905x] = 113x + 256*7x  
    ...
    add   A, H          ; 1:4       1907 *
    ld    H, A          ; 1:4       1907 *     [1907x] = 115x + 256*7x  
    ...
    add   A, H          ; 1:4       1909 *
    ld    H, A          ; 1:4       1909 *     [1909x] = 117x + 256*7x  
    ...
    add   A, H          ; 1:4       1911 *
    ld    H, A          ; 1:4       1911 *     [1911x] = 119x + 256*7x  
    ...
    add   A, H          ; 1:4       1913 *
    ld    H, A          ; 1:4       1913 *     [1913x] = 121x + 256*7x  
    ...
    add   A, H          ; 1:4       1915 *
    ld    H, A          ; 1:4       1915 *     [1915x] = 123x + 256*7x  
    ...
    add   A, H          ; 1:4       1917 *
    ld    H, A          ; 1:4       1917 *     [1917x] = 125x + 256*7x  
    ...
    add   A, H          ; 1:4       1919 *
    ld    H, A          ; 1:4       1919 *     [1919x] = 127x + 256*7x 
    ...
    ld    A, L          ; 1:4       1923 *       L = 1x 
    add  HL, HL         ; 1:11      1923 *   0  *2 = 2x 
    add   A, L          ; 1:4       1923 *      +L = 3x 
    add  HL, HL         ; 1:11      1923 *   0  *2 = 4x 
    add   A, L          ; 1:4       1923 *      +L = 7x 
    ...
    add   A, H          ; 1:4       1981 *
    ld    H, A          ; 1:4       1981 *     [1981x] = 189x + 256*7x  
    ...
    add   A, H          ; 1:4       2013 *
    ld    H, A          ; 1:4       2013 *     [2013x] = 221x + 256*7x  
    ...
    add   A, H          ; 1:4       2017 *
    ld    H, A          ; 1:4       2017 *     [2017x] = 225x + 256*7x  
    ...
    add   A, H          ; 1:4       2019 *
    ld    H, A          ; 1:4       2019 *     [2019x] = 227x + 256*7x  
    ...
    add   A, H          ; 1:4       2021 *
    ld    H, A          ; 1:4       2021 *     [2021x] = 229x + 256*7x  
    ...
    add   A, H          ; 1:4       2023 *
    ld    H, A          ; 1:4       2023 *     [2023x] = 231x + 256*7x  
    ...
    add   A, H          ; 1:4       2025 *
    ld    H, A          ; 1:4       2025 *     [2025x] = 233x + 256*7x  
    ...
    add   A, H          ; 1:4       2027 *
    ld    H, A          ; 1:4       2027 *     [2027x] = 235x + 256*7x 
    ...
    add   A, H          ; 1:4       2029 *
    ld    H, A          ; 1:4       2029 *     [2029x] = 237x + 256*7x  
    ...
    add   A, H          ; 1:4       2033 *
    ld    H, A          ; 1:4       2033 *     [2033x] = 241x + 256*7x  
    ...
    add   A, H          ; 1:4       2035 *
    ld    H, A          ; 1:4       2035 *     [2035x] = 243x + 256*7x  
    ...
    add   A, H          ; 1:4       2037 *
    ld    H, A          ; 1:4       2037 *     [2037x] = 245x + 256*7x  
    ...
    add   A, H          ; 1:4       2041 *
    ld    H, A          ; 1:4       2041 *     [2041x] = 249x + 256*7x  
