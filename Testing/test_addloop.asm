...
;   ===  b e g i n  ===
    ...
    ld    H, D          ; 1:4       push2(2,0)
    ld    L, D          ; 1:4       push2(2,0) 
    call _3loop         ; 3:17      call ( -- )
...
xdo101:                 ;           xdo(-1,1) 101  
    ...
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
                        ;[10:57/37] -1 +xloop 101   variant -1.C: step -1 with lo(real_stop) exclusivity, run 3x
idx101 EQU $+1          ;           -1 +xloop 101   idx always points to a 16-bit index
    ld   BC, 0x0000     ; 3:10      -1 +xloop 101   1.. -1 ..-1, real_stop:0xFFFE
    dec  BC             ; 1:6       -1 +xloop 101   index--
    ld    A, C          ; 1:4       -1 +xloop 101
    xor  0xFE           ; 2:7       -1 +xloop 101   lo(real_stop)
    jp   nz, xdo101save ; 3:10      -1 +xloop 101
...
xdo103:                 ;           xdo(-1,1) 103  
    ...
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
                        ;[11:61/41] -2 +xloop 103   variant -2.E: step -2 with lo(real_stop) exclusivity, run 2x
idx103 EQU $+1          ;           -2 +xloop 103   idx always points to a 16-bit index
    ld   BC, 0x0000     ; 3:10      -2 +xloop 103   1.. -2 ..-1, real_stop:0xFFFD
    dec   C             ; 1:4       -2 +xloop 103   index--
    dec  BC             ; 1:6       -2 +xloop 103   index--
    ld    A, C          ; 1:4       -2 +xloop 103
    xor  0xFD           ; 2:7       -2 +xloop 103   lo(real_stop)
    jp   nz, xdo103save ; 3:10      -2 +xloop 103
...
xdo105:                 ;           xdo(-1,1) 105  
    ...
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
idx105 EQU xdo105save-2 ;           -4 +xloop 105   variant -X.null: positive step and no repeat
...
xdo107:                 ;           xdo(0,0) 107 
    ...
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
idx107 EQU xdo107save-2 ;           -1 +xloop 107   variant -1.null: positive step and no repeat
...
xdo109:                 ;           xdo(0,0) 109  
    ...
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
idx109 EQU xdo109save-2 ;           -2 +xloop 109   variant -2.null: positive step and no repeat
...
xdo111:                 ;           xdo(0,0) 111  
    ...
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
idx111 EQU xdo111save-2 ;           -4 +xloop 111   variant -X.null: positive step and no repeat
...
xdo113:                 ;           xdo(2,-1) 113 
    ...
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
                        ;           push_addxloop(1) --> xloop 113
                        ;[10:57/37] xloop 113   variant +1.H: step one with lo(real_stop) exclusivity, run 3x
idx113 EQU $+1          ;           xloop 113   idx always points to a 16-bit index
    ld   BC, 0x0000     ; 3:10      xloop 113   -1.. +1 ..(2), real_stop:0x0002
    inc  BC             ; 1:6       xloop 113   index++
    ld    A, C          ; 1:4       xloop 113
    xor  0x02           ; 2:7       xloop 113   lo(real_stop)
    jp   nz, xdo113save ; 3:10      xloop 113
xleave113:              ;           xloop 113
xexit113:               ;           xloop 113 
    ld    A, 0x0D       ; 2:7       cr      Pollutes: AF, DE', BC'
    rst   0x10          ; 1:11      cr      with 48K ROM in, this will print char in A
...
xdo115:                 ;           xdo(2,-1) 115  
    ...
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
                        ;[11:61/41] 2 +xloop 115   variant +2.C: step 2 with lo(real_stop) exclusivity, run 2x
idx115 EQU $+1          ;           2 +xloop 115   idx always points to a 16-bit index
    ld   BC, 0x0000     ; 3:10      2 +xloop 115   -1.. +2 ..(2), real_stop:0x0003
    inc  BC             ; 1:6       2 +xloop 115   index++
    inc   C             ; 1:4       2 +xloop 115   index++
    ld    A, C          ; 1:4       2 +xloop 115
    xor  0x03           ; 2:7       2 +xloop 115   lo(real_stop)
...
xdo117:                 ;           xdo(2,-1) 117  
    ...
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
idx117 EQU xdo117save-2 ;           4 +xloop 117   variant +X.null: positive step and no repeat
...
endif101:  
    ...
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
                        ;           push_addxloop(1) --> xloop 119
                        ;[16:57/58] xloop 119   variant +1.default: step one, run 65534x
idx119 EQU $+1          ;           xloop 119   idx always points to a 16-bit index
    ld   BC, 0x0000     ; 3:10      xloop 119   1.. +1 ..(-1), real_stop:0xFFFF
    inc  BC             ; 1:6       xloop 119   index++
    ld    A, B          ; 1:4       xloop 119
    xor  0xFF           ; 2:7       xloop 119   hi(real_stop) first (255<=255)
    jp   nz, xdo119save ; 3:10      xloop 119   255x false positive
    ld    A, C          ; 1:4       xloop 119
    xor  0xFF           ; 2:7       xloop 119   lo(real_stop)
    jp   nz, xdo119save ; 3:10      xloop 119   255x false positive if he was first
xleave119:              ;           xloop 119
xexit119:               ;           xloop 119 
    ld    A, 0x0D       ; 2:7       cr      Pollutes: AF, DE', BC'
    rst   0x10          ; 1:11      cr      with 48K ROM in, this will print char in A
...
endif103:  
    ...
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
                        ;[17:61/62] 2 +xloop 121   variant +2.defaultA: positive step 2, run 32767x
idx121 EQU $+1          ;           2 +xloop 121   idx always points to a 16-bit index
    ld   BC, 0x0000     ; 3:10      2 +xloop 121   1.. +2 ..(-1), real_stop:0xFFFF
    inc  BC             ; 1:6       2 +xloop 121   index++
    inc   C             ; 1:4       2 +xloop 121   index++
    ld    A, B          ; 1:4       2 +xloop 121
    xor  0xFF           ; 2:7       2 +xloop 121   hi(real_stop) first (127<=255)
    jp   nz, xdo121save ; 3:10      2 +xloop 121   127x false positive
    ld    A, C          ; 1:4       2 +xloop 121
    xor  0xFF           ; 2:7       2 +xloop 121   lo(real_stop)
    jp   nz, xdo121save ; 3:10      2 +xloop 121   255x false positive if he was first
...
endif105:  
    ...
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
                        ;[19:67/68] 4 +xloop 123   variant +X.G: positive step 3..255 and real_stop 0..255, run 16384x
idx123 EQU $+1          ;           4 +xloop 123   idx always points to a 16-bit index
    ld   BC, 0x0000     ; 3:10      4 +xloop 123   1.. +4 ..(-1), real_stop:0x0001
    ld    A, C          ; 1:4       4 +xloop 123
    add   A, low 4      ; 2:7       4 +xloop 123
    ld    C, A          ; 1:4       4 +xloop 123
    adc   A, B          ; 1:4       4 +xloop 123
    sub   C             ; 1:4       4 +xloop 123
    ld    B, A          ; 1:4       4 +xloop 123
    jp   nz, xdo123save ; 3:10      4 +xloop 123
    ld    A, C          ; 1:4       4 +xloop 123
    xor  0x01           ; 2:7       4 +xloop 123   lo(real_stop)
    jp   nz, xdo123save ; 3:10      4 +xloop 123
...
endif107:  
    ...
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
                        ;           push_addxloop(1) --> xloop 125
                        ;[9:54/34]  xloop 125   variant +1.G: stop == 0, run 65536x
idx125 EQU $+1          ;           xloop 125   idx always points to a 16-bit index
    ld   BC, 0x0000     ; 3:10      xloop 125   0.. +1 ..(0), real_stop:0x0000
    inc  BC             ; 1:6       xloop 125   index++
    ld    A, B          ; 1:4       xloop 125
    or    C             ; 1:4       xloop 125
    jp   nz, xdo125save ; 3:10      xloop 125
xleave125:              ;           xloop 125
xexit125:               ;           xloop 125 
    ld    A, 0x0D       ; 2:7       cr      Pollutes: AF, DE', BC'
    rst   0x10          ; 1:11      cr      with 48K ROM in, this will print char in A
...
endif109:  
    ...
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
                        ;[10:58/38] 2 +xloop 127   variant +2.A: step 2 and real_stop is zero, run 32768x
idx127 EQU $+1          ;           2 +xloop 127   idx always points to a 16-bit index
    ld   BC, 0x0000     ; 3:10      2 +xloop 127   0.. +2 ..(0), real_stop:0x0000
    inc   C             ; 1:4       2 +xloop 127   index++
...
endif111:  
    ...
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
                        ;[14:55/49] 4 +xloop 129   variant +X.D: positive step 3..255 and stop 0, run 16384x
idx129 EQU $+1          ;           4 +xloop 129   idx always points to a 16-bit index
    ld   BC, 0x0000     ; 3:10      4 +xloop 129   0.. +4 ..(0), real_stop:0x0000
    ld    A, C          ; 1:4       4 +xloop 129
    add   A, low 4      ; 2:7       4 +xloop 129
    ld    C, A          ; 1:4       4 +xloop 129
    jp   nc, xdo129save ; 3:10      4 +xloop 129
    inc   B             ; 1:4       4 +xloop 129
    jp   nc, xdo129save ; 3:10      4 +xloop 129
...
endif113:  
    ...
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
                        ;[10:58/38] -1 +xloop 131   variant -1.F: step -1 and stop 2, run 65534x
idx131 EQU $+1          ;           -1 +xloop 131   idx always points to a 16-bit index
    ld   BC, 0x0000     ; 3:10      -1 +xloop 131   -1.. -1 ..2, real_stop:0x0001
    dec  BC             ; 1:6       -1 +xloop 131   index--
    ld    A, C          ; 1:4       -1 +xloop 131
    dec   A             ; 1:4       -1 +xloop 131
    or    B             ; 1:4       -1 +xloop 131
    jp   nz, xdo131save ; 3:10      -1 +xloop 131
...
endif115:  
    ...
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
                        ;[11:62/42] -2 +xloop 133   variant -2.F: step -2 and real_stop is one, run 32767x
idx133 EQU $+1          ;           -2 +xloop 133   idx always points to a 16-bit index
    ld   BC, 0x0000     ; 3:10      -2 +xloop 133   -1.. -2 ..2, real_stop:0x0001
    dec   C             ; 1:4       -2 +xloop 133   index--
    dec  BC             ; 1:6       -2 +xloop 133   index--
    ld    A, C          ; 1:4       -2 +xloop 133
    dec   A             ; 1:4       -2 +xloop 133
    or    B             ; 1:4       -2 +xloop 133
    jp   nz, xdo133save ; 3:10      -2 +xloop 133
...
endif117:  
    ...
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
                        ;[23:81/82] -4 +xloop 135   variant -X.default: negative step, run 16384x
idx135 EQU $+1          ;           -4 +xloop 135   idx always points to a 16-bit index
    ld   BC, 0x0000     ; 3:10      -4 +xloop 135   -1.. -4 ..2, real_stop:0xFFFF
    ld    A, C          ; 1:4       -4 +xloop 135
    sub  low 4          ; 2:7       -4 +xloop 135
    ld    C, A          ; 1:4       -4 +xloop 135
    ld    A, B          ; 1:4       -4 +xloop 135
    sbc   A, high 4     ; 2:7       -4 +xloop 135
    ld    B, A          ; 1:4       -4 +xloop 135
    ld    A, C          ; 1:4       -4 +xloop 135
    xor  0xFF           ; 2:7       -4 +xloop 135   lo(real_stop)
    jp   nz, xdo135save ; 3:10      -4 +xloop 135   255x
    ld    A, B          ; 1:4       -4 +xloop 135
    xor  0xFF           ; 2:7       -4 +xloop 135   hi(real_stop)
    jp   nz, xdo135save ; 3:10      -4 +xloop 135   63x
...
xdo137save:             ;           ?xdo(-1,-1) 137
xdo137:                 ;           ?xdo(-1,-1) 137  
    push DE             ; 1:11      index i 137
    ex   DE, HL         ; 1:4       index i 137
    ld   HL, (idx137)   ; 3:16      index i 137 idx always points to a 16-bit index 
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
                        ;[16:57/58] xloop 137   variant +1.default: step one, run 65536x
idx137 EQU $+1          ;           xloop 137   idx always points to a 16-bit index
    ld   BC, 0x0000     ; 3:10      xloop 137   -1.. +1 ..(-1), real_stop:0xFFFF
    inc  BC             ; 1:6       xloop 137   index++
    ld    A, B          ; 1:4       xloop 137
    xor  0xFF           ; 2:7       xloop 137   hi(real_stop) first (255<=255)
    jp   nz, xdo137save ; 3:10      xloop 137   255x false positive
    ld    A, C          ; 1:4       xloop 137
    xor  0xFF           ; 2:7       xloop 137   lo(real_stop)
    jp   nz, xdo137save ; 3:10      xloop 137   255x false positive if he was first
xleave137:              ;           xloop 137
xexit137:               ;           xloop 137 
    ld    A, 0x0D       ; 2:7       cr      Pollutes: AF, DE', BC'
    rst   0x10          ; 1:11      cr      with 48K ROM in, this will print char in A
...
xdo139save:             ;           ?xdo(1,1) 139
xdo139:                 ;           ?xdo(1,1) 139  
    push DE             ; 1:11      index i 139
    ex   DE, HL         ; 1:4       index i 139
    ld   HL, (idx139)   ; 3:16      index i 139 idx always points to a 16-bit index 
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
                        ;[16:57/58] xloop 139   variant +1.default: step one, run 65536x
idx139 EQU $+1          ;           xloop 139   idx always points to a 16-bit index
    ld   BC, 0x0000     ; 3:10      xloop 139   1.. +1 ..(1), real_stop:0x0001
    inc  BC             ; 1:6       xloop 139   index++
    ld    A, B          ; 1:4       xloop 139
    xor  0x00           ; 2:7       xloop 139   hi(real_stop) first (255<=255)
    jp   nz, xdo139save ; 3:10      xloop 139   255x false positive
    ld    A, C          ; 1:4       xloop 139
    xor  0x01           ; 2:7       xloop 139   lo(real_stop)
    jp   nz, xdo139save ; 3:10      xloop 139   255x false positive if he was first
xleave139:              ;           xloop 139
xexit139:               ;           xloop 139 
    ld    A, 0x0D       ; 2:7       cr      Pollutes: AF, DE', BC'
    rst   0x10          ; 1:11      cr      with 48K ROM in, this will print char in A
...
xdo141:                 ;           xdo(2,-1) 141  
    ...
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
                        ;[10:57/37] xloop 141   variant +1.H: step one with lo(real_stop) exclusivity, run 3x
idx141 EQU $+1          ;           xloop 141   idx always points to a 16-bit index
    ld   BC, 0x0000     ; 3:10      xloop 141   -1.. +1 ..(2), real_stop:0x0002
    inc  BC             ; 1:6       xloop 141   index++
    ld    A, C          ; 1:4       xloop 141
    xor  0x02           ; 2:7       xloop 141   lo(real_stop)
    jp   nz, xdo141save ; 3:10      xloop 141
xleave141:              ;           xloop 141
xexit141:               ;           xloop 141 
    ld    A, 0x0D       ; 2:7       cr      Pollutes: AF, DE', BC'
    rst   0x10          ; 1:11      cr      with 48K ROM in, this will print char in A
...
xdo143:                 ;           xdo(-1,-5) 143  
    ...
    call PRT_SP_S16     ; 3:17      space .   ( s -- )  
                        ;[13:48]    xloop 143   variant +1.F: hi(index) == hi(stop-1) && index < stop, run 4x
idx143 EQU $+1          ;           xloop 143   idx always points to a 16-bit index
    ld   BC, 0x0000     ; 3:10      xloop 143   -5.. +1 ..(-1), real_stop:0xFFFF
    ld    A, C          ; 1:4       xloop 143
    inc   A             ; 1:4       xloop 143   index++
    ld  (idx143),A      ; 3:13      xloop 143   save index
    xor  0xFF           ; 2:7       xloop 143   lo(real_stop)
    jp   nz, xdo143     ; 3:10      xloop 143
xleave143:              ;           xloop 143
xexit143:               ;           xloop 143 
    ld    A, 0x0D       ; 2:7       cr      Pollutes: AF, DE', BC'
    rst   0x10          ; 1:11      cr      with 48K ROM in, this will print char in A
...
else119  EQU $          ;           = endif
endif119:  
                        ;[16:57/58] xloop 145   variant +1.default: step one, run 65534x
idx145 EQU $+1          ;           xloop 145   idx always points to a 16-bit index
    ld   BC, 0x0000     ; 3:10      xloop 145   1.. +1 ..(-1), real_stop:0xFFFF
    inc  BC             ; 1:6       xloop 145   index++
    ld    A, B          ; 1:4       xloop 145
    xor  0xFF           ; 2:7       xloop 145   hi(real_stop) first (255<=255)
    jp   nz, xdo145save ; 3:10      xloop 145   255x false positive
    ld    A, C          ; 1:4       xloop 145
    xor  0xFF           ; 2:7       xloop 145   lo(real_stop)
    jp   nz, xdo145save ; 3:10      xloop 145   255x false positive if he was first
xleave145:              ;           xloop 145
xexit145:               ;           xloop 145 
    ld    A, 0x0D       ; 2:7       cr      Pollutes: AF, DE', BC'
    rst   0x10          ; 1:11      cr      with 48K ROM in, this will print char in A
...
else121  EQU $          ;           = endif
endif121:  
                        ;[9:54/34]  xloop 147   variant +1.G: stop == 0, run 65536x
idx147 EQU $+1          ;           xloop 147   idx always points to a 16-bit index
    ld   BC, 0x0000     ; 3:10      xloop 147   0.. +1 ..(0), real_stop:0x0000
    inc  BC             ; 1:6       xloop 147   index++
    ld    A, B          ; 1:4       xloop 147
    or    C             ; 1:4       xloop 147
    jp   nz, xdo147save ; 3:10      xloop 147
xleave147:              ;           xloop 147
xexit147:               ;           xloop 147 
    ld    A, 0x0D       ; 2:7       cr      Pollutes: AF, DE', BC'
    rst   0x10          ; 1:11      cr      with 48K ROM in, this will print char in A
