...
;   ===  b e g i n  ===
    ...
    exx                 ; 1:4       init
    ld   BC, 0x0000     ; 3:10      4 0 do_101(xm)
...
do101:                  ;           4 0 do_101(xm)
    ...
    ld    A, L          ; 1:4       0 ?do_102(m)   ( stop 0 -- )
    ld  [stp_lo102], A  ; 3:13      0 ?do_102(m)   lo stop
    ld    A, H          ; 1:4       0 ?do_102(m)
    ld  [stp_hi102], A  ; 3:13      0 ?do_102(m)   hi stop
    or    L             ; 1:4       0 ?do_102(m)
    ld   HL, 0          ; 3:10      0 ?do_102(m)
    ld  [idx102], HL    ; 3:16      0 ?do_102(m)
    pop  HL             ; 1:10      0 ?do_102(m)
    ex   DE, HL         ; 1:4       0 ?do_102(m)
    jp    z, exit102    ; 3:10      0 ?do_102(m)
do102:                  ;           0 ?do_102(m)
    ...
    call PRT_S16        ; 3:17      .   ( s -- )
    ld    A, 0x2C       ; 2:7       putchar comma   Pollutes: AF, AF', DE', BC'
    rst   0x10          ; 1:11      putchar comma   putchar(reg A) with ZX 48K ROM
...
exit101:                ;           loop_101
    ...
    rst   0x10          ; 1:11      cr   putchar(reg A) with ZX 48K ROM
                        ;[7:40]     4 0 do_103(s)   ( -- 4 0 )
    push DE             ; 1:11      4 0 do_103(s)
    push HL             ; 1:11      4 0 do_103(s)
    ld   DE, 0x0004     ; 3:10      4 0 do_103(s)
    ld    H, D          ; 1:4       4 0 do_103(s)   H = D = 0x00
    ld    L, H          ; 1:4       4 0 do_103(s)   L = H = 0x00
do103:                  ;           4 0 do_103(s)   ( stop index -- stop index )
                        ;           i_103(s)   ( -- i )
    push DE             ; 1:11      i_103(s)   ( a -- a a )
    ld    D, H          ; 1:4       i_103(s)
    ld    E, L          ; 1:4       i_103(s)
    push DE             ; 1:11      0 ?do_104(s)
    ex   DE, HL         ; 1:4       0 ?do_104(s)
    ld   HL, 0          ; 3:10      0 ?do_104(s)
    ld    A, E          ; 1:4       0 ?do_104(s)
    or    D             ; 1:4       0 ?do_104(s)
    jp    z, leave104   ; 3:10      0 ?do_104(s)
do104:                  ;           0 ?do_104(s)   ( stop 0 -- stop 0 )
                        ;           j_103(s)   ( -- j )
...
do105:                  ;           do_105(xm)
    ...
    push DE             ; 1:11      0 ?do_106(s)
    ex   DE, HL         ; 1:4       0 ?do_106(s)
    ld   HL, 0          ; 3:10      0 ?do_106(s)
    ld    A, E          ; 1:4       0 ?do_106(s)
    or    D             ; 1:4       0 ?do_106(s)
    jp    z, leave106   ; 3:10      0 ?do_106(s)
do106:                  ;           0 ?do_106(s)   ( stop 0 -- stop 0 )
    push DE             ; 1:11      j_105(m)   ( -- j )
    ex   DE, HL         ; 1:4       j_105(m)
    ld   HL, [idx105]   ; 3:16      j_105(m)   idx always points to a 16-bit index
    call PRT_S16        ; 3:17      .   ( s -- )
                        ;           i_106(s)   ( -- i )
    push DE             ; 1:11      i_106(s)   ( a -- a a )
    ld    D, H          ; 1:4       i_106(s)
    ld    E, L          ; 1:4       i_106(s)
    ld    A, '/'        ; 2:7       '/' emit   Pollutes: AF, AF', DE', BC'
    rst   0x10          ; 1:11      '/' emit   putchar(reg A) with ZX 48K ROM
...
exit105:                ;           loop_105
    ld    A, 0x0D       ; 2:7       cr   Pollutes: AF, AF', DE', BC'
    rst   0x10          ; 1:11      cr   putchar(reg A) with ZX 48K ROM
                        ;[7:40]     3 0 do_107(s)   ( -- 3 0 )
    push DE             ; 1:11      3 0 do_107(s)
    push HL             ; 1:11      3 0 do_107(s)
    ld   DE, 0x0003     ; 3:10      3 0 do_107(s)
    ld    H, D          ; 1:4       3 0 do_107(s)   H = D = 0x00
    ld    L, H          ; 1:4       3 0 do_107(s)   L = H = 0x00
do107:                  ;           3 0 do_107(s)   ( stop index -- stop index )
                        ;           i_107(s)   ( -- i )
    push DE             ; 1:11      i_107(s)   ( a -- a a )
    ld    D, H          ; 1:4       i_107(s)
    ld    E, L          ; 1:4       i_107(s)
...
exit107:                ;           loop_107(s)
    ld    A, 0x0D       ; 2:7       cr   Pollutes: AF, AF', DE', BC'
    rst   0x10          ; 1:11      cr   putchar(reg A) with ZX 48K ROM
    ld   BC, 0x0000     ; 3:10      3 0 do_109(xm)
...
leave114:               ;           loop_114
exit114:                ;           loop_114
    ld   BC, 0x0000     ; 3:10      do_115(xm)
do115save:              ;           do_115(xm)
    ld  (idx115),BC     ; 4:20      do_115(xm)
do115:                  ;           do_115(xm)
    ld    A, 0x63       ; 2:7       putchar 'c'   Pollutes: AF, AF', DE', BC'
    rst   0x10          ; 1:11      putchar 'c'   putchar(reg A) with ZX 48K ROM
    jp   leave115       ; 3:10      leave_115(m)
                        ;[9:54/34]  loop_115   variant +1.Gb: stop == 0 && run > 256, run 65536x
...
leave115:               ;           loop_115
exit115:                ;           loop_115
    ld   BC, 0x00FE     ; 3:10      do_116(xm)
do116save:              ;           do_116(xm)
    ld  (idx116),BC     ; 4:20      do_116(xm)
do116:                  ;           do_116(xm)
    ld    A, 0x64       ; 2:7       putchar 'd'   Pollutes: AF, AF', DE', BC'
...
leave116:               ;           loop_116
exit116:                ;           loop_116
    ld   BC, 0x00FF     ; 3:10      do_117(xm)
do117save:              ;           do_117(xm)
    ld  (idx117),BC     ; 4:20      do_117(xm)
do117:                  ;           do_117(xm)
    ld    A, 0x65       ; 2:7       putchar 'e'   Pollutes: AF, AF', DE', BC'
...
leave117:               ;           loop_117
exit117:                ;           loop_117
    ld   BC, 0x0100     ; 3:10      do_118(xm)
do118save:              ;           do_118(xm)
    ld  (idx118),BC     ; 4:20      do_118(xm)
do118:                  ;           do_118(xm)
    ld    A, 0x66       ; 2:7       putchar 'f'   Pollutes: AF, AF', DE', BC'
...
do119:                  ;           0 0 do_119(s)   ( stop index -- index )  stop = 0
    ld    A, 0x67       ; 2:7       putchar 'g'   Pollutes: AF, AF', DE', BC'
...
exit119:                ;           loop_119(s)
                        ;[7:40]     254 254 do_120(s)   ( -- 254 254 )
    push DE             ; 1:11      254 254 do_120(s)
...
do120:                  ;           254 254 do_120(s)   ( stop index -- stop index )
    ld    A, 0x68       ; 2:7       putchar 'h'   Pollutes: AF, AF', DE', BC'
...
exit120:                ;           loop_120(s)
                        ;[7:40]     255 255 do_121(s)   ( -- 255 255 )
    push DE             ; 1:11      255 255 do_121(s)
...
do121:                  ;           255 255 do_121(s)   ( stop index -- stop index )
    ld    A, 0x69       ; 2:7       putchar 'i'   Pollutes: AF, AF', DE', BC'
...
exit121:                ;           loop_121(s)
                        ;[7:40]     256 256 do_122(s)   ( -- 256 256 )
    push DE             ; 1:11      256 256 do_122(s)
...
do122:                  ;           256 256 do_122(s)   ( stop index -- stop index )
    ld    A, 0x6A       ; 2:7       putchar 'j'   Pollutes: AF, AF', DE', BC'
...
exit122:                ;           loop_122(s)
    ld   BC, 0xEA60     ; 3:10      do_123(xm)
do123save:              ;           do_123(xm)
    ld  (idx123),BC     ; 4:20      do_123(xm)
do123:                  ;           do_123(xm)
    ld    A, 0x6B       ; 2:7       putchar 'k'   Pollutes: AF, AF', DE', BC'
    rst   0x10          ; 1:11      putchar 'k'   putchar(reg A) with ZX 48K ROM
    jp   leave123       ; 3:10      leave_123(m)
                        ;[16:77/57] 5000 +loop_123(xm)   variant +X.J: positive step 256+ and hi(real_stop) exclusivity, run 14x
idx123 EQU $+1          ;           5000 +loop_123(xm)   idx always points to a 16-bit index
    ...
    ld    A, B          ; 1:4       5000 +loop_123(xm)
    adc   A, high 5000  ; 2:7       5000 +loop_123(xm)
    ld    B, A          ; 1:4       5000 +loop_123(xm)
    xor  0xFB           ; 2:7       5000 +loop_123(xm)   hi(real_stop)
    jp   nz, do123save  ; 3:10      5000 +loop_123(xm)
leave123:               ;           5000 +loop_123(xm)
exit123:                ;           5000 +loop_123(xm)
    ld   BC, 0xEA60     ; 3:10      do_124(xm)
do124save:              ;           do_124(xm)
    ld  (idx124),BC     ; 4:20      do_124(xm)
do124:                  ;           do_124(xm)
    ld    A, 0x6C       ; 2:7       putchar 'l'   Pollutes: AF, AF', DE', BC'
    rst   0x10          ; 1:11      putchar 'l'   putchar(reg A) with ZX 48K ROM
    jp   leave124       ; 3:10      leave_124(m)
                        ;[16:77/57] 3100 +loop_124(xm)   variant +X.J: positive step 256+ and hi(real_stop) exclusivity, run 22x
idx124 EQU $+1          ;           3100 +loop_124(xm)   idx always points to a 16-bit index
    ...
    ld    A, B          ; 1:4       3100 +loop_124(xm)
    adc   A, high 3100  ; 2:7       3100 +loop_124(xm)
    ld    B, A          ; 1:4       3100 +loop_124(xm)
    xor  0xF4           ; 2:7       3100 +loop_124(xm)   hi(real_stop)
    jp   nz, do124save  ; 3:10      3100 +loop_124(xm)
...
exit124:                ;           3100 +loop_124(xm)
    ...
    call 0x203C         ; 3:17      print     Print our string with ZX 48K ROM
    pop  DE             ; 1:10      print
    ld   BC, 0x0003     ; 3:10      12 3 do_125(xm)
...
do125:                  ;           12 3 do_125(xm)
    ...
    ex   DE, HL         ; 1:4       dup space .   x3 x2 x1
                       ;[13:54]     7 >= if   ( x -- ) variant: default
    ld    A, L          ; 1:4       7 >= if   HL>=7 --> L-0x07>=0
    sub   0x07          ; 2:7       7 >= if   HL>=7 --> L-0x07>=0
    ld    A, H          ; 1:4       7 >= if   HL>=7 --> H-0x00>=0
    sbc   A, 0x00       ; 2:7       7 >= if   HL>=7 --> H-0x00>=0 --> false if carry
    rra                 ; 1:4       7 >= if
    xor   H             ; 1:4       7 >= if   invert sign if HL is negative
    ex   DE, HL         ; 1:4       7 >= if
    pop  DE             ; 1:10      7 >= if
    jp    m, else101    ; 3:10      7 >= if   positive constant --> false if sign
...
exit125:                ;           loop_125
    ld    A, 0x0D       ; 2:7       cr   Pollutes: AF, AF', DE', BC'
    rst   0x10          ; 1:11      cr   putchar(reg A) with ZX 48K ROM
                        ;[8:42]     12 3 do_126(s)   ( -- 12 3 )
    push DE             ; 1:11      12 3 do_126(s)
...
do126:                  ;           12 3 do_126(s)   ( stop index -- stop index )
    ...
    ex   DE, HL         ; 1:4       7 >= if
    pop  DE             ; 1:10      7 >= if
    jp    m, else102    ; 3:10      7 >= if   positive constant --> false if sign
...
do127:                  ;           do_127(xm)
    ...
    ex   DE, HL         ; 1:4       7 >= if
    pop  DE             ; 1:10      7 >= if
    jp    m, else103    ; 3:10      7 >= if   positive constant --> false if sign
...
do128:                  ;           do_128(xm)
    ...
    ex   DE, HL         ; 1:4       7 >= if
    pop  DE             ; 1:10      7 >= if
    jp    m, else104    ; 3:10      7 >= if   positive constant --> false if sign
...
do129:                  ;           do_129(xm)
    ...
    ex   DE, HL         ; 1:4       7 >= if
    pop  DE             ; 1:10      7 >= if
    jp    m, else105    ; 3:10      7 >= if   positive constant --> false if sign
...
do130:                  ;           do_130(xm)
    ...
    ex   DE, HL         ; 1:4       7 >= if
    pop  DE             ; 1:10      7 >= if
    jp    m, else106    ; 3:10      7 >= if   positive constant --> false if sign
...
for131:                 ;           12 for_131 i_131
    ...
    ex   DE, HL         ; 1:4       dup space .   x3 x2 x1
                       ;[13:54]     7 <= if   ( x -- ) variant: default
    ld    A, 0x07       ; 2:7       7 <= if   HL<=7 --> 0<=0x07-L
    sub   L             ; 1:4       7 <= if   HL<=7 --> 0<=0x07-L
    ld    A, 0x00       ; 2:7       7 <= if   HL<=7 --> 0<=0x00-H
    sbc   A, H          ; 1:4       7 <= if   HL<=7 --> 0<=0x00-H --> false if carry
    rra                 ; 1:4       7 <= if
    xor   H             ; 1:4       7 <= if   invert sign if HL is negative
    ex   DE, HL         ; 1:4       7 <= if
    pop  DE             ; 1:10      7 <= if
    jp    m, else107    ; 3:10      7 <= if   positive constant --> false if sign
...
for132:                 ;           for_132(s) ( index -- index )
    ...
    ex   DE, HL         ; 1:4       7 <= if
    pop  DE             ; 1:10      7 <= if
    jp    m, else108    ; 3:10      7 <= if   positive constant --> false if sign
...
leave132:               ;           next_132(s)
    ...
    call 0x203C         ; 3:17      print     Print our string with ZX 48K ROM
    pop  DE             ; 1:10      print
    ld   BC, 0x0000     ; 3:10      1 0 do_133(xm)
...
leave133:               ;           loop_133
exit133:                ;           loop_133
    ld   BC, 0x00FE     ; 3:10      255 254 do_134(xm)
...
exit139:                ;           loop_139(s)
                        ;[8:42]     255 254 do_140(s)   ( -- 255 254 )
    push DE             ; 1:11      255 254 do_140(s)
...
exit140:                ;           loop_140(s)
                        ;[8:42]     256 255 do_141(s)   ( -- 256 255 )
    push DE             ; 1:11      256 255 do_141(s)
...
exit141:                ;           loop_141(s)
                        ;[7:40]     257 256 do_142(s)   ( -- 257 256 )
    push DE             ; 1:11      257 256 do_142(s)
    push HL             ; 1:11      257 256 do_142(s)
    ld   HL, 0x0100     ; 3:10      257 256 do_142(s)
    ld    D, H          ; 1:4       257 256 do_142(s)   D = H = 0x01
    ld    E, D          ; 1:4       257 256 do_142(s)   E = D = 0x01
