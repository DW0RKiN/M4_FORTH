...
begin101:               ;           begin(101)
    ...
    jp   nz, break101   ; 3:10      2dup = while
...
begin102:               ;           begin(102)
    ...
    jp   nz, break102   ; 3:10      2dup = while
...
begin103:               ;           begin(103)
    ...
    push HL             ; 1:11      2dup   ( b a -- b a b a )
                        ;[8:49]     = while(103)   ( x2 x1 -- )  flag: x2 == x1
    or    A             ; 1:4       = while(103)
...
begin106:               ;           begin(106)
    push DE             ; 1:11      2dup
    push HL             ; 1:11      2dup   ( b a -- b a b a )
                        ;[8:49]     <> while(106)   ( x2 x1 -- )  flag: x2 <> x1
    or    A             ; 1:4       <> while(106)
...
begin109:               ;           begin(109)
    push DE             ; 1:11      2dup
    push HL             ; 1:11      2dup   ( b a -- b a b a )
                       ;[12:58]     < while(109)   ( x2 x1 -- )  flag: x2 < x1
    ld    A, E          ; 1:4       < while(109)   DE<HL --> DE-HL<0 --> false if not carry
    sub   L             ; 1:4       < while(109)   DE<HL --> DE-HL<0 --> false if not carry
    ld    A, D          ; 1:4       < while(109)   DE<HL --> DE-HL<0 --> false if not carry
    sbc   A, H          ; 1:4       < while(109)   DE<HL --> DE-HL<0 --> false if not carry
    rra                 ; 1:4       < while(109)
    xor   H             ; 1:4       < while(109)
    xor   D             ; 1:4       < while(109)
...
begin112:               ;           begin(112)
    push DE             ; 1:11      2dup
    push HL             ; 1:11      2dup   ( b a -- b a b a )
                       ;[12:58]     <= while(112)   ( x2 x1 -- )  flag: x2 <= x1
    ld    A, L          ; 1:4       <= while(112)   DE<=HL --> 0<=HL-DE --> false if carry
    sub   E             ; 1:4       <= while(112)   DE<=HL --> 0<=HL-DE --> false if carry
    ld    A, H          ; 1:4       <= while(112)   DE<=HL --> 0<=HL-DE --> false if carry
    sbc   A, D          ; 1:4       <= while(112)   DE<=HL --> 0<=HL-DE --> false if carry
    rra                 ; 1:4       <= while(112)
    xor   H             ; 1:4       <= while(112)
    xor   D             ; 1:4       <= while(112)
...
begin115:               ;           begin(115)
    push DE             ; 1:11      2dup
    push HL             ; 1:11      2dup   ( b a -- b a b a )
                       ;[12:58]     > while(115)   ( x2 x1 -- )  flag: x2 > x1
    ld    A, L          ; 1:4       > while(115)   DE>HL --> 0>HL-DE --> false if not carry
    sub   E             ; 1:4       > while(115)   DE>HL --> 0>HL-DE --> false if not carry
    ld    A, H          ; 1:4       > while(115)   DE>HL --> 0>HL-DE --> false if not carry
    sbc   A, D          ; 1:4       > while(115)   DE>HL --> 0>HL-DE --> false if not carry
    rra                 ; 1:4       > while(115)
    xor   H             ; 1:4       > while(115)
    xor   D             ; 1:4       > while(115)
...
begin118:               ;           begin(118)
    push DE             ; 1:11      2dup
    push HL             ; 1:11      2dup   ( b a -- b a b a )
                       ;[12:58]     >= while(118)   ( x2 x1 -- )  flag: x2 >= x1
    ld    A, E          ; 1:4       >= while(118)   DE>=HL --> DE-HL>=0 --> false if carry
    sub   L             ; 1:4       >= while(118)   DE>=HL --> DE-HL>=0 --> false if carry
    ld    A, D          ; 1:4       >= while(118)   DE>=HL --> DE-HL>=0 --> false if carry
    sbc   A, H          ; 1:4       >= while(118)   DE>=HL --> DE-HL>=0 --> false if carry
    rra                 ; 1:4       >= while(118)
    xor   H             ; 1:4       >= while(118)
    xor   D             ; 1:4       >= while(118)
...
break118:               ;           again(118)
    ...
    rst   0x10          ; 1:11      cr   putchar(reg A) with ZX 48K ROM
begin119:               ;           begin(119)
    ld    A, E          ; 1:4       2dup = while 119
    sub   L             ; 1:4       2dup = while 119
    jp   nz, break119   ; 3:10      2dup = while 119
    ld    A, D          ; 1:4       2dup = while 119
    sub   H             ; 1:4       2dup = while 119
    jp   nz, break119   ; 3:10      2dup = while
...
begin120:               ;           begin(120)
    ...
    jp   nz, break120   ; 3:10      2dup u= while
...
begin121:               ;           begin(121)
    push DE             ; 1:11      2dup
    push HL             ; 1:11      2dup   ( b a -- b a b a )
                        ;[8:49]     u= while(121)   ( x2 x1 -- )  flag: x2 == x1
...
break121:               ;           again(121)
begin122:               ;           begin(122)
    ld    A, E          ; 1:4       2dup <> while 122
    sub   L             ; 1:4       2dup <> while 122
    jr   nz, $+7        ; 2:7/12    2dup <> while 122
    ld    A, D          ; 1:4       2dup <> while 122
    sub   H             ; 1:4       2dup <> while 122
    jp    z, break122   ; 3:10      2dup <> while
...
begin123:               ;           begin(123)
    ...
    jp    z, break123   ; 3:10      2dup u<> while
...
begin124:               ;           begin(124)
    push DE             ; 1:11      2dup
    push HL             ; 1:11      2dup   ( b a -- b a b a )
                        ;[8:49]     u<> while(124)   ( x2 x1 -- )  flag: x2 <> x1
...
begin125:               ;           begin(125)
    push DE             ; 1:11      2dup
    push HL             ; 1:11      2dup   ( b a -- b a b a )
                        ;[9:46]     u< while(125)   ( x2 x1 -- )
    ld    A, E          ; 1:4       u< while(125)   DE<HL --> DE-HL<0 --> false if not carry
    sub   L             ; 1:4       u< while(125)   DE<HL --> DE-HL<0 --> false if not carry
    ld    A, D          ; 1:4       u< while(125)   DE<HL --> DE-HL<0 --> false if not carry
    sbc   A, H          ; 1:4       u< while(125)   DE<HL --> DE-HL<0 --> false if not carry
...
begin126:               ;           begin(126)
    ...
    jp   nc, break126   ; 3:10      2dup u< while
...
begin127:               ;           begin(127)
    push DE             ; 1:11      2dup
    push HL             ; 1:11      2dup   ( b a -- b a b a )
                        ;[9:46]     u< while(127)   ( x2 x1 -- )
    ld    A, E          ; 1:4       u< while(127)   DE<HL --> DE-HL<0 --> false if not carry
    sub   L             ; 1:4       u< while(127)   DE<HL --> DE-HL<0 --> false if not carry
    ld    A, D          ; 1:4       u< while(127)   DE<HL --> DE-HL<0 --> false if not carry
    sbc   A, H          ; 1:4       u< while(127)   DE<HL --> DE-HL<0 --> false if not carry
...
begin128:               ;           begin(128)
    push DE             ; 1:11      2dup
    push HL             ; 1:11      2dup   ( b a -- b a b a )
                        ;[9:46]     u<= while(128)   ( x2 x1 -- )
    ld    A, L          ; 1:4       u<= while(128)   DE<=HL --> 0<=HL-DE --> false if carry
    sub   E             ; 1:4       u<= while(128)   DE<=HL --> 0<=HL-DE --> false if carry
    ld    A, H          ; 1:4       u<= while(128)   DE<=HL --> 0<=HL-DE --> false if carry
    sbc   A, D          ; 1:4       u<= while(128)   DE<=HL --> 0<=HL-DE --> false if carry
...
begin129:               ;           begin(129)
    ...
    jp    c, break129   ; 3:10      2dup u<= while
...
begin130:               ;           begin(130)
    push DE             ; 1:11      2dup
    push HL             ; 1:11      2dup   ( b a -- b a b a )
                        ;[9:46]     u<= while(130)   ( x2 x1 -- )
    ld    A, L          ; 1:4       u<= while(130)   DE<=HL --> 0<=HL-DE --> false if carry
    sub   E             ; 1:4       u<= while(130)   DE<=HL --> 0<=HL-DE --> false if carry
    ld    A, H          ; 1:4       u<= while(130)   DE<=HL --> 0<=HL-DE --> false if carry
    sbc   A, D          ; 1:4       u<= while(130)   DE<=HL --> 0<=HL-DE --> false if carry
...
begin131:               ;           begin(131)
    push DE             ; 1:11      2dup
    push HL             ; 1:11      2dup   ( b a -- b a b a )
                        ;[9:46]     u> while(131)   ( x2 x1 -- )
    ld    A, L          ; 1:4       u> while(131)   DE>HL --> 0>HL-DE --> false if not carry
    sub   E             ; 1:4       u> while(131)   DE>HL --> 0>HL-DE --> false if not carry
    ld    A, H          ; 1:4       u> while(131)   DE>HL --> 0>HL-DE --> false if not carry
    sbc   A, D          ; 1:4       u> while(131)   DE>HL --> 0>HL-DE --> false if not carry
...
begin132:               ;           begin(132)
    ...
    jp   nc, break132   ; 3:10      2dup u> while
...
begin133:               ;           begin(133)
    push DE             ; 1:11      2dup
    push HL             ; 1:11      2dup   ( b a -- b a b a )
                        ;[9:46]     u> while(133)   ( x2 x1 -- )
    ld    A, L          ; 1:4       u> while(133)   DE>HL --> 0>HL-DE --> false if not carry
    sub   E             ; 1:4       u> while(133)   DE>HL --> 0>HL-DE --> false if not carry
    ld    A, H          ; 1:4       u> while(133)   DE>HL --> 0>HL-DE --> false if not carry
    sbc   A, D          ; 1:4       u> while(133)   DE>HL --> 0>HL-DE --> false if not carry
...
begin134:               ;           begin(134)
    push DE             ; 1:11      2dup
    push HL             ; 1:11      2dup   ( b a -- b a b a )
                        ;[9:46]     u>= while(134)   ( x2 x1 -- )
    ld    A, E          ; 1:4       u>= while(134)   DE>=HL --> DE-HL>=0 --> false if carry
    sub   L             ; 1:4       u>= while(134)   DE>=HL --> DE-HL>=0 --> false if carry
    ld    A, D          ; 1:4       u>= while(134)   DE>=HL --> DE-HL>=0 --> false if carry
    sbc   A, H          ; 1:4       u>= while(134)   DE>=HL --> DE-HL>=0 --> false if carry
...
begin135:               ;           begin(135)
    ...
    jp    c, break135   ; 3:10      2dup u>= while
...
begin136:               ;           begin(136)
    push DE             ; 1:11      2dup
    push HL             ; 1:11      2dup   ( b a -- b a b a )
                        ;[9:46]     u>= while(136)   ( x2 x1 -- )
    ld    A, E          ; 1:4       u>= while(136)   DE>=HL --> DE-HL>=0 --> false if carry
    sub   L             ; 1:4       u>= while(136)   DE>=HL --> DE-HL>=0 --> false if carry
    ld    A, D          ; 1:4       u>= while(136)   DE>=HL --> DE-HL>=0 --> false if carry
    sbc   A, H          ; 1:4       u>= while(136)   DE>=HL --> DE-HL>=0 --> false if carry
...
begin140:               ;           begin(140)
    ...
    jp    z, break140   ; 3:10      4dup D<> while
...
begin141:               ;           begin(141)
    ...
    jp    z, break141   ; 3:10      4dup D<> while
...
begin143:               ;           begin(143)
    ...
    jp   nc, break143   ; 3:10      4dup D< while
...
begin144:               ;           begin(144)
    ...
    jp   nc, break144   ; 3:10      4dup D< while
...
begin146:               ;           begin(146)
    ...
    jp    c, break146   ; 3:10      4dup D<= while
...
begin147:               ;           begin(147)
    ...
    jp    c, break147   ; 3:10      4dup D<= while
...
begin149:               ;           begin(149)
    ...
    jp   nc, break149   ; 3:10      4dup D> while
...
begin150:               ;           begin(150)
    ...
    jp   nc, break150   ; 3:10      4dup D> while
...
begin152:               ;           begin(152)
    ...
    jp    c, break152   ; 3:10      4dup D>= while
...
begin153:               ;           begin(153)
    ...
    jp    c, break153   ; 3:10      4dup D>= while
...
begin158:               ;           begin(158)
    ...
    jp    z, break158   ; 3:10      4dup D<> while
...
begin159:               ;           begin(159)
    ...
    jp    z, break159   ; 3:10      4dup D<> while
...
begin161:               ;           begin(161)
    ...
    jp   nc, break161   ; 3:10      4dup Du< while
...
begin162:               ;           begin(162)
    ...
    jp   nc, break162   ; 3:10      4dup Du< while
...
begin164:               ;           begin(164)
    ...
    jp    c, break164   ; 3:10      4dup Du<= while
...
begin165:               ;           begin(165)
    ...
    jp    c, break165   ; 3:10      4dup Du<= while
...
begin167:               ;           begin(167)
    ...
    jp   nc, break167   ; 3:10      4dup Du> while
...
begin168:               ;           begin(168)
    ...
    jp   nc, break168   ; 3:10      4dup Du> while
...
begin170:               ;           begin(170)
    ...
    jp    c, break170   ; 3:10      4dup Du>= while
...
begin171:               ;           begin(171)
    ...
    jp    c, break171   ; 3:10      4dup Du>= while
...
break174:               ;           again(174)
begin175:               ;           begin(175)
                       ;[11:40]     dup 3 < while(175)   ( x -- x ) ;#variant: default, change: "define({_TYP_SINGLE},{sign_first})"
    ld    A, L          ; 1:4       dup 3 < while(175)   HL<3 --> L-0x03<0 --> false if not carry
    sub  0x03           ; 2:7       dup 3 < while(175)   HL<3 --> L-0x03<0 --> false if not carry
    ld    A, H          ; 1:4       dup 3 < while(175)   HL<3 --> H-0x00<0 --> false if not carry
    sbc   A, 0x00       ; 2:7       dup 3 < while(175)   HL<3 --> H-0x00<0 --> false if not carry
    rra                 ; 1:4       dup 3 < while(175)
    xor   H             ; 1:4       dup 3 < while(175)   invert sign if HL is negative
    jp    p, break175   ; 3:10      dup 3 < while(175)   positive constant --> false if not sign
...
break175:               ;           again(175)
begin176:               ;           begin(176)
                       ;[11:40]     dup 3 <= while(176)   ( x -- x ) ;#variant: default, change: "define({_TYP_SINGLE},{sign_first})"
    ld    A, 0x03       ; 2:7       dup 3 <= while(176)   HL<=3 --> 0<=0x03-L --> false if carry
    sub   L             ; 1:4       dup 3 <= while(176)   HL<=3 --> 0<=0x03-L --> false if carry
    ld    A, 0x00       ; 2:7       dup 3 <= while(176)   HL<=3 --> 0<=0x00-H --> false if carry
    sbc   A, H          ; 1:4       dup 3 <= while(176)   HL<=3 --> 0<=0x00-H --> false if carry
    rra                 ; 1:4       dup 3 <= while(176)
    xor   H             ; 1:4       dup 3 <= while(176)   invert sign if HL is negative
    jp    m, break176   ; 3:10      dup 3 <= while(176)   positive constant --> false if sign
...
break176:               ;           again(176)
begin177:               ;           begin(177)
                       ;[11:40]     dup 3 > while(177)   ( x -- x ) ;#variant: default, change: "define({_TYP_SINGLE},{sign_first})"
    ld    A, 0x03       ; 2:7       dup 3 > while(177)   HL>3 --> 0>0x03-L --> false if not carry
    sub   L             ; 1:4       dup 3 > while(177)   HL>3 --> 0>0x03-L --> false if not carry
    ld    A, 0x00       ; 2:7       dup 3 > while(177)   HL>3 --> 0>0x00-H --> false if not carry
    sbc   A, H          ; 1:4       dup 3 > while(177)   HL>3 --> 0>0x00-H --> false if not carry
    rra                 ; 1:4       dup 3 > while(177)
    xor   H             ; 1:4       dup 3 > while(177)   invert sign if HL is negative
    jp    p, break177   ; 3:10      dup 3 > while(177)   positive constant --> false if not sign
...
break177:               ;           again(177)
begin178:               ;           begin(178)
                       ;[11:40]     dup 3 >= while(178)   ( x -- x ) ;#variant: default, change: "define({_TYP_SINGLE},{sign_first})"
    ld    A, L          ; 1:4       dup 3 >= while(178)   HL>=3 --> L-0x03>=0 --> false if carry
    sub  0x03           ; 2:7       dup 3 >= while(178)   HL>=3 --> L-0x03>=0 --> false if carry
    ld    A, H          ; 1:4       dup 3 >= while(178)   HL>=3 --> H-0x00>=0 --> false if carry
    sbc   A, 0x00       ; 2:7       dup 3 >= while(178)   HL>=3 --> H-0x00>=0 --> false if carry
    rra                 ; 1:4       dup 3 >= while(178)
    xor   H             ; 1:4       dup 3 >= while(178)   invert sign if HL is negative
    jp    m, break178   ; 3:10      dup 3 >= while(178)   positive constant --> false if sign
...
begin179:               ;           begin(179)
    ...
    ld    A, 0x03       ; 2:7       dup 3 u= while(179)
    xor   L             ; 1:4       dup 3 u= while(179)   x[1] = 0x03
    or    H             ; 1:4       dup 3 u= while(179)   x[2] = 0
...
begin180:               ;           begin(180)
    ...
    ld    A, 0x03       ; 2:7       dup 3 u<> while(180)
    xor   L             ; 1:4       dup 3 u<> while(180)   x[1] = 0x03
    or    H             ; 1:4       dup 3 u<> while(180)   x[2] = 0
...
begin181:               ;           begin(181)
    ...
    jp   nc, break181   ; 3:10      dup 3 u< while
...
begin182:               ;           begin(182)
    ...
    jp    c, break182   ; 3:10      dup 3 u<= while
...
begin183:               ;           begin(183)
    ...
    jp   nc, break183   ; 3:10      dup 3 u> while
...
begin184:               ;           begin(184)
    ...
    jp    c, break184   ; 3:10      dup 3 u>= while
...
begin185:               ;           begin(185)
    ...
    xor   0x02          ; 2:7       dup -3 = while(185)   0xFF = x[1] ^ 0x02 = 0xFD ^ 0x02
...
begin186:               ;           begin(186)
    ...
    xor   0x02          ; 2:7       dup -3 <> while(186)   0xFF = x[1] ^ 0x02 = 0xFD ^ 0x02
...
break186:               ;           again(186)
begin187:               ;           begin(187)
                       ;[11:40]     dup -3 < while(187)   ( x -- x ) ;#variant: default, change: "define({_TYP_SINGLE},{sign_first})"
    ld    A, L          ; 1:4       dup -3 < while(187)   HL<-3 --> L-0xFD<0 --> false if not carry
    sub  0xFD           ; 2:7       dup -3 < while(187)   HL<-3 --> L-0xFD<0 --> false if not carry
    ld    A, H          ; 1:4       dup -3 < while(187)   HL<-3 --> H-0xFF<0 --> false if not carry
    sbc   A, 0xFF       ; 2:7       dup -3 < while(187)   HL<-3 --> H-0xFF<0 --> false if not carry
    rra                 ; 1:4       dup -3 < while(187)
    xor   H             ; 1:4       dup -3 < while(187)   invert sign if HL is negative
    jp    m, break187   ; 3:10      dup -3 < while(187)   negative constant --> false if sign
...
break187:               ;           again(187)
begin188:               ;           begin(188)
                       ;[11:40]     dup -3 <= while(188)   ( x -- x ) ;#variant: default, change: "define({_TYP_SINGLE},{sign_first})"
    ld    A, 0xFD       ; 2:7       dup -3 <= while(188)   HL<=-3 --> 0<=0xFD-L --> false if carry
    sub   L             ; 1:4       dup -3 <= while(188)   HL<=-3 --> 0<=0xFD-L --> false if carry
    ld    A, 0xFF       ; 2:7       dup -3 <= while(188)   HL<=-3 --> 0<=0xFF-H --> false if carry
    sbc   A, H          ; 1:4       dup -3 <= while(188)   HL<=-3 --> 0<=0xFF-H --> false if carry
    rra                 ; 1:4       dup -3 <= while(188)
    xor   H             ; 1:4       dup -3 <= while(188)   invert sign if HL is negative
    jp    p, break188   ; 3:10      dup -3 <= while(188)   negative constant --> false if not sign
...
break188:               ;           again(188)
begin189:               ;           begin(189)
                       ;[11:40]     dup -3 > while(189)   ( x -- x ) ;#variant: default, change: "define({_TYP_SINGLE},{sign_first})"
    ld    A, 0xFD       ; 2:7       dup -3 > while(189)   HL>-3 --> 0>0xFD-L --> false if not carry
    sub   L             ; 1:4       dup -3 > while(189)   HL>-3 --> 0>0xFD-L --> false if not carry
    ld    A, 0xFF       ; 2:7       dup -3 > while(189)   HL>-3 --> 0>0xFF-H --> false if not carry
    sbc   A, H          ; 1:4       dup -3 > while(189)   HL>-3 --> 0>0xFF-H --> false if not carry
    rra                 ; 1:4       dup -3 > while(189)
    xor   H             ; 1:4       dup -3 > while(189)   invert sign if HL is negative
    jp    m, break189   ; 3:10      dup -3 > while(189)   negative constant --> false if sign
...
break189:               ;           again(189)
begin190:               ;           begin(190)
                       ;[11:40]     dup -3 >= while(190)   ( x -- x ) ;#variant: default, change: "define({_TYP_SINGLE},{sign_first})"
    ld    A, L          ; 1:4       dup -3 >= while(190)   HL>=-3 --> L-0xFD>=0 --> false if carry
    sub  0xFD           ; 2:7       dup -3 >= while(190)   HL>=-3 --> L-0xFD>=0 --> false if carry
    ld    A, H          ; 1:4       dup -3 >= while(190)   HL>=-3 --> H-0xFF>=0 --> false if carry
    sbc   A, 0xFF       ; 2:7       dup -3 >= while(190)   HL>=-3 --> H-0xFF>=0 --> false if carry
    rra                 ; 1:4       dup -3 >= while(190)
    xor   H             ; 1:4       dup -3 >= while(190)   invert sign if HL is negative
    jp    p, break190   ; 3:10      dup -3 >= while(190)   negative constant --> false if not sign
...
begin191:               ;           begin(191)
    ...
    ld    A, L          ; 1:4       dup -3 u= while(191)
    xor   0x02          ; 2:7       dup -3 u= while(191)   0xFF = x[1] ^ 0x02 = 0xFD ^ 0x02
    and   H             ; 1:4       dup -3 u= while(191)
    inc   A             ; 1:4       dup -3 u= while(191)   x[2] = 0xFF
...
begin192:               ;           begin(192)
    ...
    ld    A, L          ; 1:4       dup -3 u<> while(192)
    xor   0x02          ; 2:7       dup -3 u<> while(192)   0xFF = x[1] ^ 0x02 = 0xFD ^ 0x02
    and   H             ; 1:4       dup -3 u<> while(192)
    inc   A             ; 1:4       dup -3 u<> while(192)   x[2] = 0xFF
...
begin193:               ;           begin(193)
    ...
    jp   nc, break193   ; 3:10      dup -3 u< while
...
begin194:               ;           begin(194)
    ...
    jp    c, break194   ; 3:10      dup -3 u<= while
...
begin195:               ;           begin(195)
    ...
    jp   nc, break195   ; 3:10      dup -3 u> while
...
begin196:               ;           begin(196)
    ...
    jp    c, break196   ; 3:10      dup -3 u>= while
