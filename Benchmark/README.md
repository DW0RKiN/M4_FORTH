...
|[PUSH(0x4000)<br /> BEGIN<br />&nbsp; &nbsp;  BEGIN<br />&nbsp; &nbsp; &nbsp; &nbsp; DUP_PUSH_SWAP_CSTORE_1ADD(255)<br />&nbsp; &nbsp; DUP_PUSH_LO_EQ_UNTIL(0x5B00)<br />DUP_PUSH_HI_EQ_UNTIL(0x5B00) <br />DROP](./fillin_v10.asm)  |   46  | 0.09s  |
