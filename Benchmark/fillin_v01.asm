...
do101:                  ;           23296 16384 do_101(xm)
                        ;[7:34]     255 i_101 c!   ( -- )  val=255, addr=i
    ld    A, 0xFF       ; 2:7       255 i_101 c!   lo(255) = 0xFF
    ld   BC, [idx101]   ; 4:20      255 i_101 c!   idx always points to a 16-bit index
    ld  [BC],A          ; 1:7       255 i_101 c!
