...
|<sub>4 pick 4 pick 4 pick 4 pick|<sub>        _4DUP        |<sub>                  |<sub>      ( d2 d1 -- d2 d1 d2 d1 )    |
...
|<sub>  dup `6` swap ! |<sub>DUP PUSH(`6`) SWAP STORE|<sub>   DUP_PUSH_SWAP_STORE(`6`)  |<sub>   (   addr -- addr )     |<sub>(addr) = `6`         |
